		...
		<div id="poststuff">
			<div class="postbox-container bd-settings-wrappers bd_poststuff">
				...
				<div class="bd-menu-setting">
					...
					<ul class="bd-setting-handle">
						...
						<!-- <?php if ( is_plugin_active( 'blog-designer-ads/blog-designer-ads.php' ) ) { ?>
							<?php do_action( 'bdads_do_single_blog_settings', 'tab' ); ?>
							<?php
							 } else {
									?>
							<li data-show="bdpads" class="">
								<div class="bdp_tab_icon">
				...
				<div id="bdpsinglegeneral" class="postbox postbox-with-fw-options" style=<?php echo esc_attr( $bdpgeneral_class_show ); ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<li class="bdp-sigle-layout-li">
								<div class="bdp-left">
									<span class="bdp-key-title">
										<?php esc_html_e( 'Select your favorite layout from 45+ powerful single post layouts.', 'blog-designer-pro' ); ?>
									</span>
								</div>
								<div class="bdp-right">
									<?php
									...
									$template_color_preset = array(
										'boxy'             => array(
											'boxy_default' => array(
												...
												'preset_value' => 'template_color:#E84159,template_ftcolor:#E21130,template_fthovercolor:#E84159,template_titlecolor:#E21130,related_title_color:#E21130,template_contentcolor:#999999,firstletter_contentcolor:#999999,',
												'display_value' => '#E21130,#E84159,#555555,#999999',
											),
											'boxy_mckenzie' => array(
												'preset_name' => esc_html__( 'McKenzie', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#A2855B,template_ftcolor:#8B6632,template_fthovercolor:#A2855B,template_titlecolor:#8B6632,related_title_color:#8B6632,template_contentcolor:#999999,firstletter_contentcolor:#999999,',
												'display_value' => '#8B6632,#A2855B,#555555,#999999',
											),
											'boxy_black_pearl' => array(
												'preset_name' => esc_html__( 'Black Pearl', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#44545D,template_ftcolor:#152934,template_fthovercolor:#44545D,template_titlecolor:#152934,related_title_color:#152934,template_contentcolor:#999999,firstletter_contentcolor:#999999,',
												'display_value' => '#152934,#44545D,#555555,#999999',
											),
											'boxy_fun_green' => array(
												'preset_name' => esc_html__( 'Fun Green', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#3E8563,template_ftcolor:#0E663C,template_fthovercolor:#3E8563,template_titlecolor:#0E663C,related_title_color:#0E663C,template_contentcolor:#999999,firstletter_contentcolor:#999999,',
												'display_value' => '#0E663C,#3E8563,#555555,#999999',
											),
											'boxy_peru_tan' => array(
												'preset_name' => esc_html__( 'Peru Tan', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#916748,template_ftcolor:#75411A,template_fthovercolor:#916748,template_titlecolor:#75411A,related_title_color:#75411A,template_contentcolor:#999999,firstletter_contentcolor:#999999,',
												'display_value' => '#75411A,#916748,#555555,#999999',
											),
											'boxy_blackberry' => array(
												'preset_name' => esc_html__( 'Blackberry', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#6D4657,template_ftcolor:#49182D,template_fthovercolor:#6D4657,template_titlecolor:#49182D,related_title_color:#49182D,template_contentcolor:#999999,firstletter_contentcolor:#999999,',
										...
										'brit_co'          => array(
											'brit_co_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#3E91AD,template_fthovercolor:#555555,template_titlecolor:#0E7699,related_title_color:#0E7699,template_contentcolor:#666666,firstletter_contentcolor:#666666',
												'display_value' => '#0E7699,#3E91AD,#555555,#666666',
											),
											'brit_co_pompadour' => array(
												'preset_name' => esc_html__( 'Pompadour', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#974772,template_fthovercolor:#555555,template_titlecolor:#7D194F,related_title_color:#7D194F,template_contentcolor:#666666,firstletter_contentcolor:#666666',
												'display_value' => '#7D194F,#974772,#555555,#666666',
											),
											'brit_co_bronzetone' => array(
												'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#67704E,template_fthovercolor:#555555,template_titlecolor:#414C22,related_title_color:#414C22,template_contentcolor:#666666,firstletter_contentcolor:#666666',
												'display_value' => '#414C22,#67704E,#555555,#666666',
											),
											'brit_co_west_side' => array(
												'preset_name' => esc_html__( 'West Side', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#FDF6F1,template_ftcolor:#E99955,template_fthovercolor:#555555,template_titlecolor:#E4802A,related_title_color:#E4802A,template_contentcolor:#666666,firstletter_contentcolor:#666666',
												'display_value' => '#E4802A,#E99955,#555555,#666666',
											),
											'brit_co_regal_blue' => array(
												'preset_name' => esc_html__( 'Regal Blue', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#EEF1F4,template_ftcolor:#435F7F,template_fthovercolor:#555555,template_titlecolor:#14375F,related_title_color:#14375F,template_contentcolor:#666666,firstletter_contentcolor:#666666',
												'display_value' => '#14375F,#435F7F,#555555,#666666',
											),
											'brit_co_fun_green' => array(
												'preset_name' => esc_html__( 'Fun Green', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#EEF4F1,template_ftcolor:#3E8563,template_fthovercolor:#555555,template_titlecolor:#0E663C,related_title_color:#0E663C,template_contentcolor:#666666,firstletter_contentcolor:#666666',
										...
										'brite'            => array(
											'brite_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#3E91AD,template_fthovercolor:#555555,winter_category_color:#3E91AD,template_titlecolor:#0E7699,related_title_color:#0E7699,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#0E7699,#3E91AD,#555555,#999999',
											),
											'brite_mandalay' => array(
												'preset_name' => esc_html__( 'Mandalay', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#C18F55,template_fthovercolor:#555555,winter_category_color:#C18F55,template_titlecolor:#B1732A,related_title_color:#B1732A,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#B1732A,#C18F55,#555555,#999999',
											),
											'brite_bronzetone' => array(
												'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#67704E,template_fthovercolor:#555555,winter_category_color:#67704E,template_titlecolor:#414C22,related_title_color:#414C22,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#414C22,#67704E,#555555,#999999',
											),
											'brite_red_violet' => array(
												'preset_name' => esc_html__( 'Red Violet', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#C44C91,template_fthovercolor:#555555,winter_category_color:#C44C91,template_titlecolor:#B51F76,related_title_color:#B51F76,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#B51F76,#C44C91,#555555,#999999',
											),
											'brite_peru_tan' => array(
												'preset_name' => esc_html__( 'Peru Tan', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#916748,template_fthovercolor:#555555,winter_category_color:#916748,template_titlecolor:#75411A,related_title_color:#75411A,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#75411A,#916748,#555555,#999999',
											),
											'brite_earls_green' => array(
												'preset_name' => esc_html__( 'Earls Green', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#CEBF59,template_fthovercolor:#555555,winter_category_color:#CEBF59,template_titlecolor:#C2AF2F,related_title_color:#C2AF2F,template_contentcolor:#999999,firstletter_contentcolor:#999999',
										...
										'cool_horizontal'  => array(
											'cool_horizontal_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#e21130,template_ftcolor:#e21130,template_fthovercolor:#333333,template_titlecolor:#e21130,related_title_color:#e21130,template_contentcolor:#444444,firstletter_contentcolor:#444444',
												'display_value' => '#e21130,#666666,#e21130,#444444',
											),
											'cool_horizontal_pink' => array(
												'preset_name' => esc_html__( 'Pink', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#D33683,template_ftcolor:#D33683,template_fthovercolor:#333333,template_titlecolor:#D33683,related_title_color:#D33683,template_contentcolor:#444444,firstletter_contentcolor:#444444',
											...
											'cool_horizontal_blue' => array(
												...
												'preset_value' => 'template_color:#6C71C3,template_ftcolor:#6C71C3,template_fthovercolor:#333333,template_titlecolor:#6C71C3,related_title_color:#6C71C3,template_contentcolor:#444444,firstletter_contentcolor:#444444',
												'display_value' => '#6C71C3,#666666,#6C71C3,#444444',
											),
											'cool_horizontal_java' => array(
												'preset_name' => esc_html__( 'Java', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#29A198,template_ftcolor:#29A198,template_fthovercolor:#333333,template_titlecolor:#29A198,related_title_color:#29A198,template_contentcolor:#444444,firstletter_contentcolor:#444444',
											...
											'cool_horizontal_curious_blue' => array(
												...
												'preset_value' => 'template_color:#268BD3,template_ftcolor:#268BD3,template_fthovercolor:#333333,template_titlecolor:#268BD3,related_title_color:#268BD3,template_contentcolor:#444444,firstletter_contentcolor:#444444',
												'display_value' => '#268BD3,#666666,#268BD3,#444444',
											),
											'cool_horizontal_olive' => array(
												'preset_name' => esc_html__( 'Olive', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#869901,template_ftcolor:#869901,template_fthovercolor:#333333,template_titlecolor:#869901,related_title_color:#869901,template_contentcolor:#444444,firstletter_contentcolor:#444444',
										...
										'deport'           => array(
											'deport_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_color:#3E91AD,template_ftcolor:#3E91AD,template_fthovercolor:#555555,deport_dashcolor:#3E91AD,template_titlecolor:#0E7699,related_title_color:#0E7699,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#0E7699,#3E91AD,#555555,#888888',
											),
											'deport_west_side' => array(
												'preset_name' => esc_html__( 'West Side', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_color:#E99955,template_ftcolor:#E99955,template_fthovercolor:#555555,deport_dashcolor:#E99955,template_titlecolor:#E4802A,related_title_color:#E4802A,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#E4802A,#E99955,#555555,#888888',
											),
											'deport_lemon_ginger' => array(
												'preset_name' => esc_html__( 'Lemon Ginger', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_color:#CEBF59,template_ftcolor:#CEBF59,template_fthovercolor:#555555,deport_dashcolor:#CEBF59,template_titlecolor:#C2AF2F,related_title_color:#C2AF2F,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#C2AF2F,#CEBF59,#555555,#888888',
											),
											'deport_alizarin' => array(
												'preset_name' => esc_html__( 'Alizarin', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_color:#ED4961,template_ftcolor:#ED4961,template_fthovercolor:#555555,deport_dashcolor:#ED4961,template_titlecolor:#E81B3A,related_title_color:#E81B3A,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#E81B3A,#ED4961,#555555,#888888',
											),
											'deport_ce_soir' => array(
												'preset_name' => esc_html__( 'Ce Soir', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_color:#A381BB,template_ftcolor:#A381BB,template_fthovercolor:#555555,deport_dashcolor:#A381BB,template_titlecolor:#8C62AA,related_title_color:#8C62AA,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#8C62AA,#A381BB,#555555,#888888',
											),
											'deport_yonder' => array(
												'preset_name' => esc_html__( 'Yonder', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_color:#8BA3CE,template_ftcolor:#8BA3CE,template_fthovercolor:#555555,deport_dashcolor:#8BA3CE,template_titlecolor:#6E8CC2,related_title_color:#6E8CC2,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#6E8CC2,#8BA3CE,#555555,#888888',
											),
										),
										'easy_timeline'    => array(
										...
										'elina'            => array(
											...
											'elina_madras' => array(
												...
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#6D6145,template_fthovercolor:#333333,template_titlecolor:#493917,related_title_color:#493917,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#493917,#6D6145,#333333,#555555',
											),
											'elina_cerulean' => array(
												'preset_name' => esc_html__( 'Cerulean', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#3E91AD,template_fthovercolor:#333333,template_titlecolor:#0E7699,related_title_color:#0E7699,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#0E7699,#3E91AD,#333333,#555555',
											),
											'elina_bronzetone' => array(
												'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#67704E,template_fthovercolor:#333333,template_titlecolor:#414C22,related_title_color:#414C22,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#414C22,#67704E,#333333,#555555',
											),
											'elina_buttercup' => array(
												'preset_name' => esc_html__( 'Buttercup', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#E5A452,template_fthovercolor:#333333,template_titlecolor:#DF8D27,related_title_color:#DF8D27,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#DF8D27,#E5A452,#333333,#555555',
											),
											'elina_yonder' => array(
												'preset_name' => esc_html__( 'Yonder', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#8BA3CE,template_fthovercolor:#333333,template_titlecolor:#6E8CC2,related_title_color:#6E8CC2,template_contentcolor:#555555,firstletter_contentcolor:#555555',
										...
										'evolution'        => array(
											...
											'evolution_rich_gold' => array(
												'preset_name' => esc_html__( 'Rich Gold', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#BA7850,template_fthovercolor:#333333,template_titlecolor:#A95624,related_title_color:#A95624,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#A95624,#BA7850,#333333,#555555',
											),
											'evolution_alizarin' => array(
												'preset_name' => esc_html__( 'Alizarin', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#ED4961,template_fthovercolor:#333333,template_titlecolor:#E81B3A,related_title_color:#E81B3A,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#E81B3A,#ED4961,#333333,#555555',
											),
											'evolution_west_side' => array(
												'preset_name' => esc_html__( 'West Side', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#E99955,template_fthovercolor:#333333,template_titlecolor:#E4802A,related_title_color:#E4802A,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#E4802A,#E99955,#333333,#555555',
											),
											'evolution_fun_green' => array(
												'preset_name' => esc_html__( 'Fun Green', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#3E8563,template_fthovercolor:#333333,template_titlecolor:#0E663C,related_title_color:#0E663C,template_contentcolor:#555555,firstletter_contentcolor:#555555',
										...
										'explore'          => array(
											'explore_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#44545D,template_fthovercolor:#333333,template_titlecolor:#152934,related_title_color:#152934,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#152934,#44545D,#333333,#555555',
											),
											'explore_lemon_ginger' => array(
												'preset_name' => esc_html__( 'Lemon Ginger', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#A39D5A,template_fthovercolor:#333333,template_titlecolor:#8C8431,related_title_color:#8C8431,template_contentcolor:#555555,firstletter_contentcolor:#555555',
											...
											'explore_catalina_blue' => array(
												...
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#495F85,template_fthovercolor:#333333,template_titlecolor:#1B3766,related_title_color:#1B3766,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#1B3766,#495F85,#333333,#555555',
											),
											'explore_red_violet' => array(
												'preset_name' => esc_html__( 'Red Violet', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#C44C91,template_fthovercolor:#333333,template_titlecolor:#B51F76,related_title_color:#B51F76,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#B51F76,#C44C91,#333333,#555555',
											),
											'explore_blackberry' => array(
												'preset_name' => esc_html__( 'Blackberry', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#6D4657,template_fthovercolor:#333333,template_titlecolor:#49182D,related_title_color:#49182D,template_contentcolor:#555555,firstletter_contentcolor:#555555',
										...
										'glossary'         => array(
											...
											'glossary_madras' => array(
												'preset_name' => esc_html__( 'Madras', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#493917,template_fthovercolor:#6D6145,template_titlecolor:#493917,related_title_color:#493917,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#493917,#6D6145,#555555,#888888',
											),
											'glossary_catalina_blue' => array(
												'preset_name' => esc_html__( 'Catalina Blue', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#1B3766,template_fthovercolor:#495F85,template_titlecolor:#1B3766,related_title_color:#1B3766,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#1B3766,#495F85,#555555,#888888',
											),
											'glossary_pompadour' => array(
												'preset_name' => esc_html__( 'Pompadour', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#7D194F,template_fthovercolor:#974772,template_titlecolor:#7D194F,related_title_color:#7D194F,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#7D194F,#974772,#555555,#888888',
											),
											'glossary_bronzetone' => array(
												'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#414C22,template_fthovercolor:#67704E,template_titlecolor:#414C22,related_title_color:#414C22,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#414C22,#67704E,#555555,#888888',
											),
											'glossary_peru-tan' => array(
												'preset_name' => esc_html__( 'Peru Tan', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#75411A,template_fthovercolor:#916748,template_titlecolor:#75411A,related_title_color:#75411A,template_contentcolor:#888888,firstletter_contentcolor:#888888',
										...
										'hub'              => array(
											'hub_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#0E7699,template_fthovercolor:#555555,template_titlecolor:#0E7699,related_title_color:#222222,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#0E7699,#222222,#555555,#888888',
											),
											'hub_crimson' => array(
												'preset_name' => esc_html__( 'Crimson', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#E21130,template_fthovercolor:#E84159,template_titlecolor:#E21130,related_title_color:#E21130,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#E21130,#E84159,#555555,#888888',
											),
											...
											'hub_west_side' => array(
												'preset_name' => esc_html__( 'West Side', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#E4802A,template_fthovercolor:#E99955,template_titlecolor:#E4802A,related_title_color:#E4802A,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#E4802A,#E99955,#555555,#888888',
											),
											'hub_wasabi'  => array(
												'preset_name' => esc_html__( 'Wasabi', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#788F3D,template_fthovercolor:#93A564,template_titlecolor:#788F3D,related_title_color:#788F3D,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#788F3D,#93A564,#555555,#888888',
											),
											'hub_yonder'  => array(
												'preset_name' => esc_html__( 'Yonder', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#6E8CC2,template_fthovercolor:#8BA3CE,template_titlecolor:#6E8CC2,related_title_color:#6E8CC2,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#6E8CC2,#8BA3CE,#555555,#888888',
											),
										),
										'invert-grid'      => array(
										...
										'masonry_timeline' => array(
											...
											'masonry_timeline_peru_tan' => array(
												'preset_name' => esc_html__( 'Peru Tan', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#916748,template_fthovercolor:#333333,template_titlecolor:#75411A,related_title_color:#75411A,template_contentcolor:#555555,firstletter_contentcolor:#555555',
										...
										'media-grid'       => array(
											'media-grid_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#3E91AD,template_ftcolor:#3E91AD,template_fthovercolor:#333333,template_titlecolor:#0E7699,related_title_color:#0E7699,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#0E7699,#3E91AD,#333333,#555555',
											),
											'media-grid_rich_gold' => array(
												'preset_name' => esc_html__( 'Rich Gold', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#BA7850,template_ftcolor:#A95624,template_fthovercolor:#BA7850,template_titlecolor:#A95624,related_title_color:#A95624,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#A95624,#BA7850,#333333,#555555',
											),
											'media-grid_pompadour' => array(
												'preset_name' => esc_html__( 'Pompadour', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#974772,template_ftcolor:#7D194F,template_fthovercolor:#974772,template_titlecolor:#7D194F,related_title_color:#7D194F,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#7D194F,#974772,#333333,#555555',
											),
											'media-grid_bronzetone' => array(
												'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#67704E,template_ftcolor:#414C22,template_fthovercolor:#67704E,template_titlecolor:#414C22,related_title_color:#414C22,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#414C22,#67704E,#333333,#555555',
											),
											'media-grid_ce_soir' => array(
												'preset_name' => esc_html__( 'Ce Soir', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#A381BB,template_ftcolor:#8C62AA,template_fthovercolor:#A381BB,template_titlecolor:#8C62AA,related_title_color:#8C62AA,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#8C62AA,#A381BB,#333333,#555555',
											),
											'media-grid_yonder' => array(
												'preset_name' => esc_html__( 'Yonder', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#8BA3CE,template_ftcolor:#6E8CC2,template_fthovercolor:#8BA3CE,template_titlecolor:#6E8CC2,related_title_color:#6E8CC2,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#6E8CC2,#8BA3CE,#333333,#555555',
											),
										),
										'my_diary'         => array(
											'my_diary_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#E21130,template_fthovercolor:#E84159,template_titlecolor:#E21130,related_title_color:#E21130,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#E21130,#E84159,#333333,#555555',
											),
											'my_diary_lemon_ginger' => array(
												'preset_name' => esc_html__( 'Lemon Ginger', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#8C8431,template_fthovercolor:#A39D5A,template_titlecolor:#8C8431,related_title_color:#8C8431,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#8C8431,#A39D5A,#333333,#555555',
											),
											'my_diary_cerulean' => array(
												'preset_name' => esc_html__( 'Cerulean', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#0E7699,template_fthovercolor:#3E91AD,template_titlecolor:#0E7699,related_title_color:#0E7699,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#0E7699,#3E91AD,#333333,#555555',
											),
											'my_diary_mandalay' => array(
												'preset_name' => esc_html__( 'Mandalay', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#A95624,template_fthovercolor:#BA7850,template_titlecolor:#A95624,related_title_color:#A95624,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#A95624,#BA7850,#333333,#555555',
											),
											'my_diary_regal_blue' => array(
												'preset_name' => esc_html__( 'Regal Blue', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#14375F,template_fthovercolor:#435F7F,template_titlecolor:#14375F,related_title_color:#14375F,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#14375F,#435F7F,#333333,#555555',
											),
											'my_diary_yonder' => array(
												'preset_name' => esc_html__( 'Yonder', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#6E8CC2,template_fthovercolor:#8BA3CE,template_titlecolor:#6E8CC2,related_title_color:#6E8CC2,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#6E8CC2,#8BA3CE,#333333,#555555',
											),
										),
										'navia'            => array(
											'navia_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#0E7699,template_fthovercolor:#555555,template_titlecolor:#0E7699,related_title_color:#222222,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#0E7699,#222222,#555555,#999999',
											),
											'navia_toddy'  => array(
												'preset_name' => esc_html__( 'Toddy', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#AE742A,template_fthovercolor:#BE9055,template_titlecolor:#AE742A,related_title_color:#AE742A,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#AE742A,#BE9055,#555555,#999999',
											),
											'navia_bronzetone' => array(
												'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#414C22,template_fthovercolor:#67704E,template_titlecolor:#414C22,related_title_color:#414C22,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#414C22,#67704E,#555555,#999999',
											),
											'navia_regal_blue' => array(
												'preset_name' => esc_html__( 'Regal Blue', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#14375F,template_fthovercolor:#435F7F,template_titlecolor:#14375F,related_title_color:#14375F,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#14375F,#435F7F,#555555,#999999',
											),
											'navia_claret' => array(
												'preset_name' => esc_html__( 'Claret', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#781335,template_fthovercolor:#93425D,template_titlecolor:#781335,related_title_color:#781335,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#781335,#93425D,#555555,#999999',
											),
											'navia_earls_green' => array(
												'preset_name' => esc_html__( 'Earls Green', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#C2AF2F,template_fthovercolor:#CEBF59,template_titlecolor:#C2AF2F,related_title_color:#C2AF2F,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#C2AF2F,#CEBF59,#555555,#999999',
											),
										),
										'news'             => array(
											'news_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#A95624,template_fthovercolor:#555555,template_titlecolor:#A95624,related_title_color:#222222,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#A95624,#222222,#555555,#999999',
											),
											'news_cerulean' => array(
												'preset_name' => esc_html__( 'Cerulean', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#0E7699,template_fthovercolor:#3E91AD,template_titlecolor:#0E7699,related_title_color:#0E7699,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#0E7699,#3E91AD,#555555,#999999',
											),
											'news_pompadour' => array(
												'preset_name' => esc_html__( 'Pompadour', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#7D194F,template_fthovercolor:#974772,template_titlecolor:#7D194F,related_title_color:#7D194F,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#7D194F,#974772,#555555,#999999',
											),
											'news_alizarin' => array(
												'preset_name' => esc_html__( 'Alizarin', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#E81B3A,template_fthovercolor:#ED4961,template_titlecolor:#E81B3A,related_title_color:#E81B3A,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#E81B3A,#ED4961,#555555,#999999',
											),
											'news_wasabi'  => array(
												'preset_name' => esc_html__( 'Wasabi', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#788F3D,template_fthovercolor:#93A564,template_titlecolor:#788F3D,related_title_color:#788F3D,template_contentcolor:#999999,firstletter_contentcolor:#999999',
										...
										'offer_blog'       => array(
											'offer_blog_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#0E7699,template_fthovercolor:#333333,template_titlecolor:#0E7699,related_title_color:#222222,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#0E7699,#222222,#333333,#555555',
											),
											'offer_blog_earls_green' => array(
												'preset_name' => esc_html__( 'Earls Green', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#C2AF2F,template_fthovercolor:#CEBF59,template_titlecolor:#C2AF2F,related_title_color:#C2AF2F,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#C2AF2F,#CEBF59,#333333,#555555',
											),
											'offer_blog_pompadour' => array(
												'preset_name' => esc_html__( 'Pompadour', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#7D194F,template_fthovercolor:#974772,template_titlecolor:#7D194F,related_title_color:#7D194F,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#7D194F,#974772,#333333,#555555',
											),
											'offer_blog_bronzetone' => array(
												'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#414C22,template_fthovercolor:#67704E,template_titlecolor:#414C22,related_title_color:#414C22,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#414C22,#67704E,#333333,#555555',
											),
											'offer_blog_west-side' => array(
												'preset_name' => esc_html__( 'West Side', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#FDF6F1,template_ftcolor:#E4802A,template_fthovercolor:#E99955,template_titlecolor:#E4802A,related_title_color:#E4802A,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#E4802A,#E99955,#333333,#555555',
											),
											'offer_blog_yonder' => array(
												'preset_name' => esc_html__( 'Yonder', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#F5F7FB,template_ftcolor:#6E8CC2,template_fthovercolor:#8BA3CE,template_titlecolor:#6E8CC2,related_title_color:#6E8CC2,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#6E8CC2,#8BA3CE,#333333,#555555',
											),
										),
										...
										'region'           => array(
											...
											'region_alizarin' => array(
												'preset_name' => esc_html__( 'Alizarin', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#E81B3A,template_fthovercolor:#ED4961,template_titlecolor:#E81B3A,related_title_color:#E81B3A,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#E81B3A,#ED4961,#333333,#555555',
											),
											...
											'region_fun_green' => array(
												'preset_name' => esc_html__( 'Fun Green', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#0E663C,template_fthovercolor:#3E8563,template_titlecolor:#0E663C,related_title_color:#0E663C,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#0E663C,#3E8563,#333333,#555555',
											),
											'region_toddy' => array(
												'preset_name' => esc_html__( 'Toddy', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#AE742A,template_fthovercolor:#BE9055,template_titlecolor:#AE742A,related_title_color:#AE742A,template_contentcolor:#555555,firstletter_contentcolor:#555555',
										...
										'roctangle'        => array(
											'roctangle_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_color:#f18293,template_ftcolor:#f18293,template_fthovercolor:#444444,template_titlecolor:#f18293,template_contentcolor:#444444,firstletter_contentcolor:#444444',
												'display_value' => '#f18293,#222222,#444444,#666666',
											),
											'roctangle_sky_blue' => array(
												'preset_name' => esc_html__( 'Sky Blue', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_color:#92E2FD,template_ftcolor:#92E2FD,template_fthovercolor:#444444,template_titlecolor:#92E2FD,template_contentcolor:#444444,firstletter_contentcolor:#444444',
												'display_value' => '#92E2FD,#222222,#444444,#666666',
											),
											'roctangle_lite_green' => array(
												'preset_name' => esc_html__( 'Lite Green', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_color:#0ef58d,template_ftcolor:#0ef58d,template_fthovercolor:#444444,template_titlecolor:#0ef58d,template_contentcolor:#444444,firstletter_contentcolor:#444444',
										...
										'tagly'            => array(
											'tagly_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#d4c6a8,template_ftcolor:#b79a5e,template_fthovercolor:#d4c6a8,template_titlecolor:#b79a5e,related_title_color:#333333,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#b79a5e,#d4c6a8,#333333,#555555',
											),
											'tagly_crimson' => array(
												'preset_name' => esc_html__( 'Crimson', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#E84159,template_ftcolor:#E21130,template_fthovercolor:#E84159,template_titlecolor:#E21130,related_title_color:#E21130,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#E21130,#E84159,#555555,#888888',
											),
											'tagly_cerulean' => array(
												'preset_name' => esc_html__( 'Cerulean', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#3E91AD,template_ftcolor:#0E7699,template_fthovercolor:#3E91AD,template_titlecolor:#0E7699,related_title_color:#0E7699,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#0E7699,#3E91AD,#555555,#888888',
											),
											'tagly_wasabi' => array(
												'preset_name' => esc_html__( 'Wasabi', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#93A564,template_ftcolor:#788F3D,template_fthovercolor:#93A564,template_titlecolor:#788F3D,related_title_color:#788F3D,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#788F3D,#93A564,#555555,#888888',
											),
											'tagly_ce_soir' => array(
												'preset_name' => esc_html__( 'Ce Soir', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#A381BB,template_ftcolor:#8C62AA,template_fthovercolor:#A381BB,template_titlecolor:#8C62AA,related_title_color:#8C62AA,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#8C62AA,#A381BB,#555555,#888888',
											),
											'tagly_earls-green' => array(
												'preset_name' => esc_html__( 'Earls Green', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#CEBF59,template_ftcolor:#C2AF2F,template_fthovercolor:#CEBF59,template_titlecolor:#C2AF2F,related_title_color:#C2AF2F,template_contentcolor:#888888,firstletter_contentcolor:#888888',
												'display_value' => '#C2AF2F,#CEBF59,#555555,#888888',
											),
										),
										'timeline'         => array(
										...
										'winter'           => array(
											'winter_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'winter_category_color:#e7492f,template_ftcolor:#37aece,template_fthovercolor:#444444,template_titlecolor:#37aece,related_title_color:#444444,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#e7492f,#37aece,#444444,#555555',
											),
											'winter_wasabi' => array(
												'preset_name' => esc_html__( 'Wasabi', 'blog-designer-pro' ),
												'preset_value' => 'winter_category_color:#93A564,template_ftcolor:#93A564,template_fthovercolor:#555555,template_titlecolor:#788F3D,related_title_color:#788F3D,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#788F3D,#93A564,#555555,#999999',
											),
											'winter_yonder' => array(
												'preset_name' => esc_html__( 'Yonder', 'blog-designer-pro' ),
												'preset_value' => 'winter_category_color:#8BA3CE,template_ftcolor:#8BA3CE,template_fthovercolor:#555555,template_titlecolor:#6E8CC2,related_title_color:#6E8CC2,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#6E8CC2,#8BA3CE,#555555,#999999',
											),
											'winter_regal_blue' => array(
												'preset_name' => esc_html__( 'Regal Blue', 'blog-designer-pro' ),
												'preset_value' => 'winter_category_color:#435F7F,template_ftcolor:#435F7F,template_fthovercolor:#555555,template_titlecolor:#14375F,related_title_color:#14375F,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#14375F,#435F7F,#555555,#999999',
											),
											'winter_buttercup' => array(
												'preset_name' => esc_html__( 'Buttercup', 'blog-designer-pro' ),
												'preset_value' => 'winter_category_color:#E5A452,template_ftcolor:#E5A452,template_fthovercolor:#555555,template_titlecolor:#DF8D27,related_title_color:#DF8D27,template_contentcolor:#999999,firstletter_contentcolor:#999999',
												'display_value' => '#DF8D27,#E5A452,#555555,#999999',
											),
											'winter_alizarin' => array(
												'preset_name' => esc_html__( 'Alizarin', 'blog-designer-pro' ),
												'preset_value' => 'winter_category_color:#EE4861,template_ftcolor:#EE4861,template_fthovercolor:#555555,template_titlecolor:#EA1A3A,related_title_color:#EA1A3A,template_contentcolor:#999999,firstletter_contentcolor:#999999',
										...
										'minimal'          => array(
											'minimal_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#e84c89,template_fthovercolor:#e84c89,winter_category_color:#e84c89,template_titlecolor:#e84c89,related_title_color:#000000,template_contentcolor:#333333,firstletter_contentcolor:#444444',
												'display_value' => '#ffffff,#e84c89,#444444,#000000',
											),
											'minimal_caribbean' => array(
												'preset_name' => esc_html__( 'Caribbean', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#0EE08B,template_fthovercolor:#0EE08B,winter_category_color:#0EE08B,template_titlecolor:#0EE08B,related_title_color:#043A25,template_contentcolor:#333333,firstletter_contentcolor:#065B39',
												'display_value' => '#DFFBF0,#0EE08B,#065B39,#043A25',
											),
											'minimal_cerulean' => array(
												'preset_name' => esc_html__( 'Cerulean', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#0E5476,template_fthovercolor:#0E5476,winter_category_color:#0E5476,template_titlecolor:#0E5476,related_title_color:#04161E,template_contentcolor:#333333,firstletter_contentcolor:#062230',
												'display_value' => '#DFE8ED,#0E5476,#062230,#04161E',
											),
											'minimal_purple' => array(
												'preset_name' => esc_html__( 'Purple', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#8261DA,template_fthovercolor:#8261DA,winter_category_color:#8261DA,template_titlecolor:#8261DA,related_title_color:#221A39,template_contentcolor:#333333,firstletter_contentcolor:#352859',
												'display_value' => '#EEE9FA,#8261DA,#352859,#221A39',
											),
											'minimal_harvest' => array(
												'preset_name' => esc_html__( 'Harvest', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#E6B571,template_fthovercolor:#E6B571,winter_category_color:#E6B571,template_titlecolor:#E6B571,related_title_color:#3C2F1E,template_contentcolor:#333333,firstletter_contentcolor:#5E4A2E',
												'display_value' => '#FCF5EC,#E6B571,#5E4A2E,#3C2F1E',
											),
											'minimal_scarlet' => array(
												'preset_name' => esc_html__( 'Scarlet', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#F02F18,template_fthovercolor:#F02F18,winter_category_color:#F02F18,template_titlecolor:#F02F18,related_title_color:#3E0C06,template_contentcolor:#333333,firstletter_contentcolor:#62130A',
										...
										'glamour'          => array(
											'glamour_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#f5c034,template_fthovercolor:#444444,template_titlecolor:#f5c034,related_title_color:#000000,template_contentcolor:#444444,firstletter_contentcolor:#444444',
												'display_value' => '#ffffff,#f5c034,#444444,#000000',
											),
											'glamour_aqua' => array(
												'preset_name' => esc_html__( 'Aqua', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#00FFE9,template_fthovercolor:#003531,template_titlecolor:#00FFE9,related_title_color:#00221F,template_contentcolor:#003531,firstletter_contentcolor:#003531',
												'display_value' => '#DDFFFC,#00FFE9,#003531,#00221F',
											),
											'glamour_jade' => array(
												'preset_name' => esc_html__( 'Jade', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#00B97B,template_fthovercolor:#00261A,template_titlecolor:#00B97B,related_title_color:#001811,template_contentcolor:#00261A,firstletter_contentcolor:#00261A',
												'display_value' => '#DDF6ED,#00B97B,#00261A,#001811',
											),
											'glamour_malibu' => array(
												'preset_name' => esc_html__( 'Malibu', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#60C1E8,template_fthovercolor:#152831,template_titlecolor:#60C1E8,related_title_color:#0E1A1F,template_contentcolor:#152831,firstletter_contentcolor:#152831',
												'display_value' => '#E9F6FC,#60C1E8,#152831,#0E1A1F',
											),
											'glamour_bourbon' => array(
												'preset_name' => esc_html__( 'Bourbon', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#AD6F49,template_fthovercolor:#2D1E13,template_titlecolor:#AD6F49,related_title_color:#170F0A,template_contentcolor:#2D1E13,firstletter_contentcolor:#2D1E13',
												'display_value' => '#F4ECE7,#AD6F49,#2D1E13,#170F0A',
											),
											'glamour_raven' => array(
												'preset_name' => esc_html__( 'Raven', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#696F7A,template_fthovercolor:#222528,template_titlecolor:#696F7A,related_title_color:#0E0F11,template_contentcolor:#222528,firstletter_contentcolor:#222528',
										...
										'famous'           => array(
											'famous_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#f20075,template_fthovercolor:#333333,template_titlecolor:#f20075,related_title_color:#333333,template_contentcolor:#555555,firstletter_contentcolor:#555555',
											...
											'famous_vivid_gamboge' => array(
												...
												'preset_value' => 'template_ftcolor:#F99900,template_fthovercolor:#333333,template_titlecolor:#F99900,related_title_color:#333333,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#F99900,#a5a5a5,#555555,#333333',
											),
											'famous_timber_green' => array(
												'preset_name' => esc_html__( 'Timber Green', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#3D3242,template_fthovercolor:#333333,template_titlecolor:#3D3242,related_title_color:#333333,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#3D3242,#a5a5a5,#555555,#333333',
											),
											'famous_jagger' => array(
												'preset_name' => esc_html__( 'Jagger', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#374232,template_fthovercolor:#333333,template_titlecolor:#374232,related_title_color:#333333,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#374232,#a5a5a5,#555555,#333333',
											),
											'famous_barossa' => array(
												'preset_name' => esc_html__( 'Barossa', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#423237,template_fthovercolor:#333333,template_titlecolor:#423237,related_title_color:#333333,template_contentcolor:#555555,firstletter_contentcolor:#555555',
												'display_value' => '#423237,#a5a5a5,#555555,#333333',
											),
											'famous_blumine' => array(
												'preset_name' => esc_html__( 'Blumine', 'blog-designer-pro' ),
												'preset_value' => 'template_ftcolor:#2A5B66,template_fthovercolor:#333333,template_titlecolor:#2A5B66,related_title_color:#333333,template_contentcolor:#555555,firstletter_contentcolor:#555555',
										...
										'fairy'            => array(
											'fairy_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#b6b6b6,template_fthovercolor:#0089bb,template_titlecolor:#0089bb,related_title_color:#000000,template_contentcolor:#5b5b5b,firstletter_contentcolor:#5b5b5b',
												'display_value' => '#ffffff ,#0089bb,#5b5b5b,#000000',
											),
											'fairy_gorse'  => array(
												'preset_name' => esc_html__( 'Gorse', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#7E7415,template_fthovercolor:#F7E229,template_titlecolor:#F7E229,related_title_color:#221E06,template_contentcolor:#342F09,firstletter_contentcolor:#342F09',
												'display_value' => '#FDFBE2 ,#F7E229,#342F09,#221E06',
											),
											'fairy_scampi' => array(
												'preset_name' => esc_html__( 'Scampi', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#393848,template_fthovercolor:#6F6E8D,template_titlecolor:#6F6E8D,related_title_color:#0F0E13,template_contentcolor:#18171E,firstletter_contentcolor:#18171E',
												'display_value' => '#ECECF0 ,#6F6E8D,#18171E,#0F0E13',
											),
											'fairy_crusoe' => array(
												'preset_name' => esc_html__( 'Crusoe', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#083511,template_fthovercolor:#0F6620,template_titlecolor:#0F6620,related_title_color:#020E05,template_contentcolor:#041B09,firstletter_contentcolor:#041B09',
												'display_value' => '#DFEAE1 ,#0F6620,#041B09,#020E05',
											),
											'fairy_seagull' => array(
												'preset_name' => esc_html__( 'Seagull', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#3E5866,template_fthovercolor:#7BADC8,template_titlecolor:#7BADC8,related_title_color:#11171B,template_contentcolor:#202D35,firstletter_contentcolor:#202D35',
												'display_value' => '#EDF4F8 ,#7BADC8,#202D35,#11171B',
											),
											'fairy_persimmon' => array(
												'preset_name' => esc_html__( 'Persimmon', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#722A05,template_fthovercolor:#722A05,template_titlecolor:#DF5309,related_title_color:#1E0B02,template_contentcolor:#2E1202,firstletter_contentcolor:#2E1202',
										...
										'clicky'           => array(
											...
											'clicky_portage' => array(
												...
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#C1C5ED,template_fthovercolor:#2A2B3C,winter_category_color:#2A2B3C,template_titlecolor:#C1C5ED,related_title_color:#2A2B3C,template_contentcolor:#9DA5E4,firstletter_contentcolor:#9DA5E4',
												'display_value' => '#ffffff ,#C1C5ED,#9DA5E4,#2A2B3C',
											),
											'clicky_emerald' => array(
												'preset_name' => esc_html__( 'Emerald', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#229541,template_fthovercolor:#0B3116,winter_category_color:#0B3116,template_titlecolor:#0B3116,related_title_color:#0B3116,template_contentcolor:#686868,firstletter_contentcolor:#165F2A',
										...
										'cover'            => array(
											'cover_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#b6b6b6,template_fthovercolor:#b6b6b6,template_titlecolor:#272727,related_title_color:#272727,template_contentcolor:#696969,firstletter_contentcolor:#696969',
										...
										'foodbox'          => array(
											'foodbox_default' => array(
												'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#6e3d30,template_bgcolor:#f7f4ef,template_ftcolor:#6e3d30,template_fthovercolor:#000000,template_titlecolor:#312725,template_titlehovercolor:#000000',
												'display_value' => '#312725,#000000,#6e3d30,#444444',
											),
											'foodbox_radical' => array(
												'preset_name' => esc_html__( 'Radical', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#4F171C,template_bgcolor:#FDE7E9,template_ftcolor:#F34656,template_fthovercolor:#7C242C,template_titlecolor:#F34656,template_titlehovercolor:#4F171C,template_titlebackcolor:#FDE7E9,template_contentcolor:#7C242C',
												'display_value' => '#FDE7E9,#F34656,#7C242C,#4F171C',
											),
											'Foodbox_tangerine' => array(
												'preset_name' => esc_html__( 'Tangerine', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#efb828,template_bgcolor:#fdf7e7,template_ftcolor:#473505,template_fthovercolor:#473505,template_titlecolor:#473505,template_titlehovercolor:#efb828,template_titlebackcolor:#fdf7e7,template_contentcolor:#171101',
												'display_value' => '#f8df9f,#efb828,#473505,#171101',
											),
											'foodbox_rich-gold' => array(
												'preset_name' => esc_html__( 'Rich Gold', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#A95624,template_bgcolor:#ffd1b6,template_ftcolor:#A95624,template_fthovercolor:#444444,template_titlecolor:#A95624,template_titlehovercolor:#BA7850,template_titlebackcolor:#ffd1b6,template_contentcolor:#444444',
										...
										'neaty_block'      => array(
											...
											'neaty_block_roof_terracotta' => array(
												...
												'preset_value' => 'template_color:#B06F6D,template_bgcolor:#ffffff,template_bghovercolor:#F1E7E7,template_ftcolor:#B06F6D,template_fthovercolor:#555555,template_titlecolor:#9C4B48,template_titlehovercolor:#B06F6D,template_contentcolor:#999999',
												'display_value' => '#9C4B48,#B06F6D,#555555,#999999',
											),
											'neaty_block_bronzetone' => array(
												'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#67704E,template_fthovercolor:#555555,template_titlecolor:#414C22,template_titlehovercolor:#67704E,template_titlebackcolor:#ffffff,template_contentcolor:#999999',
												'display_value' => '#414C22,#67704E,#555555,#999999',
											),
											'offer_yonder' => array(
												'preset_name' => esc_html__( 'Yonder', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#F3F5FA,template_ftcolor:#8BA3CE,template_fthovercolor:#555555,template_titlecolor:#6E8CC2,template_titlehovercolor:#8BA3CE,template_titlebackcolor:#F3F5FA,template_contentcolor:#666666',
										...
										'soft_block'       => array(
											...
											'soft_block_lochmara' => array(
												'preset_name' => esc_html__( 'Lochmara', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#4fbfc1,template_ftcolor:#227CAD,template_fthovercolor:#0E3246,template_titlecolor:#227CAD,template_titlehovercolor:#227CAD,template_contentcolor:#F7FAFC',
												'display_value' => '#F7FAFC,#227CAD,#051117,#09202D',
											),
											'soft_block_burgundy' => array(
												'preset_name' => esc_html__( 'Burgundy', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#4fbfc1,template_ftcolor:#6C0124,template_fthovercolor:#2C010E,template_titlecolor:#6C0124,template_titlehovercolor:#6C0124,template_contentcolor:#FAF6F7',
												'display_value' => '#FAF6F7,#6C0124,#0E0105,#1C0109',
											),
											'soft_block_hillary' => array(
												'preset_name' => esc_html__( 'Hillary', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#4fbfc1,template_ftcolor:#A49E77,template_fthovercolor:#434131,template_titlecolor:#A49E77,template_titlehovercolor:#A49E77,template_contentcolor:#FCFBFA',
												'display_value' => '#FCFBFA,#A49E77,#161610,#2B2A1F',
											),
											'soft_block_amaranth' => array(
												'preset_name' => esc_html__( 'Amaranth', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#4fbfc1,template_ftcolor:#DE364A,template_fthovercolor:#491218,template_titlecolor:#DE364A,template_titlehovercolor:#DE364A,template_contentcolor:#FDF9FA',
												'display_value' => '#FDF9FA,#DE364A,#1E070A,#2E0B0F',
											),
											'soft_block_manatee' => array(
												'preset_name' => esc_html__( 'Manatee', 'blog-designer-pro' ),
												'preset_value' => 'template_bgcolor:#4fbfc1,template_ftcolor:#9699A7,template_fthovercolor:#3E3E45,template_titlecolor:#9699A7,template_titlehovercolor:#9699A7,template_titlebackcolor:#FCFCFD,template_contentcolor:#FCFCFD',
												'display_value' => '#FCFCFD,#9699A7,#151516,#28282C',
											),
										),
										'schedule'         => array(
											...
											'schedule_radical' => array(
												'preset_name' => esc_html__( 'Radical', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#7C242C,template_bgcolor:#ffffff,template_ftcolor:#F9A1A9,template_fthovercolor:#FDE7E9,template_titlecolor:#F34656,template_titlehovercolor:#4F171C,template_titlebackcolor:#FDE7E9,template_contentcolor:#7C242C,winter_category_color:#7C242C',
												'display_value' => '#FDE7E9,#F34656,#7C242C,#4F171C',
											),
											'schedule_mariner' => array(
												'preset_name' => esc_html__( 'Mariner', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#465BAC,template_bgcolor:#ffffff,template_ftcolor:#465BAC,template_fthovercolor:#EAEDF6,template_titlecolor:#465BAC,template_titlehovercolor:#484848,template_titlebackcolor:#eaedf6,template_contentcolor:#7b7b7b,winter_category_color:#465BAC',
												'display_value' => '#465BAC,#EAEDF6,#465BAC,#484848',
											),
											'schedule_flamenco' => array(
												'preset_name' => esc_html__( 'Flamenco', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#683C6F,template_bgcolor:#ffffff,template_ftcolor:#683C6F,template_fthovercolor:#FFF3ED,template_titlecolor:#683C6F,template_titlehovercolor:#484848,template_titlebackcolor:#FFF3ED,template_contentcolor:#7b7b7b,winter_category_color:#683C6F',
												'display_value' => '#683C6F,#FFF3ED,#683C6F,#484848',
											),
											'schedule_finch' => array(
												'preset_name' => esc_html__( 'Finch', 'blog-designer-pro' ),
												'preset_value' => 'template_color:#75815B,template_bgcolor:#ffffff,template_ftcolor:#75815B,template_fthovercolor:#EFF0EB,template_titlecolor:#75815B,template_titlehovercolor:#484848,template_titlebackcolor:#EFF0EB,template_contentcolor:#7b7b7b,winter_category_color:#75815B',
										...
										if ( $allposts ) {
											...
											<select data-placeholder="<?php esc_attr_e( 'Choose Posts', 'blog-designer-pro' ); ?>" class="chosen-select" multiple style="width:220px;" name="template_posts[]" id="template_posts">
												...
												foreach ( $allposts as $single_post_id ) {
													...
													// if ( is_array($template_posts) && !empty($template_posts) && in_array( $single_post->ID, $bdp_settings['template_posts'] ) ) {.
													?>
													<option value="<?php echo esc_attr( $single_post->ID ); ?>"
														<?php
														if ( isset( $bdp_settings['template_posts'] ) && is_array( $bdp_settings['template_posts'] ) && in_array( $single_post->ID, $bdp_settings['template_posts'] ) ) {
															echo 'selected="selected"';
														}
														if ( is_array( $final_posts ) && in_array( $single_post->ID, $final_posts ) ) {
															echo 'disabled="disabled"';
														}
				...
				<div id="bdpsinglestandard" class="postbox postbox-with-fw-options" style=<?php echo esc_attr( $bdpstandard_class_show ); ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							<li class="bdp-main-container-class-li">
								<div class="bdp-left">
									<span class="bdp-key-title">
						...
						<ul class="bdp-settings bdp-lineheight">
							...
							<li class="post_length_line">
								...
								<div class="bdp-right  input_number_of_line">
									...
									<input type="number" id="total_noofline" name="total_noofline" step="1" min="1" value="<?php echo isset( $bdp_settings['total_noofline'] ) ? esc_attr( $bdp_settings['total_noofline'] ) : '2'; ?>"  onkeypress="return isNumberKey(event)">
								</div>
							</li>
							...
							<li class="bdp-typography-setting-li">
							...
							<h3 class="single_post_title_wrap bdp-table-title post_title_border_setting"><?php esc_html_e( 'Single Post Title Margin', 'blog-designer-pro' ); ?></h3>
							<li class="single_post_title_wrap edd_addtocart_button_box_shadow_setting post_title_border_setting">
								<div class="bdp-boxshadow-wrapper bdp-boxshadow-wrapper1">
									<div class="bdp-boxshadow-cover">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_title_marginleft = isset( $bdp_settings['single_post_title_marginleft'] ) ? $bdp_settings['single_post_title_marginleft'] : 0; ?>
											<input type="number" id="single_post_title_marginleft" name="single_post_title_marginleft" step="1" value="<?php echo esc_attr( $single_post_title_marginleft ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_title_marginright = isset( $bdp_settings['single_post_title_marginright'] ) ? $bdp_settings['single_post_title_marginright'] : 0; ?>
											<input type="number" id="single_post_title_marginright" name="single_post_title_marginright" step="1" value="<?php echo esc_attr( $single_post_title_marginright ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_title_margintop = isset( $bdp_settings['single_post_title_margintop'] ) ? $bdp_settings['single_post_title_margintop'] : 0; ?>
											<input type="number" id="single_post_title_margintop" name="single_post_title_margintop" step="1" value="<?php echo esc_attr( $single_post_title_margintop ); ?>"  onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_title_marginbottom = isset( $bdp_settings['single_post_title_marginbottom'] ) ? $bdp_settings['single_post_title_marginbottom'] : 0; ?>
											<input type="number" id="single_post_title_marginbottom" name="single_post_title_marginbottom" step="1" value="<?php echo esc_attr( $single_post_title_marginbottom ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
								</div>
							</li>
							<h3 class="single_post_title_padding_wrap bdp-table-title post_title_border_setting"><?php esc_html_e( 'Single Post Title Padding', 'blog-designer-pro' ); ?></h3>
							<li class="single_post_title_padding_wrap edd_addtocart_button_box_shadow_setting post_title_border_setting">
								<div class="bdp-boxshadow-wrapper bdp-boxshadow-wrapper1">
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
											<span class="bdp-key-title">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_title_paddingleft = isset( $bdp_settings['single_post_title_paddingleft'] ) ? $bdp_settings['single_post_title_paddingleft'] : 0; ?>
											<input type="number" id="single_post_title_paddingleft" name="single_post_title_paddingleft" step="1" value="<?php echo esc_attr( $single_post_title_paddingleft ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_title_paddingright = isset( $bdp_settings['single_post_title_paddingright'] ) ? $bdp_settings['single_post_title_paddingright'] : 0; ?>
											<input type="number" id="single_post_title_paddingright" name="single_post_title_paddingright" step="1" value="<?php echo esc_attr( $single_post_title_paddingright ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_title_paddingtop = isset( $bdp_settings['single_post_title_paddingtop'] ) ? $bdp_settings['single_post_title_paddingtop'] : 0; ?>
											<input type="number" id="single_post_title_paddingtop" name="single_post_title_paddingtop" step="1" value="<?php echo esc_attr( $single_post_title_paddingtop ); ?>"  onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_title_paddingbottom = isset( $bdp_settings['single_post_title_paddingbottom'] ) ? $bdp_settings['single_post_title_paddingbottom'] : 0; ?>
											<input type="number" id="single_post_title_paddingbottom" name="single_post_title_paddingbottom" step="1" value="<?php echo esc_attr( $single_post_title_paddingbottom ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
								</div>
							</li>
				...
				<div id="bdpsingleconent" class="postbox postbox-with-fw-options bdp-content-setting1" style=<?php echo esc_attr( $bdpcontent_class_show ); ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<h3 class="single_post_content_wrap bdp-table-title post_content_border_setting"><?php esc_html_e( 'Single Post Content Margin', 'blog-designer-pro' ); ?></h3>
							<li class="single_post_content_wrap edd_addtocart_button_box_shadow_setting post_content_border_setting">
								<div class="bdp-boxshadow-wrapper bdp-boxshadow-wrapper1">
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
											<span class="bdp-key-title">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_content_marginleft = isset( $bdp_settings['single_post_content_marginleft'] ) ? $bdp_settings['single_post_content_marginleft'] : 0; ?>
											<input type="number" id="single_post_content_marginleft" name="single_post_content_marginleft" step="1" value="<?php echo esc_attr( $single_post_content_marginleft ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_content_marginright = isset( $bdp_settings['single_post_content_marginright'] ) ? $bdp_settings['single_post_content_marginright'] : 0; ?>
											<input type="number" id="single_post_content_marginright" name="single_post_content_marginright" step="1" value="<?php echo esc_attr( $single_post_content_marginright ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_content_margintop = isset( $bdp_settings['single_post_content_margintop'] ) ? $bdp_settings['single_post_content_margintop'] : 0; ?>
											<input type="number" id="single_post_content_margintop" name="single_post_content_margintop" step="1" value="<?php echo esc_attr( $single_post_content_margintop ); ?>"  onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_content_marginbottom = isset( $bdp_settings['single_post_content_marginbottom'] ) ? $bdp_settings['single_post_content_marginbottom'] : 0; ?>
											<input type="number" id="single_post_content_marginbottom" name="single_post_content_marginbottom" step="1" value="<?php echo esc_attr( $single_post_content_marginbottom ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
								</div>
							</li>
							<h3 class="single_post_content_padding_wrap bdp-table-title post_content_border_setting"><?php esc_html_e( 'Single Post Content Padding', 'blog-designer-pro' ); ?></h3>
							<li class="single_post_content_padding_wrap edd_addtocart_button_box_shadow_setting post_content_border_setting">
								<div class="bdp-boxshadow-wrapper bdp-boxshadow-wrapper1">
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
											<span class="bdp-key-title">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_content_paddingleft = isset( $bdp_settings['single_post_content_paddingleft'] ) ? $bdp_settings['single_post_content_paddingleft'] : 0; ?>
											<input type="number" id="single_post_content_paddingleft" name="single_post_content_paddingleft" step="1" value="<?php echo esc_attr( $single_post_content_paddingleft ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_content_paddingright = isset( $bdp_settings['single_post_content_paddingright'] ) ? $bdp_settings['single_post_content_paddingright'] : 0; ?>
											<input type="number" id="single_post_content_paddingright" name="single_post_content_paddingright" step="1" value="<?php echo esc_attr( $single_post_content_paddingright ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_content_paddingtop = isset( $bdp_settings['single_post_content_paddingtop'] ) ? $bdp_settings['single_post_content_paddingtop'] : 0; ?>
											<input type="number" id="single_post_content_paddingtop" name="single_post_content_paddingtop" step="1" value="<?php echo esc_attr( $single_post_content_paddingtop ); ?>"  onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $single_post_content_paddingbottom = isset( $bdp_settings['single_post_content_paddingbottom'] ) ? $bdp_settings['single_post_content_paddingbottom'] : 0; ?>
											<input type="number" id="single_post_content_paddingbottom" name="single_post_content_paddingbottom" step="1" value="<?php echo esc_attr( $single_post_content_paddingbottom ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
								</div>
							</li>
				...
				<div id="bdpsinglemedia" class="postbox postbox-with-fw-options bdp-content-setting1" style=<?php echo esc_attr( $bdpmedia_class_show ); ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<li class="bdp_media_custom_size_tr blog-templatecolor-tr">
								<div class="bdp-left">
									<span class="bdp-key-title">
				...
				<div id="bdpsinglerelated" class="postbox postbox-with-fw-options bdp-content-setting1" style=<?php echo esc_attr( $bdprelated_class_show ); ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							<div class="bdp_grid_col_2 bdp-display-post-single">
								<li class="bdp-related-lineheight">
									...
									<div class="bdp-right">
										...
										<fieldset class="bdp-social-options bdp-display_author buttonset">
											...
											<label for="display_related_post_1"><?php esc_html_e( 'Yes', 'blog-designer-pro' ); ?></label>
											<input id="display_related_post_0" name="display_related_post" type="radio" value="0" <?php checked( 0, $display_related_post ); ?> />
											<label for="display_related_post_0"><?php esc_html_e( 'No', 'blog-designer-pro' ); ?></label>
										</fieldset>
									</div>
								</li>
								<li>
									...
									<div class="bdp-right">
										<select id="bdp_related_post_media_size" name="bdp_related_post_media_size">
											...
											foreach ( $image_size as $s ) {
												...
												if ( in_array( $s, array( 'thumbnail', 'medium', 'large' ) ) ) {
													?>
													<option value="<?php echo esc_html( $s ); ?>" <?php echo ( isset( $bdp_settings['bdp_related_post_media_size'] ) && $bdp_settings['bdp_related_post_media_size'] == $s ) ? 'selected="selected"' : ''; ?>> <?php echo esc_html( $s ) . ' (' . esc_html( get_option( $s . '_size_w' ) ) . 'x' . esc_html( get_option( $s . '_size_h' ) ) . ')'; ?> </option>
													<?php
												} elseif ( isset( $_wp_additional_image_sizes ) && isset( $_wp_additional_image_sizes[ $s ] ) ) {
													?>
														<option value="<?php echo esc_html( $s ); ?>" <?php echo ( isset( $bdp_settings['bdp_related_post_media_size'] ) && $bdp_settings['bdp_related_post_media_size'] == $s ) ? 'selected="selected"' : ''; ?>> <?php echo esc_html( $s ) . ' (' . esc_html( $_wp_additional_image_sizes[ $s ]['width'] ) . 'x' . esc_html( $_wp_additional_image_sizes[ $s ]['height'] ) . ')'; ?> </option>
														<?php
							...
							<li class="bdp_related_post_media_custom_size_tr blog-templatecolor-tr-inner">
								<div class="bdp-left">
									<span class="bdp-key-title">
										<?php esc_html_e( 'Add Custom Size', 'blog-designer-pro' ); ?>
									</span>
							...
							<div class="bdp_grid_col_2 bdp-related-post-title">
								...
								<li class="bdp_related_br bdp_related_font_size">
									<div class="bdp-left">
										<span class="bdp-key-title">
									...
									<div class="bdp-right">
										...
										?>
										<input type="number" class="grid_col_space_val" name="related_title_fontsize" id="related_title_fontsize" value="<?php echo esc_attr( $related_title_fontsize ); ?>" onkeypress="return isNumberKey(event)" />
									</div>
								</li>
								<li>
									<div class="bdp-left">
							...
							<div class="bdp_grid_col_3 bdp-related-post-order-by">
							<li>
								<div class="bdp-left">
									<span class="bdp-key-title">
							...
							<li class="bdp_related_length_div">
								<div class="bdp-left">
									<span class="bdp-key-title">
										<?php esc_html_e( 'Post Content Length', 'blog-designer-pro' ); ?>
									</span><span class="bdp-px-prefix"><?php esc_html_e( '(words)', 'blog-designer-pro' ); ?></span>
								</div>
								<div class="bdp-right">
							...
							<li>
								<div class="bdp-left">
									<span class="bdp-key-title">
										<?php esc_html_e( 'Display Related Post Title', 'blog-designer-pro' ); ?>
									</span>
								</div>
								<div class="bdp-right">
									<?php
					...
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<div class="bdp_grid_col_3">
								...
								<li class ="social_share_options social_share_count_position">
									<div class="bdp-left">
										<span class="bdp-key-title">
				...
				if ( is_plugin_active( 'blog-designer-ads/blog-designer-ads.php' ) ) {
					do_action( 'bdads_do_single_blog_settings', 'tab_content' );
				} else {
					?>
									<div id="bdpadssingle" class="postbox postbox-with-fw-options">
									<div class="inside">
						<?php
						...
						if ( isset( $_GET['page'] ) ) {
							$the_page_id = sanitize_text_field( wp_unslash( $_GET['page'] ) );
						}
						$thetype = $the_page_id;
						?>
										<ul class="bdp-settings bdp-lineheight">
											<li>
												<div class="bdp-left"><?php esc_html_e( 'Ads', 'blog-designer-ads' ); ?></div>
												<div class="bdp-right">
									<?php
									$bdads_ads_set = isset( $bdp_settings['bdads_ads_set'] ) ? $bdp_settings['bdads_ads_set'] : '0';
									?>
													<input type="hidden" name="theid" value="">
													<input type="hidden" name="thetype" value="<?php echo esc_html( $thetype ); ?>">
													<fieldset class="buttonset green buttonset-hide" data-hide='1'>
														<input id="bdads_ads_set_1" name="bdads_ads_set" type="radio" value="1" <?php checked( 1, esc_html( $bdads_ads_set ) ); ?> /><label id="bdp-options-button" for="bdads_ads_set_1" <?php checked( 1, esc_html( $bdads_ads_set ) ); ?>><?php esc_html_e( 'Enable', 'blog-designer-ads' ); ?></label>
														<input id="bdads_ads_set_0" name="bdads_ads_set" type="radio" value="0" <?php checked( 0, esc_html( $bdads_ads_set ) ); ?> /><label id="bdp-options-button" for="bdads_ads_set_0" <?php checked( 0, esc_html( $bdads_ads_set ) ); ?>><?php esc_html_e( 'Disable', 'blog-designer-ads' ); ?></label>
													</fieldset>
												</div>
											</li>
											<li class="bdads_is_random_ads_col">
												<div class="bdp-left"><?php esc_html_e( 'Random Ads', 'blog-designer-ads' ); ?></div>
												<div class="bdp-right">
													<?php $bdads_is_random = isset( $bdp_settings['bdads_is_random'] ) ? $bdp_settings['bdads_is_random'] : '1'; ?>
													<fieldset class="buttonset buttonset-hide" data-hide='1'>
														<input id="bdads_is_random_1" name="bdads_is_random" type="radio" value="1" <?php checked( 1, $bdads_is_random ); ?> /><label id="bdp-options-button" for="bdads_is_random_1" <?php checked( 1, $bdads_is_random ); ?>><?php esc_html_e( 'Enable', 'blog-designer-ads' ); ?></label>
														<input id="bdads_is_random_0" name="bdads_is_random" type="radio" value="0" <?php checked( 0, $bdads_is_random ); ?> /><label id="bdp-options-button" for="bdads_is_random_0" <?php checked( 0, $bdads_is_random ); ?>><?php esc_html_e( 'Disable', 'blog-designer-ads' ); ?></label>
													</fieldset>
												</div>
											</li>
											<li class="bdads_to_repeate_col">
												<div class="bdp-left"><?php esc_html_e( 'Select Ads', 'blog-designer-ads' ); ?></div>
												<div class="bdp-right">
													<?php
													$ads = get_posts(
														array(
													...
													if ( $ads ) {
														if ( isset( $bdp_settings['bdads_to_repeate'] ) ) {
															$bdads_to_repeate = $bdp_settings['bdads_to_repeate'];
														} else {
															$bdads_to_repeate = array();
														}
														echo '<select  name="bdads_to_repeate[]" multiple>';
														foreach ( $ads as $ad ) {
															$ad_id    = (int) $ad->ID;
															$ad_title = $ad->post_title;
															if ( in_array( $ad_id, $bdads_to_repeate ) ) {
																$is_selected = 'selected="selected"';
															} else {
																$is_selected = '';
															}
															echo '<option value="' . (int) $ad_id . '" ' . esc_html( $is_selected ) . '>' . esc_html( $ad_title ) . '</option>';
														}
														echo '</select>';
													} else {
														echo '<select  name="bdads_to_repeate">';
														echo '<option value="" >' . esc_html__( 'No Ads Created', 'blog-designer-ads' ) . '</option>';
														echo '</select>';
													}
													?>
												</div>
											</li>
											<li class="bdads_show_post_ads_col">
												<?php $bdads_to_show_after = isset( $bdp_settings['bdads_to_show_after'] ) ? $bdp_settings['bdads_to_show_after'] : 'main_content'; ?>
												<div class="bdp-left"><?php esc_html_e( 'Show Ad after single post content', 'blog-designer-ads' ); ?></div>
												<div class="bdp-right">
													<select name="bdads_to_show_after">
														<option value="main_content" <?php echo selected( 'main_content', $bdads_to_show_after ); ?>><?php esc_html_e( 'Main Content' ); ?></option>
														<option value="author_content" <?php echo selected( 'author_content', $bdads_to_show_after ); ?>><?php esc_html_e( 'Author Content' ); ?></option>
														<option value="post_navigation" <?php echo selected( 'post_navigation', $bdads_to_show_after ); ?>><?php esc_html_e( 'Post Navigation' ); ?></option>
														<option value="relatet_post" <?php echo selected( 'relatet_post', $bdads_to_show_after ); ?>><?php esc_html_e( 'Related Post' ); ?></option>
													</select>
												</div>
											</li>
											<li class="bdads_number_of_ads_col">
												<?php $number_of_ads = isset( $bdp_settings['number_of_ads'] ) ? $bdp_settings['number_of_ads'] : '1'; ?>
												<div class="bdp-left"><?php esc_html_e( 'Show Number Of Ads', 'blog-designer-ads' ); ?></div>
												<div class="bdp-right">
													<input type="number" id="number_of_ads" name="number_of_ads" step="1" min="0" value="<?php echo esc_html( $number_of_ads ); ?>" onkeypress="return isNumberKey(event)">
												</div>
											</li>
											<li class="bdads_show_post_ads_col">
												<?php $bdads_number_of_col = isset( $bdp_settings['bdads_number_of_col'] ) ? $bdp_settings['bdads_number_of_col'] : '1'; ?>
												<div class="bdp-left"><?php esc_html_e( 'Number Of Column Ads', 'blog-designer-ads' ); ?></div>
												<div class="bdp-right">
													<select name="bdads_number_of_col">
														<option value="1" <?php echo selected( '1', $bdads_number_of_col ); ?>>1 <?php esc_html_e( 'column' ); ?></option>
														<option value="2" <?php echo selected( '2', $bdads_number_of_col ); ?>>2 <?php esc_html_e( 'columns' ); ?></option>
														<option value="3" <?php echo selected( '3', $bdads_number_of_col ); ?>>3 <?php esc_html_e( 'columns' ); ?></option>
														<option value="4" <?php echo selected( '4', $bdads_number_of_col ); ?>>4 <?php esc_html_e( 'columns' ); ?></option>
													</select>
												</div>
											</li>
										</ul>
