...
if ( isset( $_GET['page'] ) && 'add_edd_archive' === $_GET['page'] ) {
	...
	if ( isset( $_GET['id'] ) && ! empty( $_GET['id'] ) ) {
		...
		if ( is_serialized( $allsettings ) ) {
			...
			$custom_archive_type = $get_allsettings[0]['download_archive_template'];
		}
	}
}
...
$template_readmorebackcolor     = isset( $bdp_settings['template_readmorebackcolor'] ) ? $bdp_settings['template_readmorebackcolor'] : '#999999';
...
<div class="wrap">
	...
	<h1 class="bdp-shortcode-div">
		...
		<?php if ( isset( $_GET['action'] ) && 'edit' === $_GET['action'] && isset( $_GET['id'] ) ) { ?>
			...
			<a class="page-title-action bdp_create_new_layout" href="?page=add_edd_archive">
				<?php esc_html_e( 'Create New Product Archive Layout', 'blog-designer-pro' ); ?>
			</a>
			</div>
		<?php } ?>
	</h1>
	...
	<form method="post" action="" id="edit_archive_layout_form" class="bd-form-class bdp-download-archive-page">
		<?php
		wp_nonce_field( 'bdp-download-archive-page-submit', 'bdp-download-archive-nonce' );
		$page = '';
		...
		<div id="poststuff">
			<div class="postbox-container bd-settings-wrappers bd_poststuff">
				...
				<div class="bd-menu-setting">
					...
					$bdpeddsetting_class_show       = '';
					if ( Bdp_Posts::postbox_classes( 'bdpdownloadgeneral', $page ) ) {
					...
					} elseif ( Bdp_Posts::postbox_classes( 'bdpeddsettings', $page ) ) {
						$bdpeddsetting_class      = 'bd-active-tab';
						$bdpeddsetting_class_show = 'display:block';
					...
					<ul class="bd-setting-handle">
						<li data-show="bdpdownloadgeneral" class=<?php echo esc_attr( $bdpgeneral_class ); ?>>
						...
						<li data-show="bdpeddsettings" class=<?php echo esc_attr( $bdpeddsetting_class ); ?>>
							<div class="bdp_tab_icon">
				...
				<div id="bdpdownloadgeneral" class="postbox postbox-with-fw-options" style=<?php echo esc_attr( $bdpgeneral_class_show ); ?>>
					<div class="inside">
...
" />
							...
							<li class="template_color_preset">
								<div class="bdp-left">
									<span class="bdp-key-title">
										...
										$template_color_preset = array(
											...
											'classical'    => array(
												'classical_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_ftcolor:#2a97ea,template_fthovercolor:#555555,template_titlecolor:#222222,template_titlehovercolor:#2a97ea,template_titlebackcolor:#ffffff,template_contentcolor:#999999,template_readmorecolor:#f1f1f1,template_readmorebackcolor:#2a97ea,beforeloop_readmorecolor:#2a97ea,beforeloop_readmorebackcolor:#f1f1f1,beforeloop_readmorehovercolor:#f1f1f1,beforeloop_readmorehoverbackcolor:#2a97ea,bdp_edd_price_color:#2a97ea,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#999999,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#2a97ea,template_readmore_hover_backcolor:#2a97ea',
													'display_value' => '#2a97ea,#222222,#555555,#999999',
												),
												'classical_cerulean' => array(
													'preset_name' => esc_html__( 'Cerulean', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_ftcolor:#0E7699,template_fthovercolor:#3E91AD,template_titlecolor:#555555,template_titlehovercolor:#3E91AD,template_titlebackcolor:#ffffff,template_contentcolor:#999999,template_readmorecolor:#3E91AD,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#3E91AD,beforeloop_readmorebackcolor:#f1f1f1,beforeloop_readmorehovercolor:#f1f1f1,beforeloop_readmorehoverbackcolor:#3E91AD,bdp_edd_price_color:#333333,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#999999,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#0E7699,template_readmore_hover_backcolor:#0E7699',
													'display_value' => '#0E7699,#3E91AD,#555555,#999999',
												),
												'classical_fun_green' => array(
													'preset_name' => esc_html__( 'Fun Green', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_ftcolor:#0E663C,template_fthovercolor:#3E8563,template_titlecolor:#555555,template_titlehovercolor:#3E8563,template_titlebackcolor:#ffffff,template_contentcolor:#999999,template_readmorecolor:#3E8563,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#3E8563,beforeloop_readmorebackcolor:#f1f1f1,beforeloop_readmorehovercolor:#f1f1f1,beforeloop_readmorehoverbackcolor:#3E8563,bdp_edd_price_color:#333333,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#999999,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#0E663C,template_readmore_hover_backcolor:#0E663C',
													'display_value' => '#0E663C,#3E8563,#555555,#999999',
												),
												'classical_blackberry' => array(
													'preset_name' => esc_html__( 'Blackberry', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_ftcolor:#49182D,template_fthovercolor:#6D4657,template_titlecolor:#555555,template_titlehovercolor:#6D4657,template_titlebackcolor:#ffffff,template_contentcolor:#999999,template_readmorecolor:#6D4657,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#6D4657,beforeloop_readmorebackcolor:#f1f1f1,beforeloop_readmorehovercolor:#f1f1f1,beforeloop_readmorehoverbackcolor:#6D4657,bdp_edd_price_color:#333333,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#999999,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#49182D,template_readmore_hover_backcolor:#49182D',
													'display_value' => '#49182D,#6D4657,#555555,#999999',
												),
												'classical_earls_green' => array(
													'preset_name' => esc_html__( 'Earls Green', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_ftcolor:#C2AF2F,template_fthovercolor:#CEBF59,template_titlecolor:#555555,template_titlehovercolor:#CEBF59,template_titlebackcolor:#ffffff,template_contentcolor:#999999,template_readmorecolor:#CEBF59,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#CEBF59,beforeloop_readmorebackcolor:#f1f1f1,beforeloop_readmorehovercolor:#f1f1f1,beforeloop_readmorehoverbackcolor:#CEBF59,bdp_edd_price_color:#333333,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#999999,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#C2AF2F,template_readmore_hover_backcolor:#C2AF2F',
													'display_value' => '#C2AF2F,#CEBF59,#555555,#999999',
												),
												'classical_toddy' => array(
													'preset_name' => esc_html__( 'Toddy', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_ftcolor:#AE742A,template_fthovercolor:#BE9055,template_titlecolor:#555555,template_titlehovercolor:#BE9055,template_titlebackcolor:#ffffff,template_contentcolor:#999999,template_readmorecolor:#BE9055,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#BE9055,beforeloop_readmorebackcolor:#f1f1f1,beforeloop_readmorehovercolor:#f1f1f1,beforeloop_readmorehoverbackcolor:#BE9055,bdp_edd_price_color:#333333,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#999999,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#AE742A,template_readmore_hover_backcolor:#AE742A',
													'display_value' => '#AE742A,#BE9055,#555555,#999999',
												),
											),
											'clicky'       => array(
											...
											'easy_timeline' => array(
												'easy_timeline_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_ftcolor:#C58A3C,template_fthovercolor:#555555,template_titlecolor:#222222,template_titlehovercolor:#C58A3C,template_readmorecolor:#C58A3C,template_readmorebackcolor:#ffffff,template_contentcolor:#555555,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#C58A3C,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#222222',
													'display_value' => '#ffffff,#C58A3C,#222222,#555555',
												),
												'easy_timeline_crimson' => array(
													'preset_name' => esc_html__( 'Crimson', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#E21130,template_ftcolor:#ffffff,template_fthovercolor:#f1f1f1,template_titlecolor:#ffffff,template_titlehovercolor:#f1f1f1,template_readmorecolor:#E21130,template_readmorebackcolor:#ffffff,template_contentcolor:#ffffff,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#E21130,bdp_edd_addtocart_backgroundcolor:#ffffff,bdp_edd_addtocart_text_hover_color:#E21130,bdp_edd_addtocart_hover_backgroundcolor:#ffffff',
													'display_value' => '#E21130,#ffffff,#f1f1f1,#E21130',
												),
												'easy_timeline_flamenco' => array(
													'preset_name' => esc_html__( 'Flamenco', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#E18942,template_ftcolor:#ffffff,template_fthovercolor:#f1f1f1,template_titlecolor:#ffffff,template_titlehovercolor:#f1f1f1,template_readmorecolor:#E18942,template_readmorebackcolor:#ffffff,template_contentcolor:#ffffff,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#E18942,bdp_edd_addtocart_backgroundcolor:#ffffff,bdp_edd_addtocart_text_hover_color:#E18942,bdp_edd_addtocart_hover_backgroundcolor:#ffffff',
													'display_value' => '#E18942,#ffffff,#f1f1f1,#E18942',
												),
												'easy_timeline_jagger' => array(
													'preset_name' => esc_html__( 'Jagger', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#3D3242,template_ftcolor:#ffffff,template_fthovercolor:#f1f1f1,template_titlecolor:#ffffff,template_titlehovercolor:#f1f1f1,template_readmorecolor:#3D3242,template_readmorebackcolor:#ffffff,template_contentcolor:#ffffff,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#3D3242,bdp_edd_addtocart_backgroundcolor:#ffffff,bdp_edd_addtocart_text_hover_color:#3D3242,bdp_edd_addtocart_hover_backgroundcolor:#ffffff',
													'display_value' => '#3D3242,#ffffff,#f1f1f1,#3D3242',
												),
												'easy_timeline_camelot' => array(
													'preset_name' => esc_html__( 'Camelot', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#7A3E48,template_ftcolor:#ffffff,template_fthovercolor:#f1f1f1,template_titlecolor:#ffffff,template_titlehovercolor:#f1f1f1,template_readmorecolor:#7A3E48,template_readmorebackcolor:#ffffff,template_contentcolor:#ffffff,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#7A3E48,bdp_edd_addtocart_backgroundcolor:#ffffff,bdp_edd_addtocart_text_hover_color:#7A3E48,bdp_edd_addtocart_hover_backgroundcolor:#ffffff',
													'display_value' => '#7A3E48,#ffffff,#f1f1f1,#7A3E48',
												),
												'easy_timeline_sundance' => array(
													'preset_name' => esc_html__( 'Sundance', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#C59F4A,template_ftcolor:#ffffff,template_fthovercolor:#f1f1f1,template_titlecolor:#ffffff,template_titlehovercolor:#f1f1f1,template_readmorecolor:#C59F4A,template_readmorebackcolor:#ffffff,template_contentcolor:#ffffff,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#C59F4A,bdp_edd_addtocart_backgroundcolor:#ffffff,bdp_edd_addtocart_text_hover_color:#C59F4A,bdp_edd_addtocart_hover_backgroundcolor:#ffffff',
											...
											'elina'        => array(
												'elina_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#3E91AD,template_fthovercolor:#555555,template_titlecolor:#222222,template_titlehovercolor:#3E91AD,template_readmorecolor:#3E91AD,template_readmorebackcolor:#666666,template_contentcolor:#666666,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#3E91AD,beforeloop_readmorehovercolor:#3E91AD,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#222222,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#3E91AD,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#222222',
													'display_value' => '#3E91AD,#222222,#555555,#666666',
												),
												'elina_crimson' => array(
													'preset_name' => esc_html__( 'Crimson', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#FDEEF1,template_ftcolor:#555555,template_fthovercolor:#E84159,template_titlecolor:#E21130,template_titlehovercolor:#E84159,template_readmorecolor:#E84159,template_readmorebackcolor:#666666,template_contentcolor:#666666,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#E84159,beforeloop_readmorehovercolor:#E84159,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#E21130,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#E84159,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#555555',
													'display_value' => '#E21130,#E84159,#555555,#666666',
												),
												'elina_bronzetone' => array(
													'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#F1F3F0,template_ftcolor:#555555,template_fthovercolor:#67704E,template_titlecolor:#414C22,template_titlehovercolor:#67704E,template_readmorecolor:#67704E,template_readmorebackcolor:#666666,template_contentcolor:#666666,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#67704E,beforeloop_readmorehovercolor:#67704E,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#414C22,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#67704E,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#555555',
													'display_value' => '#414C22,#67704E,#555555,#666666',
												),
												'elina_toddy' => array(
													'preset_name' => esc_html__( 'Toddy', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#F9F5F1,template_ftcolor:#555555,template_fthovercolor:#BE9055,template_titlecolor:#AE742A,template_titlehovercolor:#BE9055,template_readmorecolor:#BE9055,template_readmorebackcolor:#666666,template_contentcolor:#666666,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#BE9055,beforeloop_readmorehovercolor:#BE9055,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#AE742A,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#BE9055,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#555555',
											...
											'explore'      => array(
												'explore_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'grid_hoverback_color:#000000,template_ftcolor:#e0e0e0,template_fthovercolor:#ffffff,template_titlecolor:#e0e0e0,template_titlehovercolor:#ffffff,beforeloop_readmorecolor:#e0e0e0,beforeloop_readmorebackcolor:#000000,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#000000,bdp_edd_price_color:#e0e0e0,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#000000,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#000000',
													'display_value' => '#000000,#e0e0e0,#ffffff,#e0e0e0',
												),
												'explore_mariner' => array(
													'preset_name' => esc_html__( 'Mariner', 'blog-designer-pro' ),
													'preset_value' => 'grid_hoverback_color:#465BAC,template_ftcolor:#e0e0e0,template_fthovercolor:#ffffff,template_titlecolor:#e0e0e0,template_titlehovercolor:#ffffff,beforeloop_readmorecolor:#465BAC,beforeloop_readmorebackcolor:#e0e0e0,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#465BAC,bdp_edd_price_color:#e0e0e0,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#465BAC,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#465BAC',
													'display_value' => '#465BAC,#e0e0e0,#ffffff,#e0e0e0',
												),
												'explore_radical_red' => array(
													'preset_name' => esc_html__( 'Radical Red', 'blog-designer-pro' ),
													'preset_value' => 'grid_hoverback_color:#FA336C,template_ftcolor:#e0e0e0,template_fthovercolor:#ffffff,template_titlecolor:#e0e0e0,template_titlehovercolor:#ffffff,beforeloop_readmorecolor:#FA336C,beforeloop_readmorebackcolor:#e0e0e0,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#FA336C,bdp_edd_price_color:#e0e0e0,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#FA336C,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#FA336C',
													'display_value' => '#FA336C,#e0e0e0,#ffffff,#e0e0e0',
												),
												'explore_finch' => array(
													'preset_name' => esc_html__( 'Finch', 'blog-designer-pro' ),
													'preset_value' => 'grid_hoverback_color:#75815B,template_ftcolor:#e0e0e0,template_fthovercolor:#ffffff,template_titlecolor:#e0e0e0,template_titlehovercolor:#ffffff,beforeloop_readmorecolor:#75815B,beforeloop_readmorebackcolor:#e0e0e0,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#75815B,bdp_edd_price_color:#e0e0e0,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#75815B,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#75815B',
												...
												'explore_vivid_gamboge' => array(
													...
													'preset_value' => 'grid_hoverback_color:#f99900,template_ftcolor:#e0e0e0,template_fthovercolor:#ffffff,template_titlecolor:#e0e0e0,template_titlehovercolor:#ffffff,beforeloop_readmorecolor:#f99900,beforeloop_readmorebackcolor:#e0e0e0,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#f999000,bdp_edd_price_color:#e0e0e0,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#f99900,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#f99900',
												...
												'explore_moderate-orange' => array(
													...
													'preset_value' => 'grid_hoverback_color:#8B6632,template_ftcolor:#e0e0e0,template_fthovercolor:#ffffff,template_titlecolor:#e0e0e0,template_titlehovercolor:#ffffff,beforeloop_readmorecolor:#8B6632,beforeloop_readmorebackcolor:#e0e0e0,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#8B6632,bdp_edd_price_color:#e0e0e0,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#8B6632,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#8B6632',
											...
											'famous'       => array(
												'famous_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#f42887,template_fthovercolor:#333333,template_titlecolor:#777777,template_titlehovercolor:#333333,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#f42887,template_readmore_hover_backcolor:#333333,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#f42887,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#f42887,bdp_edd_price_color:#777777,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#f42887,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#ffffff,#f42887,#333333,#777777',
												),
												'famous_vivid_gamboge' => array(
													'preset_name' => esc_html__( 'Vivid Gamboge', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#fef4e5,template_ftcolor:#f99900,template_fthovercolor:#333333,template_titlecolor:#777777,template_titlehovercolor:#333333,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#f99900,template_readmore_hover_backcolor:#333333,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#f99900,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#f99900,bdp_edd_price_color:#777777,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#f99900,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#fef4e5,#f99900,#333333,#777777',
												),
												'famous_jagger' => array(
													'preset_name' => esc_html__( 'Jagger', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ebeaec,template_ftcolor:#3d3242,template_fthovercolor:#333333,template_titlecolor:#777777,template_titlehovercolor:#333333,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#3d3242,template_readmore_hover_backcolor:#333333,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#3d3242,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#3d3242,bdp_edd_price_color:#777777,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#3d3242,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#ebeaec,#3d3242,#333333,#777777',
												),
												'famous_timber_green' => array(
													'preset_name' => esc_html__( 'Timber Green', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ebeaec,template_ftcolor:#374232,template_fthovercolor:#333333,template_titlecolor:#777777,template_titlehovercolor:#333333,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#374232,template_readmore_hover_backcolor:#333333,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#374232,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#374232,bdp_edd_price_color:#777777,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#374232,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#ebecea,#374232,#333333,#777777',
												),
												'famous_barossa' => array(
													'preset_name' => esc_html__( 'Barossa', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ebeaec,template_ftcolor:#423237,template_fthovercolor:#333333,template_titlecolor:#777777,template_titlehovercolor:#333333,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#423237,template_readmore_hover_backcolor:#333333,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#423237,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#423237,bdp_edd_price_color:#777777,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#423237,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#eceaeb,#423237,#333333,#777777',
												),
												'famous_blumine' => array(
													'preset_name' => esc_html__( 'Blumine', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#e9eeef,template_ftcolor:#2a5b66,template_fthovercolor:#333333,template_titlecolor:#777777,template_titlehovercolor:#333333,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#2a5b66,template_readmore_hover_backcolor:#333333,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#2a5b66,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#2a5b66,bdp_edd_price_color:#777777,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#2a5b66,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
											...
											'glossary'     => array(
												'glossary_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#E84159,template_fthovercolor:#555555,template_titlecolor:#222222,template_titlehovercolor:#E84159,template_titlebackcolor:#ffffff,template_contentcolor:#999999,template_content_hovercolor:#E84159,template_readmorecolor:#ffffff,template_readmorebackcolor:#E84159,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#E84159,beforeloop_readmorehovercolor:#E84159,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#222222,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#E84159,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#E84159,#222222,#555555,#999999',
												),
												'glossary_madras' => array(
													'preset_name' => esc_html__( 'Madras', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#555555,template_fthovercolor:#6D6145,template_titlecolor:#493917,template_titlehovercolor:#6D6145,template_titlebackcolor:#ffffff,template_contentcolor:#999999,template_content_hovercolor:#6D6145,template_readmorecolor:#ffffff,template_readmorebackcolor:#6D6145,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#6D6145,beforeloop_readmorehovercolor:#6D6145,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#6D6145,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#493917,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#493917,#6D6145,#555555,#999999',
												),
												'glossary_pompadour' => array(
													'preset_name' => esc_html__( 'Pompadour', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#555555,template_fthovercolor:#974772,template_titlecolor:#7D194F,template_titlehovercolor:#974772,template_titlebackcolor:#ffffff,template_contentcolor:#999999,template_content_hovercolor:#974772,template_readmorecolor:#ffffff,template_readmorebackcolor:#974772,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#974772,beforeloop_readmorehovercolor:#974772,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#974772,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#7D194F,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#7D194F,#974772,#555555,#999999',
												),
												'glossary_bronzetone' => array(
													'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#E5E7E1,template_ftcolor:#555555,template_fthovercolor:#67704E,template_titlecolor:#414C22,template_titlehovercolor:#6D6145,template_titlebackcolor:#E5E7E1,template_contentcolor:#999999,template_content_hovercolor:#67704E,template_readmorecolor:#ffffff,template_readmorebackcolor:#67704E,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#67704E,beforeloop_readmorehovercolor:#67704E,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#67704E,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#414C22,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#414C22,#67704E,#555555,#999999',
												),
												'glossary_peru_tan' => array(
													'preset_name' => esc_html__( 'Peru Tan', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#EDE5E1,template_ftcolor:#555555,template_fthovercolor:#916748,template_titlecolor:#75411A,template_titlehovercolor:#916748,template_titlebackcolor:#EDE5E1,template_contentcolor:#999999,template_content_hovercolor:#916748,template_readmorecolor:#ffffff,template_readmorebackcolor:#916748,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#916748,beforeloop_readmorehovercolor:#916748,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#916748,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#75411A,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#75411A,#916748,#555555,#999999',
												),
												'glossary_buttercup' => array(
													'preset_name' => esc_html__( 'Buttercup', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#FAF0E2,template_ftcolor:#555555,template_fthovercolor:#E5A452,template_titlecolor:#DF8D27,template_titlehovercolor:#E5A452,template_titlebackcolor:#FAF0E2,template_contentcolor:#999999,template_content_hovercolor:#E5A452,template_readmorecolor:#ffffff,template_readmorebackcolor:#E5A452,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#E5A452,beforeloop_readmorehovercolor:#E5A452,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#E5A452,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#DF8D27,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
											...
											'hoverbic'     => array(
												'hoverbic_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'grid_hoverback_color:#000000,template_ftcolor:#ff9600,template_fthovercolor:#ffffff,template_titlecolor:#e0e0e0,template_titlehovercolor:#ff9600,beforeloop_readmorecolor:#e0e0e0,beforeloop_readmorebackcolor:#000000,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#000000,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#000000,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#000000',
													'display_value' => '#000000,#ff9600,#ffffff,#e0e0e0',
												),
												'hoverbic_mariner' => array(
													'preset_name' => esc_html__( 'Mariner', 'blog-designer-pro' ),
													'preset_value' => 'grid_hoverback_color:#465BAC,template_ftcolor:#e0e0e0,template_fthovercolor:#ffffff,template_titlecolor:#e0e0e0,template_titlehovercolor:#ffffff,beforeloop_readmorecolor:#465BAC,beforeloop_readmorebackcolor:#e0e0e0,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#465BAC,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#465BAC,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#465BAC',
													'display_value' => '#465BAC,#e0e0e0,#ffffff,#e0e0e0',
												),
												'hoverbic_radical_red' => array(
													'preset_name' => esc_html__( 'Radical Red', 'blog-designer-pro' ),
													'preset_value' => 'grid_hoverback_color:#FA336C,template_ftcolor:#e0e0e0,template_fthovercolor:#ffffff,template_titlecolor:#e0e0e0,template_titlehovercolor:#ffffff,beforeloop_readmorecolor:#FA336C,beforeloop_readmorebackcolor:#e0e0e0,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#FA336C,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#FA336C,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#FA336C',
													'display_value' => '#FA336C,#e0e0e0,#ffffff,#e0e0e0',
												),
												...
												'hoverbic_vivid_gamboge' => array(
													'preset_name' => esc_html__( 'Vivid Gamboge', 'blog-designer-pro' ),
													'preset_value' => 'grid_hoverback_color:#f99900,template_ftcolor:#e0e0e0,template_fthovercolor:#ffffff,template_titlecolor:#e0e0e0,template_titlehovercolor:#ffffff,beforeloop_readmorecolor:#f99900,beforeloop_readmorebackcolor:#e0e0e0,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#f999000,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#f99900,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#f99900',
													'display_value' => '#f99900,#e0e0e0,#ffffff,#e0e0e0',
												),
												'hoverbic_moderate-orange' => array(
													'preset_name' => esc_html__( 'Moderate Orange', 'blog-designer-pro' ),
													'preset_value' => 'grid_hoverback_color:#8B6632,template_ftcolor:#e0e0e0,template_fthovercolor:#ffffff,template_titlecolor:#e0e0e0,template_titlehovercolor:#ffffff,beforeloop_readmorecolor:#8B6632,beforeloop_readmorebackcolor:#e0e0e0,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#8B6632,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#8B6632,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#8B6632',
													'display_value' => '#8B6632,#e0e0e0,#ffffff,#e0e0e0',
												),
											),
											'hub'          => array(
											...
											'masonry_timeline' => array(
												'masonry_timeline_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#A39D5A,template_fthovercolor:#555555,template_titlecolor:#222222,template_titlehovercolor:#A39D5A,template_contentcolor:#666666,template_readmorecolor:#666666,template_readmorebackcolor:#A39D5A,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#A39D5A,beforeloop_readmorehovercolor:#A39D5A,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#222222,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#A39D5A,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#666666',
													'display_value' => '#A39D5A,#222222,#555555,#666666',
												),
												'masonry_timeline_crimson' => array(
													'preset_name' => esc_html__( 'Crimson', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#555555,template_fthovercolor:#E84159,template_titlecolor:#E21130,template_titlehovercolor:#E84159,template_contentcolor:#666666,template_readmorecolor:#666666,template_readmorebackcolor:#E21130,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#E21130,beforeloop_readmorehovercolor:#E21130,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#E84159,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#E21130,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#666666',
													'display_value' => '#E21130,#E84159,#555555,#666666',
												),
												...
												'masonry_timeline_cerulean' => array(
													'preset_name' => esc_html__( 'Cerulean', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#EEF6F8,template_ftcolor:#555555,template_fthovercolor:#EEF6F8,template_titlecolor:#0E7699,template_titlehovercolor:#EEF6F8,template_contentcolor:#666666,template_readmorecolor:#666666,template_readmorebackcolor:#0E7699,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#EEF6F8,beforeloop_readmorehovercolor:#EEF6F8,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#0E7699,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#0E7699,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#666666',
													'display_value' => '#0E7699,#3E91AD,#555555,#666666',
												),
												'masonry_timeline_buttercup' => array(
													'preset_name' => esc_html__( 'Buttercup', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#FDF7F1,template_ftcolor:#555555,template_fthovercolor:#E5A452,template_titlecolor:#DF8D27,template_titlehovercolor:#E5A452,template_contentcolor:#666666,template_readmorecolor:#666666,template_readmorebackcolor:#E5A452,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#E5A452,beforeloop_readmorehovercolor:#E5A452,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#DF8D27,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#DF8D27,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#666666',
													'display_value' => '#DF8D27,#E5A452,#555555,#666666',
												),
												'masonry_timeline_red_violet' => array(
													'preset_name' => esc_html__( 'Red Violet', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#FAF0F6,template_ftcolor:#555555,template_fthovercolor:#C44C91,template_titlecolor:#B51F76,template_titlehovercolor:#C44C91,template_contentcolor:#666666,template_readmorecolor:#666666,template_readmorebackcolor:#C44C91,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#C44C91,beforeloop_readmorehovercolor:#C44C91,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#B51F76,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#B51F76,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#666666',
											...
											'media-grid'   => array(
												...
												'media-grid_pacific_venetian_red' => array(
													...
													'preset_value' => 'template_ftcolor:#CC0001,template_fthovercolor:#2b2b2b,template_titlecolor:#CC0001,template_titlehovercolor:#2b2b2b,template_contentcolor:#7b6b79,template_readmorecolor:#dddddd,template_readmorebackcolor:#CC0001,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#CC0001,beforeloop_readmorehovercolor:#CC0001,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#2b2b2b,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#CC0001,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#2b2b2b,template_readmore_hover_backcolor:#CC0001',
											...
											'news'         => array(
												'news_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#AF583D,template_fthovercolor:#555555,template_titlecolor:#222222,template_titlehovercolor:#AF583D,template_titlebackcolor:#ffffff,template_contentcolor:#444444,template_readmorecolor:#AF583D,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#f1f1f1,beforeloop_readmorebackcolor:#AF583D,beforeloop_readmorehovercolor:#AF583D,beforeloop_readmorehoverbackcolor:#f1f1f1,bdp_edd_price_color:#222222,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#AF583D,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#222222',
													'display_value' => '#AF583D,#222222,#555555,#444444',
												),
												'news_toddy' => array(
													'preset_name' => esc_html__( 'Toddy', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#F8F3ED,template_ftcolor:#555555,template_fthovercolor:#BE9055,template_titlecolor:#AE742A,template_titlehovercolor:#BE9055,template_titlebackcolor:#F8F3ED,template_contentcolor:#444444,template_readmorecolor:#683C6F,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#f1f1f1,beforeloop_readmorebackcolor:#BE9055,beforeloop_readmorehovercolor:#BE9055,beforeloop_readmorehoverbackcolor:#f1f1f1,bdp_edd_price_color:#BE9055,bdp_edd_addtocart_textcolor:#f1f1f1,bdp_edd_addtocart_backgroundcolor:#AE742A,bdp_edd_addtocart_text_hover_color:#f1f1f1,bdp_edd_addtocart_hover_backgroundcolor:#444444',
													'display_value' => '#AE742A,#BE9055,#555555,#444444',
												),
												'news_cerulean' => array(
													'preset_name' => esc_html__( 'Cerulean', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#EEF6F8,template_ftcolor:#555555,template_fthovercolor:#3E91AD,template_titlecolor:#0E7699,template_titlehovercolor:#3E91AD,template_titlebackcolor:#EEF6F8,template_contentcolor:#444444,template_readmorecolor:#3E91AD,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#f1f1f1,beforeloop_readmorebackcolor:#3E91AD,beforeloop_readmorehovercolor:#3E91AD,beforeloop_readmorehoverbackcolor:#f1f1f1,bdp_edd_price_color:#3E91AD,bdp_edd_addtocart_textcolor:#f1f1f1,bdp_edd_addtocart_backgroundcolor:#0E7699,bdp_edd_addtocart_text_hover_color:#f1f1f1,bdp_edd_addtocart_hover_backgroundcolor:#444444',
													'display_value' => '#0E7699,#3E91AD,#555555,#444444',
												),
												'news_rich-gold' => array(
													'preset_name' => esc_html__( 'Rich Gold', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#F9F4F0,template_ftcolor:#555555,template_fthovercolor:#BA7850,template_titlecolor:#A95624,template_titlehovercolor:#BA7850,template_titlebackcolor:#F9F4F0,template_contentcolor:#444444,template_readmorecolor:#BA7850,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#f1f1f1,beforeloop_readmorebackcolor:#BA7850,beforeloop_readmorehovercolor:#BA7850,beforeloop_readmorehoverbackcolor:#f1f1f1,bdp_edd_price_color:#BA7850,bdp_edd_addtocart_textcolor:#f1f1f1,bdp_edd_addtocart_backgroundcolor:#A95624,bdp_edd_addtocart_text_hover_color:#f1f1f1,bdp_edd_addtocart_hover_backgroundcolor:#444444',
													'display_value' => '#A95624,#BA7850,#555555,#444444',
												),
												'news_bronzetone' => array(
													'preset_name' => esc_html__( 'Bronzetone', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#F1F3F0,template_ftcolor:#555555,template_fthovercolor:#67704E,template_titlecolor:#414C22,template_titlehovercolor:#67704E,template_titlebackcolor:#F1F3F0,template_contentcolor:#444444,template_readmorecolor:#67704E,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#f1f1f1,beforeloop_readmorebackcolor:#67704E,beforeloop_readmorehovercolor:#67704E,beforeloop_readmorehoverbackcolor:#f1f1f1,bdp_edd_price_color:#67704E,bdp_edd_addtocart_textcolor:#f1f1f1,bdp_edd_addtocart_backgroundcolor:#414C22,bdp_edd_addtocart_text_hover_color:#f1f1f1,bdp_edd_addtocart_hover_backgroundcolor:#444444',
													'display_value' => '#414C22,#67704E,#555555,#444444',
												),
												'news_regal_blue' => array(
													'preset_name' => esc_html__( 'Regal Blue', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#EEF1F4,template_ftcolor:#555555,template_fthovercolor:#435F7F,template_titlecolor:#14375F,template_titlehovercolor:#435F7F,template_titlebackcolor:#EEF1F4,template_contentcolor:#444444,template_readmorecolor:#435F7F,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#f1f1f1,beforeloop_readmorebackcolor:#435F7F,beforeloop_readmorehovercolor:#435F7F,beforeloop_readmorehoverbackcolor:#f1f1f1,bdp_edd_price_color:#435F7F,bdp_edd_addtocart_textcolor:#f1f1f1,bdp_edd_addtocart_backgroundcolor:#14375F,bdp_edd_addtocart_text_hover_color:#f1f1f1,bdp_edd_addtocart_hover_backgroundcolor:#444444',
											...
											'offer_blog'   => array(
												'offer_blog_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#BE6A67,template_fthovercolor:#555555,template_titlecolor:#333333,template_titlehovercolor:#BE6A67,template_titlebackcolor:#ffffff,template_contentcolor:#666666,template_readmorecolor:#ffffff,template_readmorebackcolor:#BE6A67,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#BE6A67,beforeloop_readmorehovercolor:#BE6A67,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#333333,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#BE6A67,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#666666',
											...
											'nicy'         => array(
												'nicy_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_ftcolor:#ED4961,template_fthovercolor:#555555,template_titlecolor:#222222,template_titlehovercolor:#ED4961,template_titlebackcolor:#ffffff,template_contentcolor:#999999,template_readmorecolor:#f1f1f1,template_readmorebackcolor:#ED4961,beforeloop_readmorecolor:#ED4961,beforeloop_readmorebackcolor:#f1f1f1,beforeloop_readmorehovercolor:#f1f1f1,beforeloop_readmorehoverbackcolor:#ED4961,bdp_edd_price_color:#222222,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#ED4961,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#ED4961,#222222,#555555,#999999',
												),
												'nicy_cerulean' => array(
													'preset_name' => esc_html__( 'Cerulean', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_ftcolor:#555555,template_fthovercolor:#3E91AD,template_titlecolor:#0E7699,template_titlehovercolor:#3E91AD,template_titlebackcolor:#ffffff,template_contentcolor:#999999,template_readmorecolor:#3E91AD,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#3E91AD,beforeloop_readmorebackcolor:#f1f1f1,beforeloop_readmorehovercolor:#f1f1f1,beforeloop_readmorehoverbackcolor:#3E91AD,bdp_edd_price_color:#0E7699,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#0E7699,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#0E7699,#3E91AD,#555555,#999999',
												),
												'nicy_fun_green' => array(
													'preset_name' => esc_html__( 'Fun Green', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_ftcolor:#555555,template_fthovercolor:#3E8563,template_titlecolor:#0E663C,template_titlehovercolor:#3E8563,template_titlebackcolor:#ffffff,template_contentcolor:#999999,template_readmorecolor:#3E8563,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#3E8563,beforeloop_readmorebackcolor:#f1f1f1,beforeloop_readmorehovercolor:#f1f1f1,beforeloop_readmorehoverbackcolor:#3E8563,bdp_edd_price_color:#0E663C,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#0E663C,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#0E663C,#3E8563,#555555,#999999',
												),
												'nicy_blackberry' => array(
													'preset_name' => esc_html__( 'Blackberry', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_ftcolor:#555555,template_fthovercolor:#6D4657,template_titlecolor:#49182D,template_titlehovercolor:#6D4657,template_titlebackcolor:#ffffff,template_contentcolor:#999999,template_readmorecolor:#6D4657,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#6D4657,beforeloop_readmorebackcolor:#f1f1f1,beforeloop_readmorehovercolor:#f1f1f1,beforeloop_readmorehoverbackcolor:#6D4657,bdp_edd_price_color:#49182D,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#49182D,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#49182D,#6D4657,#555555,#999999',
												),
												'nicy_earls_green' => array(
													'preset_name' => esc_html__( 'Earls Green', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_ftcolor:#555555,template_fthovercolor:#CEBF59,template_titlecolor:#C2AF2F,template_titlehovercolor:#CEBF59,template_titlebackcolor:#ffffff,template_contentcolor:#999999,template_readmorecolor:#CEBF59,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#CEBF59,beforeloop_readmorebackcolor:#f1f1f1,beforeloop_readmorehovercolor:#f1f1f1,beforeloop_readmorehoverbackcolor:#CEBF59,bdp_edd_price_color:#C2AF2F,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#C2AF2F,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#C2AF2F,#CEBF59,#555555,#999999',
												),
												'nicy_toddy' => array(
													'preset_name' => esc_html__( 'Toddy', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_ftcolor:#555555,template_fthovercolor:#BE9055,template_titlecolor:#AE742A,template_titlehovercolor:#BE9055,template_titlebackcolor:#ffffff,template_contentcolor:#999999,template_readmorecolor:#BE9055,template_readmorebackcolor:#f1f1f1,beforeloop_readmorecolor:#BE9055,beforeloop_readmorebackcolor:#f1f1f1,beforeloop_readmorehovercolor:#f1f1f1,beforeloop_readmorehoverbackcolor:#BE9055,bdp_edd_price_color:#AE742A,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#AE742A,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#AE742A,#BE9055,#555555,#999999',
												),
											),
											'region'       => array(
											...
											'roctangle'    => array(
												'roctangle_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_color:#f18293,template_ftcolor:#666666,template_fthovercolor:#444444,template_titlecolor:#222222,template_titlehovercolor:#f18293,template_readmorecolor:#222222,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#f18293,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#222222,template_contentcolor:#444444,bdp_edd_price_color:#222222,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#f18293,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#666666',
													'display_value' => '#f18293,#222222,#444444,#666666',
												),
												'roctangle_sky_blue' => array(
													'preset_name' => esc_html__( 'Sky Blue', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_color:#92E2FD,template_ftcolor:#666666,template_fthovercolor:#444444,template_titlecolor:#222222,template_titlehovercolor:#92E2FD,template_readmorecolor:#222222,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#92E2FD,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#222222,template_contentcolor:#444444,bdp_edd_price_color:#222222,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#92E2FD,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#444444',
													'display_value' => '#92E2FD,#222222,#444444,#666666',
												),
												'roctangle_lite_green' => array(
													'preset_name' => esc_html__( 'Lite Green', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_color:#0ef58d,template_ftcolor:#666666,template_fthovercolor:#444444,template_titlecolor:#222222,template_titlehovercolor:#0ef58d,template_readmorecolor:#222222,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#0ef58d,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#222222,template_contentcolor:#444444,bdp_edd_price_color:#222222,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#0ef58d,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#666666',
											...
											'spektrum'     => array(
												'spektrum_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#2d7fc1,template_fthovercolor:#555555,template_titlecolor:#2d7fc1,template_titlehovercolor:#2d7fc1,template_titlebackcolor:#ffffff,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#2d7fc1,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#2d7fc1,beforeloop_readmorehovercolor:#2d7fc1,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#222222,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#2d7fc1,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#ffffff',
												...
												'spektrum_alizarin' => array(
													'preset_name' => esc_html__( 'Alizarin', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#EA1A3A,template_fthovercolor:#EE4861,template_titlecolor:#EA1A3A,template_titlehovercolor:#EE4861,template_titlebackcolor:#ffffff,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#EE4861,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#EE4861,beforeloop_readmorehovercolor:#EE4861,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#EE4861,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#EA1A3A,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#EA1A3A,#EE4861,#555555,#333333',
												),
												'spektrum_buttercup' => array(
													'preset_name' => esc_html__( 'Buttercup', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#DF8D27,template_fthovercolor:#E5A452,template_titlecolor:#DF8D27,template_titlehovercolor:#E5A452,template_titlebackcolor:#ffffff,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#E5A452,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#E5A452,beforeloop_readmorehovercolor:#E5A452,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#E5A452,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#DF8D27,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#DF8D27,#E5A452,#555555,#333333',
												),
											...
											'winter'       => array(
												...
												'winter_cerulean' => array(
													'preset_name' => esc_html__( 'Cerulean', 'blog-designer-pro' ),
													'preset_value' => 'winter_category_color:#3E91AD,template_bgcolor:#EEF6F8,template_ftcolor:#555555,template_fthovercolor:#3E91AD,template_titlecolor:#0E7699,template_titlehovercolor:#3E91AD,template_titlebackcolor:#EEF6F8,template_contentcolor:#666666,template_readmorecolor:#EEF6F8,template_readmorebackcolor:#3E91AD,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#3E91AD,beforeloop_readmorehovercolor:#3E91AD,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#3E91AD,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#0E7699,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#666666',
													'display_value' => '#0E7699,#3E91AD,#555555,#666666',
												),
												'winter_ce_soir' => array(
													'preset_name' => esc_html__( 'Ce Soir', 'blog-designer-pro' ),
													'preset_value' => 'winter_category_color:#A381BB,template_bgcolor:#F7F4F9,template_ftcolor:#555555,template_fthovercolor:#A381BB,template_titlecolor:#8C62AA,template_titlehovercolor:#3E91AD,template_titlebackcolor:#F7F4F9,template_contentcolor:#666666,template_readmorecolor:#F7F4F9,template_readmorebackcolor:#8C62AA,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#8C62AA,beforeloop_readmorehovercolor:#8C62AA,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#A381BB,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#8C62AA,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#666666',
											...
											'sallet_slider' => array(
												'sallet_slider_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_ftcolor:#555555,template_fthovercolor:#3E8563,winter_category_color:#3E8563,template_titlecolor:#0E663C,template_titlehovercolor:#3E8563,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#3E8563,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#3E8563,beforeloop_readmorehovercolor:#3E8563,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#0E663C,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#0E663C,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#0E663C,#3E8563,#555555,#333333',
												),
												'sallet_slider_red_violet' => array(
													'preset_name' => esc_html__( 'Red Violet', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#FBF3F8,template_ftcolor:#555555,template_fthovercolor:#C44C91,winter_category_color:#C44C91,template_titlecolor:#B51F76,template_titlehovercolor:#C44C91,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#C44C91,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#C44C91,beforeloop_readmorehovercolor:#C44C91,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#B51F76,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#B51F76,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#B51F76,#C44C91,#555555,#333333',
												),
												'sallet_slider_lemon_ginger' => array(
													'preset_name' => esc_html__( 'Lemon Ginger', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#F7F6F1,template_ftcolor:#555555,template_fthovercolor:#A39D5A,winter_category_color:#A39D5A,template_titlecolor:#8C8431,template_titlehovercolor:#A39D5A,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#A39D5A,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#A39D5A,beforeloop_readmorehovercolor:#A39D5A,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#8C8431,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#8C8431,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#8C8431,#A39D5A,#555555,#333333',
												),
												'sallet_slider_cerulean' => array(
													'preset_name' => esc_html__( 'Cerulean', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#EEF6F8,template_ftcolor:#555555,template_fthovercolor:#3E91AD,winter_category_color:#3E91AD,template_titlecolor:#0E7699,template_titlehovercolor:#3E91AD,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#3E91AD,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#3E91AD,beforeloop_readmorehovercolor:#3E91AD,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#0E7699,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#0E7699,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#0E7699,#3E91AD,#555555,#333333',
												),
												'sallet_slider_buttercup' => array(
													'preset_name' => esc_html__( 'Buttercup', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#FDF7F1,template_ftcolor:#555555,template_fthovercolor:#E5A452,winter_category_color:#E5A452,template_titlecolor:#DF8D27,template_titlehovercolor:#E5A452,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#E5A452,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#E5A452,beforeloop_readmorehovercolor:#E5A452,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#DF8D27,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#DF8D27,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#DF8D27,#E5A452,#555555,#333333',
												),
												'sallet_slider_wasabi' => array(
													'preset_name' => esc_html__( 'Wasabi', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#F6F7F1,template_ftcolor:#555555,template_fthovercolor:#93A564,winter_category_color:#93A564,template_titlecolor:#788F3D,template_titlehovercolor:#93A564,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#93A564,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#93A564,beforeloop_readmorehovercolor:#93A564,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#788F3D,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#788F3D,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
											...
											'sunshiny_slider' => array(
												'sunshiny_slider_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#000000,template_ftcolor:#ffffff,template_fthovercolor:#ff00ae,winter_category_color:#ff00ae,template_titlecolor:#ffffff,template_titlehovercolor:#ff00ae,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#ff00ae,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#333333,bdp_edd_addtocart_backgroundcolor:#ffffff,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#ffffff',
													'display_value' => '#ffffff,#ff00ae,#ffffff,#333333',
												),
												'sunshiny_slider_radical_red' => array(
													'preset_name' => esc_html__( 'Radical Red', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#330a12,template_ftcolor:#ffeaee,template_fthovercolor:#ff355e,winter_category_color:#ff355e,template_titlecolor:#ffd6de,template_titlehovercolor:#FA336C,template_contentcolor:#ffeaee,template_readmorecolor:#ffffff,template_readmorebackcolor:#FA336C,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#ff355e,bdp_edd_addtocart_backgroundcolor:#ffffff,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#ffffff',
													'display_value' => '#330a12,#ff355e,#ffd6de,#ffeaee',
												),
												'sunshiny_slider_eminence' => array(
													'preset_name' => esc_html__( 'Eminence', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#2b1334,template_ftcolor:#e1d5e6,template_fthovercolor:#2b1334,winter_category_color:#6c3082,template_titlecolor:#e1d5e6,template_titlehovercolor:#2b1334,template_contentcolor:#f0eaf2,template_readmorecolor:#ffffff,template_readmorebackcolor:#683C6F,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#6c3082,bdp_edd_addtocart_backgroundcolor:#ffffff,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#ffffff',
													'display_value' => '#2b1334,#6c3082,#e1d5e6,#f0eaf2',
												),
												'sunshiny_slider_dark_orange' => array(
													'preset_name' => esc_html__( 'Dark Orange', 'blog-designer-pro' ),
													'preset_value' => 'winter_category_color:#FF8A00,template_color:#FFF3E5,template_ftcolor:#FF8A00,template_fthovercolor:#2b2b2b,template_titlecolor:#FF8A00,template_titlehovercolor:#2b2b2b,template_contentcolor:#2b2b2b,template_readmorecolor:#ffffff,template_readmorebackcolor:#FF8A00,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#FFF3E5,bdp_edd_addtocart_backgroundcolor:#ffffff,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#ffffff',
													'display_value' => '#FF8A00,#FFF3E5,#ffffff,#2b2b2b',
												),
												'sunshiny_slider_persian_red' => array(
													'preset_name' => esc_html__( 'Persian Red', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#3d0f0f,template_ftcolor:#ffffff,template_fthovercolor:#3d0f0f,winter_category_color:#cc3333,template_titlecolor:#f4d6d6,template_titlehovercolor:#3d0f0f,template_contentcolor:#f9eaea,template_readmorecolor:#ffffff,template_readmorebackcolor:#DC3330,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#cc3333,bdp_edd_addtocart_backgroundcolor:#ffffff,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#ffffff',
													'display_value' => '#3d0f0f,#cc3333,#f4d6d6,#f9eaea',
												),
												'sunshiny_slider_venetian_red' => array(
													'preset_name' => esc_html__( 'Venetian Red', 'blog-designer-pro' ),
													'preset_value' => 'winter_category_color:#CC0001,template_color:#FAE4E6,template_ftcolor:#ffffff,template_fthovercolor:#2b2b2b,template_titlecolor:#ffffff,template_titlehovercolor:#2b2b2b,template_contentcolor:#ffffff,template_readmorecolor:#ffffff,template_readmorebackcolor:#CC0001,bdp_edd_price_color:#ffffff,bdp_edd_addtocart_textcolor:#CC0001,bdp_edd_addtocart_backgroundcolor:#ffffff,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#ffffff',
											...
											'tagly'        => array(
												'tagly_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#b79a5e,template_bgcolor:#ffffff,template_ftcolor:#555555,template_fthovercolor:#b79a5e,template_titlecolor:#333333,template_titlehovercolor:#b79a5e,template_titlebackcolor:#ffffff,template_readmorecolor:#ffffff,template_readmorebackcolor:#b79a5e,template_contentcolor:#999999,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#b79a5e,beforeloop_readmorehovercolor:#b79a5e,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#333333,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#b79a5e,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#b79a5e,#333333,#555555,#999999',
												),
												'tagly_earls_green' => array(
													'preset_name' => esc_html__( 'Earls Green', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#CEBF59,template_bgcolor:#ffffff,template_ftcolor:#555555,template_fthovercolor:#CEBF59,template_titlecolor:#C2AF2F,template_titlehovercolor:#CEBF59,template_titlebackcolor:#ffffff,template_readmorecolor:#ffffff,template_readmorebackcolor:#CEBF59,template_contentcolor:#999999,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#CEBF59,beforeloop_readmorehovercolor:#CEBF59,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#CEBF59,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#C2AF2F,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#C2AF2F,#CEBF59,#555555,#999999',
												),
												'tagly_cerulean' => array(
													'preset_name' => esc_html__( 'Cerulean', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#3E91AD,template_bgcolor:#ffffff,template_ftcolor:#555555,template_fthovercolor:#3E91AD,template_titlecolor:#0E7699,template_titlehovercolor:#3E91AD,template_titlebackcolor:#ffffff,template_readmorecolor:#ffffff,template_readmorebackcolor:#3E91AD,template_contentcolor:#999999,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#3E91AD,beforeloop_readmorehovercolor:#3E91AD,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#3E91AD,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#0E7699,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#0E7699,#3E91AD,#555555,#999999',
												),
												...
												'tagly_alizarin' => array(
													'preset_name' => esc_html__( 'Alizarin', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ED4961,template_bgcolor:#FDF0F1,template_ftcolor:#555555,template_fthovercolor:#ED4961,template_titlecolor:#E81B3A,template_titlehovercolor:#ED4961,template_titlebackcolor:#FDF0F1,template_readmorecolor:#ffffff,template_readmorebackcolor:#ED4961,template_contentcolor:#999999,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#ED4961,beforeloop_readmorehovercolor:#ED4961,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#ED4961,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#E81B3A,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#E81B3A,#ED4961,#555555,#999999',
												),
												'tagly_yonder' => array(
													'preset_name' => esc_html__( 'Yonder', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#8BA3CE,template_bgcolor:#F5F7FB,template_ftcolor:#555555,template_fthovercolor:#8BA3CE,template_titlecolor:#6E8CC2,template_titlehovercolor:#8BA3CE,template_titlebackcolor:#F5F7FB,template_readmorecolor:#ffffff,template_readmorebackcolor:#8BA3CE,template_contentcolor:#999999,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#8BA3CE,beforeloop_readmorehovercolor:#8BA3CE,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#8BA3CE,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#6E8CC2,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#999999',
													'display_value' => '#6E8CC2,#8BA3CE,#555555,#999999',
												),
											),
											'foodbox'      => array(
												'foodbox_default' => array(
                                                    ...
                                                    template_readmore_hover_backcolor:#000000,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#6e3d30,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#bdp_edd_price_color:#444444,bdp_edd_addtocart_textcolor:#FDE7E9,bdp_edd_addtocart_backgroundcolor:#000000,bdp_edd_addtocart_text_hover_color:#FDE7E9,bdp_edd_addtocart_hover_backgroundcolor:#6e3d30',
												...
												'foodbox_rich-gold' => array(
													'preset_name' => esc_html__( 'Rich Gold', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#A95624,template_bgcolor:#ffd1b6,template_ftcolor:#444444,template_fthovercolor:#A95624,template_titlecolor:#A95624,template_titlehovercolor:#BA7850,template_titlebackcolor:#ffd1b6,template_contentcolor:#444444,template_readmorecolor:#f1f1f1,template_readmorebackcolor:#A95624,beforeloop_readmorecolor:#f1f1f1,beforeloop_readmorebackcolor:#BA7850,beforeloop_readmorehovercolor:#BA7850,beforeloop_readmorehoverbackcolor:#f1f1f1,bdp_edd_price_color:#BA7850,bdp_edd_addtocart_textcolor:#f1f1f1,bdp_edd_addtocart_backgroundcolor:#A95624,bdp_edd_addtocart_text_hover_color:#f1f1f1,bdp_edd_addtocart_hover_backgroundcolor:#444444',
											...
											'neaty_block'  => array(
												'neaty_block_default' => array(
                                                    ...
                                                    template_readmore_hover_backcolor:#000000,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#444444,beforeloop_readmorehovercolor:#444444,beforeloop_readmorehoverbackcolor:#000000,bdp_edd_price_color:#444444,bdp_edd_addtocart_textcolor:#f1f1f1,bdp_edd_addtocart_backgroundcolor:#000000,bdp_edd_addtocart_text_hover_color:#f1f1f1,bdp_edd_addtocart_hover_backgroundcolor:#444444',
											...
											'wise_block'   => array(
												'wise_block_default' => array(
                                                    ...
                                                    template_readmore_hover_backcolor:#000000,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#444444,beforeloop_readmorehovercolor:#444444,beforeloop_readmorehoverbackcolor:#000000,bdp_edd_price_color:#444444,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#000000,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#000000',
													'display_value' => '#444444,#000000,#444444,#000000',
												),
											...
											'schedule'     => array(
												'schedule_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#e21130,template_bgcolor:#ffffff,template_ftcolor:#a5a5a5,template_fthovercolor:#123123,template_titlecolor:#444444,template_titlebackcolor:#ffffff,template_titlehovercolor:#123123,template_readmorecolor:#ffffff,template_readmore_hover_backcolor:#e21130,template_contentcolor:#333333,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#444444,beforeloop_readmorehovercolor:#444444,beforeloop_readmorehoverbackcolor:#000000,bdp_edd_price_color:#444444,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#F34656,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333,winter_category_color:#333333,winter_category_color:#a5a5a5',
													'display_value' => '#444444,#e21130,#333333,#ffffff',
												),
												'schedule_radical' => array(
													'preset_name' => esc_html__( 'Radical', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#7C242C,template_bgcolor:#FDE7E9,template_ftcolor:#F9A1A9,template_fthovercolor:#7C242C,template_titlecolor:#F34656,template_titlehovercolor:#4F171C,template_titlebackcolor:#FDE7E9,template_contentcolor:#7C242C,template_readmorecolor:#F34656,template_readmorebackcolor:#FDE7E9,template_readmore_hover_backcolor:#FDE7E9,beforeloop_readmorecolor:#F34656,beforeloop_readmorebackcolor:#FDE7E9,beforeloop_readmorehovercolor:#F34656,beforeloop_readmorehoverbackcolor:#F9A1A9,bdp_edd_price_color:#FDE7E9,bdp_edd_addtocart_textcolor:#FDE7E9,bdp_edd_addtocart_backgroundcolor:#F34656,bdp_edd_addtocart_text_hover_color:#FDE7E9,bdp_edd_addtocart_hover_backgroundcolor:#7C242C,
                                                        winter_category_color:#7C242C',
													'display_value' => '#FDE7E9,#F34656,#7C242C,#4F171C',
												),
												'schedule_mariner' => array(
													'preset_name' => esc_html__( 'Mariner', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#465BAC,template_bgcolor:#EAEDF6,template_ftcolor:#465BAC,template_fthovercolor:#ffffff,template_titlecolor:#465BAC,template_titlehovercolor:#484848,template_titlebackcolor:#eaedf6,template_contentcolor:#7b7b7b,template_readmorecolor:#465BAC,template_readmorebackcolor:#EAEDF6,template_readmore_hover_backcolor:#465BAC,bdp_edd_price_color:#484848,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#465BAC,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#484848,winter_category_color:#465BAC',
													'display_value' => '#465BAC,#EAEDF6,#465BAC,#484848',
												),
												'schedule_flamenco' => array(
													'preset_name' => esc_html__( 'Flamenco', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#683C6F,template_bgcolor:#FFF3ED,template_ftcolor:#683C6F,template_fthovercolor:#ffffff,template_titlecolor:#683C6F,template_titlehovercolor:#484848,template_titlebackcolor:#FFF3ED,template_contentcolor:#7b7b7b,template_readmorecolor:#683C6F,template_readmorebackcolor:#FFF3ED,template_readmore_hover_backcolor:#683C6F,bdp_edd_price_color:#484848,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#683C6F,bdp_edd_addtocart_text_hover_color:#683C6F,bdp_edd_addtocart_hover_backgroundcolor:#FFF3ED,winter_category_color:#683C6F',
													'display_value' => '#683C6F,#FFF3ED,#683C6F,#484848',
												),
												'schedule_finch' => array(
													'preset_name' => esc_html__( 'Finch', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#75815B,template_bgcolor:#EFF0EB,template_ftcolor:#75815B,template_fthovercolor:#ffffff,template_titlecolor:#75815B,template_titlehovercolor:#484848,template_titlebackcolor:#EFF0EB,template_contentcolor:#7b7b7b,template_readmorecolor:#75815B,template_readmorebackcolor:#EFF0EB,template_readmore_hover_backcolor:#75815B,bdp_edd_price_color:#484848,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#75815B,bdp_edd_addtocart_text_hover_color:#75815B,bdp_edd_addtocart_hover_backgroundcolor:#EFF0EB,winter_category_color:#75815B',
													'display_value' => '#75815B,#EFF0EB,#75815B,#484848',
												),
											),
											'quci'         => array(
											...
											'threed_carousel' => array(
												'threed_carousel_default' => array(
													'preset_name' => esc_html__( 'Default', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_bgcolor:#ffffff,template_ftcolor:#f42887,template_fthovercolor:#333333,template_titlecolor:#777777,template_titlehovercolor:#333333,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#f42887,template_readmore_hover_backcolor:#333333,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#f42887,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#f42887,bdp_edd_price_color:#777777,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#f42887,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#ffffff,#f42887,#333333,#777777',
												),
												'threed_carousel_vivid_gamboge' => array(
													'preset_name' => esc_html__( 'Vivid Gamboge', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_bgcolor:#fef4e5,template_ftcolor:#f99900,template_fthovercolor:#333333,template_titlecolor:#777777,template_titlehovercolor:#333333,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#f99900,template_readmore_hover_backcolor:#333333,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#f99900,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#f99900,bdp_edd_price_color:#777777,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#f99900,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#fef4e5,#f99900,#333333,#777777',
												),
												'threed_carousel_jagger' => array(
													'preset_name' => esc_html__( 'Jagger', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_bgcolor:#ebeaec,template_ftcolor:#3d3242,template_fthovercolor:#333333,template_titlecolor:#777777,template_titlehovercolor:#333333,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#3d3242,template_readmore_hover_backcolor:#333333,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#3d3242,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#3d3242,bdp_edd_price_color:#777777,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#3d3242,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#ebeaec,#3d3242,#333333,#777777',
												),
												'threed_carousel_timber_green' => array(
													'preset_name' => esc_html__( 'Timber Green', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_bgcolor:#ebeaec,template_ftcolor:#374232,template_fthovercolor:#333333,template_titlecolor:#777777,template_titlehovercolor:#333333,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#374232,template_readmore_hover_backcolor:#333333,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#374232,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#374232,bdp_edd_price_color:#777777,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#374232,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#ebecea,#374232,#333333,#777777',
												),
												'threed_carousel_barossa' => array(
													'preset_name' => esc_html__( 'Barossa', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_bgcolor:#ebeaec,template_ftcolor:#423237,template_fthovercolor:#333333,template_titlecolor:#777777,template_titlehovercolor:#333333,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#423237,template_readmore_hover_backcolor:#333333,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#423237,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#423237,bdp_edd_price_color:#777777,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#423237,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#eceaeb,#423237,#333333,#777777',
												),
												'threed_carousel_blumine' => array(
													'preset_name' => esc_html__( 'Blumine', 'blog-designer-pro' ),
													'preset_value' => 'template_color:#ffffff,template_bgcolor:#e9eeef,template_ftcolor:#2a5b66,template_fthovercolor:#333333,template_titlecolor:#777777,template_titlehovercolor:#333333,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#2a5b66,template_readmore_hover_backcolor:#333333,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#2a5b66,beforeloop_readmorehovercolor:#ffffff,beforeloop_readmorehoverbackcolor:#2a5b66,bdp_edd_price_color:#777777,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#2a5b66,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#e9eeef,#2a5b66,#333333,#777777',
												),
											),
											'flip_book_3d' => array(
												...
												'flip_book_3d_salt-box' => array(
													'preset_name' => esc_html__( 'Salt Box', 'blog-designer-pro' ),
													'preset_value' => 'template_ftcolor:#60505e,template_fthovercolor:#333333,template_titlecolor:#60505e,template_titlehovercolor:#2b2b2b,template_contentcolor:#7b6b79,template_readmorecolor:#dddddd,template_readmorebackcolor:#60505e,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#60505e,beforeloop_readmorehovercolor:#60505e,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#2b2b2b,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#60505e,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#2b2b2b',
													'display_value' => '#60505e,#ffffff,#2b2b2b,#7b6b79',
												),
												'flip_book_3d_pacific_blue' => array(
													'preset_name' => esc_html__( 'Pacific Blue', 'blog-designer-pro' ),
													'preset_value' => 'template_ftcolor:#0099CB,template_fthovercolor:#2b2b2b,template_titlecolor:#0099CB,template_titlehovercolor:#2b2b2b,template_contentcolor:#7b6b79,template_readmorecolor:#dddddd,template_readmorebackcolor:#0099CB,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#0099CB,beforeloop_readmorehovercolor:#0099CB,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#2b2b2b,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#0099CB,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#2b2b2b',
													'display_value' => '#0099CB,#ffffff,#2b2b2b,#7b6b79',
												),
												'flip_book_3d_pacific_dark_orchid' => array(
													'preset_name' => esc_html__( 'Dark Orchid', 'blog-designer-pro' ),
													'preset_value' => 'template_ftcolor:#9A33CC,template_fthovercolor:#2b2b2b,template_titlecolor:#9A33CC,template_titlehovercolor:#2b2b2b,template_contentcolor:#7b6b79,template_readmorecolor:#dddddd,template_readmorebackcolor:#9A33CC,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#9A33CC,beforeloop_readmorehovercolor:#9A33CC,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#2b2b2b,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#9A33CC,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#2b2b2b',
													'display_value' => '#9A33CC,#ffffff,#2b2b2b,#7b6b79',
												),
												'flip_book_3d_pacific_dark_orange' => array(
													'preset_name' => esc_html__( 'Dark Orange', 'blog-designer-pro' ),
													'preset_value' => 'template_ftcolor:#FF8A00,template_fthovercolor:#2b2b2b,template_titlecolor:#FF8A00,template_titlehovercolor:#2b2b2b,template_contentcolor:#7b6b79,template_readmorecolor:#dddddd,template_readmorebackcolor:#FF8A00,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#FF8A00,beforeloop_readmorehovercolor:#FF8A00,beforeloop_readmorehoverbackcolor:#ffffff,bdp_edd_price_color:#2b2b2b,bdp_edd_addtocart_textcolor:#ffffff,bdp_edd_addtocart_backgroundcolor:#FF8A00,bdp_edd_addtocart_text_hover_color:#ffffff,bdp_edd_addtocart_hover_backgroundcolor:#2b2b2b',
													'display_value' => '#FF8A00,#ffffff,#2b2b2b,#7b6b79',
												),
							...
							<div class="bdp_grid_col_3">
								...
								<li class="post-category">
									...
									<div class="bdp-right">
										<?php
											...
											$db_categories    = $wpdb->get_results( 'SELECT download_sub_categories FROM ' . $wpdb->prefix . 'bdp_edd_archives WHERE download_archive_template = "category_template"' );
											$db_category_list = array();
											if ( $db_categories ) {
												foreach ( $db_categories as $db_category ) {
													$sub_list = $db_category->download_sub_categories;
													if ( $sub_list ) {
											...
											<select data-placeholder="<?php esc_attr_e( 'Choose Product Categories', 'blog-designer-pro' ); ?>" class="chosen-select" multiple style="width:220px;" name="template_category[]" id="template_category">
												<?php foreach ( $categories as $category_obj ) : ?>
													<option value="<?php echo esc_attr( $category_obj->term_id ); ?>" 
														<?php
														if ( is_array( $final_cat ) && ! empty( $final_cat ) && in_array( $category_obj->term_id, $final_cat ) ) {
															echo 'disabled="disabled"';
														}
														if ( is_array( $template_category ) && ! empty( $template_category ) && in_array( $category_obj->term_id, $template_category ) ) {
															echo 'selected="selected"';
														}
														?>
													><?php echo esc_attr( $category_obj->name ); ?></option>
												<?php endforeach; ?>
											</select>
								...
								<li class="post-tag">
									...
									<div class="bdp-right">
										...
										$db_tags     = $wpdb->get_results( 'SELECT download_sub_categories FROM ' . $wpdb->prefix . 'bdp_edd_archives WHERE download_archive_template = "tag_template"' );
										$db_tag_list = array();
										if ( $db_tags ) {
											foreach ( $db_tags as $db_tag ) {
												$sub_list = $db_tag->download_sub_categories;
												if ( $sub_list ) {
										...
										<select data-placeholder="<?php esc_attr_e( 'Choose Product Tags', 'blog-designer-pro' ); ?>" class="chosen-select" multiple style="width:220px;" name="template_tags[]" id="template_tags">
											<?php foreach ( $tags as $tag ) : ?>
												<option value="<?php echo esc_attr( $tag->term_id ); ?>" 
													<?php
													if ( is_array( $template_tags ) && ! empty( $template_tags ) && in_array( $tag->term_id, $template_tags ) ) {
														echo 'selected="selected"';
													} if ( is_array( $final_tag ) && ! empty( $final_tag ) && in_array( $tag->term_id, $final_tag ) ) {
														echo 'disabled="disabled"';
													}
													?>
								...
								<li class="archive_blog_page_show">
									...
									<div class="bdp-right">
										<input name="posts_per_page" type="number" step="1" min="1" id="posts_per_page"
											value="<?php echo esc_attr( $posts_per_page ); ?>" class="" onkeypress="return isNumberKey(event)" />
									</div>
								</li>
								<li class="bdp_display_tabbed_options">
									...
									<div class="bdp-right">
										...
										<select id="bdp_tabbed_layout" name="bdp_tabbed_layout">
											<option value="left_side" <?php echo selected( 'left_side', $bdp_tabbed_layout ); ?>><?php esc_html_e( 'Left Download And Right Download Product List', 'blog-designer-pro' ); ?></option>
											<option value="right_side" <?php echo selected( 'right_side', $bdp_tabbed_layout ); ?>><?php esc_html_e( 'Right Download  And Left Download Product List', 'blog-designer-pro' ); ?></option>
										</select>
									</div>
								</li>
						...
						<ul class="bdp-settings">
							<div class="bdp_grid_col_3">
								...
								<li>
									<div class="bdp-left">
										<span class="bdp-key-title">
											<?php esc_html_e( 'Product Effect', 'blog-designer-pro' ); ?>
										</span>
									</div>
									<div class="bdp-right">
								...
								<li>
									<div class="bdp-left">
										<span class="bdp-key-title">
											<?php esc_html_e( 'Product Width', 'blog-designer-pro' ); ?>
								...
								<li>
									<div class="bdp-left">
										<span class="bdp-key-title">
											<?php esc_html_e( 'Product Height', 'blog-designer-pro' ); ?>
										</span><span class="bdp-px-prefix"><?php esc_html_e( '(px)', 'blog-designer-pro' ); ?></span>
									</div>
									<div class="bdp-right">
								...
								<li>
									<div class="bdp-left">
										<span class="bdp-key-title">
											<?php esc_html_e( 'Margin between Product', 'blog-designer-pro' ); ?>
										</span><span class="bdp-px-prefix"><?php esc_html_e( '(px)', 'blog-designer-pro' ); ?></span>
									</div>
									<div class="bdp-right">
										...
										<input type="number" class="grid_col_space_val" name="template_post_margin" id="template_post_margin" value="<?php echo esc_attr( $template_post_margin ); ?>" />
									</div>
								</li>
								...
								<li class="scroll_speed_tr">
									<div class="bdp-left">
										...
										<?php echo '<span class="bdp-media-div">(<i>' . esc_html__( 'ms', 'blog-designer-pro' ) . '</i>)</span>'; ?>
									</div>
									<div class="bdp-right">
				...
				<div id="bdpstandard" class="postbox postbox-with-fw-options" style=<?php echo esc_attr( $bdpstandard_class_show ); ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<div class="bdp_grid_col_3 bdp_col_ash bdp_grid_col_1">
							...
							<div class="bdp_grid_col_2">
								...
								<li class="blog-sallet-slider-tr blog-templatecolor-tr">
									<div class="bdp-left">
										<span class="bdp-key-title">
								...
								<li class="ticker-effect-option blog-templatecolor-tr">
									<div class="bdp-left">
										<span class="bdp-key-title">
								...
								<li class="ticker-label-text blog-templatecolor-tr">
									<div class="bdp-left">
										<span class="bdp-key-title">
								...
								<li class="crayon-slider-design blog-templatecolor-tr">
									<div class="bdp-left">
										<span class="bdp-key-title">
								...
								<li class="timeline-layout-design blog-templatecolor-tr">
									<div class="bdp-left">
										<span class="bdp-key-title">
											<?php esc_html_e( 'Choose Design', 'blog-designer-pro' ); ?>
										</span>
								...
								<li class="winter-category-back-color blog-templatecolor-tr" style="display: none;">
									<div class="bdp-left">
										<span class="bdp-key-title">
								...
								<li class="lightbreeze-image-corner blog-templatecolor-tr" style="display:none">
									<div class="bdp-left">
										<span class="bdp-key-title">
							...
							<h3 class="bdp-table-title bdp-table-sub-title bdp-background-settings"><?php esc_html_e( 'Background Settings', 'blog-designer-pro' ); ?></h3>
							<div class="bdp_grid_col_2">
							...
							<div class="bdp_grid_col_1">
								...
								<li class="bdp-post-container-hover blog-templatecolor-tr-inner">
									<div class="bdp-left">
										<span class="bdp-key-title">
						...
						<ul class="bdp-settings bdp-lineheight">
							...
							<li class="bdp_padding_0">
								<div class="bdp-typography-wrapper bdp-typography-wrapper1 bdp_grid_col_2">
									<div class="bdp-typography-cover download-product-typography-normal">
							...
							<h3 class="download_post_title_wrap bdp-table-title post_title_border_setting"><?php esc_html_e( 'Download Post Title Margin', 'blog-designer-pro' ); ?></h3>
							<li class="download_post_title_wrap edd_addtocart_button_box_shadow_setting post_title_border_setting">
								<div class="bdp-boxshadow-wrapper bdp-boxshadow-wrapper1">
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
											<span class="bdp-key-title">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_title_marginleft = isset( $bdp_settings['download_post_title_marginleft'] ) ? $bdp_settings['download_post_title_marginleft'] : 0; ?>
											<input type="number" id="download_post_title_marginleft" name="download_post_title_marginleft" step="1" value="<?php echo esc_attr( $download_post_title_marginleft ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_title_marginright = isset( $bdp_settings['download_post_title_marginright'] ) ? $bdp_settings['download_post_title_marginright'] : 0; ?>
											<input type="number" id="download_post_title_marginright" name="download_post_title_marginright" step="1" value="<?php echo esc_attr( $download_post_title_marginright ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_title_margintop = isset( $bdp_settings['download_post_title_margintop'] ) ? $bdp_settings['download_post_title_margintop'] : 0; ?>
											<input type="number" id="download_post_title_margintop" name="download_post_title_margintop" step="1" value="<?php echo esc_attr( $download_post_title_margintop ); ?>"  onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_title_marginbottom = isset( $bdp_settings['download_post_title_marginbottom'] ) ? $bdp_settings['download_post_title_marginbottom'] : 0; ?>
											<input type="number" id="download_post_title_marginbottom" name="download_post_title_marginbottom" step="1" value="<?php echo esc_attr( $download_post_title_marginbottom ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
								</div>
							</li>
							<h3 class="download_post_title_padding_wrap bdp-table-title post_content_border_setting"><?php esc_html_e( 'Download Post Title Padding', 'blog-designer-pro' ); ?></h3>
							<li class="download_post_title_padding_wrap edd_addtocart_button_box_shadow_setting post_content_border_setting">
								<div class="bdp-boxshadow-wrapper bdp-boxshadow-wrapper1">
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
											<span class="bdp-key-title">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_title_paddingleft = isset( $bdp_settings['download_post_title_paddingleft'] ) ? $bdp_settings['download_post_title_paddingleft'] : 0; ?>
											<input type="number" id="download_post_title_paddingleft" name="download_post_title_paddingleft" step="1" value="<?php echo esc_attr( $download_post_title_paddingleft ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_title_paddingright = isset( $bdp_settings['download_post_title_paddingright'] ) ? $bdp_settings['download_post_title_paddingright'] : 0; ?>
											<input type="number" id="download_post_title_paddingright" name="download_post_title_paddingright" step="1" value="<?php echo esc_attr( $download_post_title_paddingright ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_title_paddingtop = isset( $bdp_settings['download_post_title_paddingtop'] ) ? $bdp_settings['download_post_title_paddingtop'] : 0; ?>
											<input type="number" id="download_post_title_paddingtop" name="download_post_title_paddingtop" step="1" value="<?php echo esc_attr( $download_post_title_paddingtop ); ?>"  onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_title_paddingbottom = isset( $bdp_settings['download_post_title_paddingbottom'] ) ? $bdp_settings['download_post_title_paddingbottom'] : 0; ?>
											<input type="number" id="download_post_title_paddingbottom" name="download_post_title_paddingbottom" step="1" value="<?php echo esc_attr( $download_post_title_paddingbottom ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
								</div>
							</li>
				...
				<div id="bdpcontent" class="postbox postbox-with-fw-options bdp-content-setting1" style=<?php echo esc_attr( $bdpcontent_class_show ); ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<div class="bdp_grid_col_3">
								<li class="excerpt_length bdp_related_font_size">
									<div class="bdp-left">
										<span class="bdp-key-title">
							...
							<h3 class="download_post_content_wrap bdp-table-title post_content_border_setting"><?php esc_html_e( 'Download Post Content Margin', 'blog-designer-pro' ); ?></h3>
							<li class="download_post_content_wrap edd_addtocart_button_box_shadow_setting post_content_border_setting">
								<div class="bdp-boxshadow-wrapper bdp-boxshadow-wrapper1">
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
											<span class="bdp-key-title">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_content_marginleft = isset( $bdp_settings['download_post_content_marginleft'] ) ? $bdp_settings['download_post_content_marginleft'] : 0; ?>
											<input type="number" id="download_post_content_marginleft" name="download_post_content_marginleft" step="1" value="<?php echo esc_attr( $download_post_content_marginleft ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_content_marginright = isset( $bdp_settings['download_post_content_marginright'] ) ? $bdp_settings['download_post_content_marginright'] : 0; ?>
											<input type="number" id="download_post_content_marginright" name="download_post_content_marginright" step="1" value="<?php echo esc_attr( $download_post_content_marginright ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_content_margintop = isset( $bdp_settings['download_post_content_margintop'] ) ? $bdp_settings['download_post_content_margintop'] : 0; ?>
											<input type="number" id="download_post_content_margintop" name="download_post_content_margintop" step="1" value="<?php echo esc_attr( $download_post_content_margintop ); ?>"  onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_content_marginbottom = isset( $bdp_settings['download_post_content_marginbottom'] ) ? $bdp_settings['download_post_content_marginbottom'] : 0; ?>
											<input type="number" id="download_post_content_marginbottom" name="download_post_content_marginbottom" step="1" value="<?php echo esc_attr( $download_post_content_marginbottom ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
								</div>
							</li>
							<h3 class="download_post_content_padding_wrap bdp-table-title post_content_border_setting"><?php esc_html_e( 'Download Post Content Padding', 'blog-designer-pro' ); ?></h3>
							<li class="download_post_content_padding_wrap edd_addtocart_button_box_shadow_setting post_content_border_setting">
								<div class="bdp-boxshadow-wrapper bdp-boxshadow-wrapper1">
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
											<span class="bdp-key-title">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_content_paddingleft = isset( $bdp_settings['download_post_content_paddingleft'] ) ? $bdp_settings['download_post_content_paddingleft'] : 0; ?>
											<input type="number" id="download_post_content_paddingleft" name="download_post_content_paddingleft" step="1" value="<?php echo esc_attr( $download_post_content_paddingleft ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_content_paddingright = isset( $bdp_settings['download_post_content_paddingright'] ) ? $bdp_settings['download_post_content_paddingright'] : 0; ?>
											<input type="number" id="download_post_content_paddingright" name="download_post_content_paddingright" step="1" value="<?php echo esc_attr( $download_post_content_paddingright ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_content_paddingtop = isset( $bdp_settings['download_post_content_paddingtop'] ) ? $bdp_settings['download_post_content_paddingtop'] : 0; ?>
											<input type="number" id="download_post_content_paddingtop" name="download_post_content_paddingtop" step="1" value="<?php echo esc_attr( $download_post_content_paddingtop ); ?>"  onkeypress="return isNumberKey(event)">
										</div>
									</div>
									<div class="bdp-boxshadow-cover">
										<div class="bdp-boxshadow-label">
										...
										<div class="bdp-boxshadow-content">
											<?php $download_post_content_paddingbottom = isset( $bdp_settings['download_post_content_paddingbottom'] ) ? $bdp_settings['download_post_content_paddingbottom'] : 0; ?>
											<input type="number" id="download_post_content_paddingbottom" name="download_post_content_paddingbottom" step="1" value="<?php echo esc_attr( $download_post_content_paddingbottom ); ?>" onkeypress="return isNumberKey(event)">
										</div>
									</div>
								</div>
							</li>
							...
							<li class="read_more_wrap bdp_padding_0">
								<div class="bdp-typography-wrapper bdp-typography-wrapper1 bdp_grid_col_2">
									<div class="bdp-typography-cover">
										...
										<div class="bdp-typography-sub-cover read_more_button_border_radius_setting bdp_border_radius_tr">
											<div class="bdp-typography-label">
												<span class="bdp-key-title">
							...
							<div class="bdp_grid_col_3">
								...
								<li class="gridcol_space_tr">
									<div class="bdp-left">
										...
										<?php esc_html_e( 'px', 'blog-designer-pro' ); ?>
									</div>
									<div class="bdp-right">
								...
								<li class="bdp_media_custom_size_tr display_image_tr">
									...
									<div class="bdp-right">
										<div class="bdp_media_custom_size_tbl">
											<p> <span class="bdp_custom_media_size_title"><?php esc_html_e( 'Width', 'blog-designer-pro' ); ?> </span> 
											<span class="bdp-px-prefix"><?php esc_html_e( '(px)', 'blog-designer-pro' ); ?></span><input type="number" min="1" name="media_custom_width" class="media_custom_width" id="media_custom_width" value="<?php echo ( isset( $bdp_settings['media_custom_width'] ) && '' != $bdp_settings['media_custom_width'] ) ? esc_attr( $bdp_settings['media_custom_width'] ) : ''; ?>" /> </p>
											<p> <span class="bdp_custom_media_size_title"><?php esc_html_e( 'Height', 'blog-designer-pro' ); ?> </span> 
											<span class="bdp-px-prefix"><?php esc_html_e( '(px)', 'blog-designer-pro' ); ?></span><input type="number" min="1" name="media_custom_height" class="media_custom_height" id="media_custom_height" value="<?php echo ( isset( $bdp_settings['media_custom_height'] ) && '' != $bdp_settings['media_custom_height'] ) ? esc_attr( $bdp_settings['media_custom_height'] ) : ''; ?>"/> </p>
										</div>
									</div>
								</li>
							</div>
					...
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<div class="bdp_grid_col_3">
								...
								<li class="select_slider_navigation">
									<div class="bdp-left">
										<span class="bdp-key-title">
								...
								<li class="slider_autoplay_tr">
									<div class="bdp-left">
										<span class="bdp-key-title">
											<?php esc_html_e( 'Enter slider autoplay intervals', 'blog-designer-pro' ); ?>
										</span>
										<?php echo '<span class="bdp-media-div">(<i>' . esc_html__( 'ms', 'blog-designer-pro' ) . '</i>)</span>'; ?>
									</div>
									<div class="bdp-right">
								...
								<li class="slider_autoplay_tr">
									<div class="bdp-left">
										<span class="bdp-key-title">
											<?php esc_html_e( 'Slider Speed', 'blog-designer-pro' ); ?>
										</span>
										<?php echo '<span class="bdp-media-div">(<i>' . esc_html__( 'ms', 'blog-designer-pro' ) . '</i>)</span>'; ?>
									</div>
									<div class="bdp-right">
									...
									<div class="bdp-right">
										<div class="bdp_3d_slider_custom_size_tbl">
											<p> <span class="bdp_custom_3d_slider_size_title">
												...
												?>
												</span> <span class="bdp-px-prefix"><?php esc_html_e( '(px)', 'blog-designer-pro' ); ?></span><input type="number" min="1" name="slider_custom_width" class="slider_custom_width" id="slider_custom_width" value="<?php echo ( isset( $bdp_settings['slider_custom_width'] ) && '' != $bdp_settings['slider_custom_width'] ) ? esc_attr( $bdp_settings['slider_custom_width'] ) : ''; ?>" /></p>
												<p> <span class="bdp_custom_3d_slider_size_title">
												<?php
												esc_html_e( 'Height', 'blog-designer-pro' );
												?>
											</span> <span class="bdp-px-prefix"><?php esc_html_e( '(px)', 'blog-designer-pro' ); ?></span><input type="number" min="1" name="slider_custom_height" class="slider_custom_height" id="slider_custom_height" value="<?php echo ( isset( $bdp_settings['slider_custom_height'] ) && '' != $bdp_settings['slider_custom_height'] ) ? esc_attr( $bdp_settings['slider_custom_height'] ) : ''; ?>"/> </p>
										</div>
									</div>
								</li>
				...
				<div id="bdpeddsettings" class="postbox postbox-with-fw-options" style=<?php echo esc_attr( $bdpeddsetting_class_show ); ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							<li>
								<div class="bdp-left">
										...
										<div class="bdp-typography-wrapper bdp-typography-wrapper1 bdp_grid_col_4">
											...
											<div class="bdp-typography-cover">
												...
												<div class="bdp-typography-content">
													...
													?>
													<input type="number" class="grid_col_space_val" name="bdp_edd_pricefontsize" id="bdp_edd_pricefontsize" value="<?php echo esc_attr( $bdp_edd_pricefontsize ); ?>" onkeypress="return isNumberKey(event)" />
												</div>
											</div>
											...
											<div class="bdp-typography-wrapper bdp-typography-wrapper1 bdp_grid_col_4">
												...
												<div class="bdp-typography-cover">
													...
													<div class="bdp-typography-content">
														...
														?>
														<input type="number" class="grid_col_space_val" name="bdp_edd_addtocart_button_fontsize" id="bdp_edd_addtocart_button_fontsize" value="<?php echo esc_attr( $bdp_edd_addtocart_button_fontsize ); ?>" onkeypress="return isNumberKey(event)" />
													</div>
												</div>
