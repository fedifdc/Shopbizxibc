...
$shortcodes = $wpdb->get_results( $wpdb->prepare( "SELECT * FROM {$wpdb->prefix}bdp_single_layouts %1s order by %1s %1s limit %d, %d", $where, $order_field, $order_by, $offset, $limit ) );
?>
