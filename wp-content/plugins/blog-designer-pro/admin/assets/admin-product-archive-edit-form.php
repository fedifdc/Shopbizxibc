		...
		<div id="poststuff">
			<div class="postbox-container bd-settings-wrappers bd_poststuff">
				...
				<div id="bdpproductgeneral" class="postbox postbox-with-fw-options" style=<?php echo esc_attr( $bdpgeneral_class_show ); ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<li class="bdp-product-archive-li">
								<div class="bdp-left">
										...
										$template_color_preset = array(
											...
											'evolution'    => array(
												...
												'evolution_buttercup' => array(
													...
													'preset_value' => 'template_bgcolor:#ffffff,template_alterbgcolor:#ffffff,template_ftcolor:#555555,template_fthovercolor:#E5A452,template_titlecolor:#DF8D27,template_titlehovercolor:#E5A452,template_titlebackcolor:#ffffff,template_readmorecolor:#ffffff,template_readmorebackcolor:#E5A452,template_contentcolor:#333333,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#E5A452,beforeloop_readmorehovercolor:#E5A452,beforeloop_readmorehoverbackcolor:#ffffff,bdp_sale_tagbgcolor:#DF8D27,bdp_sale_tagtextcolor:#ffffff,bdp_star_rating_color:#333333,bdp_star_rating_bg_color:#555555,bdp_pricetextcolor:#DF8D27,bdp_wishlist_textcolor:#ffffff,bdp_wishlist_backgroundcolor:#555555,bdp_wishlist_text_hover_color:#ffffff,bdp_wishlist_hover_backgroundcolor:#E5A452,bdp_addtocart_textcolor:#ffffff,bdp_addtocart_backgroundcolor:#DF8D27,bdp_addtocart_text_hover_color:#ffffff,bdp_addtocart_hover_backgroundcolor:#333333',
											...
											'spektrum'     => array(
												...
												'spektrum_alizarin' => array(
													'preset_name' => esc_html__( 'Alizarin', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#EA1A3A,template_fthovercolor:#EE4861,template_titlecolor:#EA1A3A,template_titlehovercolor:#EE4861,template_titlebackcolor:#ffffff,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#EE4861,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#EE4861,beforeloop_readmorehovercolor:#EE4861,beforeloop_readmorehoverbackcolor:#ffffff,bdp_sale_tagbgcolor:#EA1A3A,bdp_sale_tagtextcolor:#ffffff,bdp_star_rating_color:#333333,bdp_star_rating_bg_color:#555555,bdp_pricetextcolor:#EE4861,bdp_wishlist_textcolor:#ffffff,bdp_wishlist_backgroundcolor:#EE4861,bdp_wishlist_text_hover_color:#ffffff,bdp_wishlist_hover_backgroundcolor:#555555,bdp_addtocart_textcolor:#ffffff,bdp_addtocart_backgroundcolor:#EA1A3A,bdp_addtocart_text_hover_color:#ffffff,bdp_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#EA1A3A,#EE4861,#555555,#333333',
												),
												'spektrum_buttercup' => array(
													'preset_name' => esc_html__( 'Buttercup', 'blog-designer-pro' ),
													'preset_value' => 'template_bgcolor:#ffffff,template_ftcolor:#DF8D27,template_fthovercolor:#E5A452,template_titlecolor:#DF8D27,template_titlehovercolor:#E5A452,template_titlebackcolor:#ffffff,template_contentcolor:#333333,template_readmorecolor:#ffffff,template_readmorebackcolor:#E5A452,beforeloop_readmorecolor:#ffffff,beforeloop_readmorebackcolor:#E5A452,beforeloop_readmorehovercolor:#E5A452,beforeloop_readmorehoverbackcolor:#ffffff,bdp_sale_tagbgcolor:#DF8D27,bdp_sale_tagtextcolor:#ffffff,bdp_star_rating_color:#333333,bdp_star_rating_bg_color:#555555,bdp_pricetextcolor:#E5A452,bdp_wishlist_textcolor:#ffffff,bdp_wishlist_backgroundcolor:#E5A452,bdp_wishlist_text_hover_color:#ffffff,bdp_wishlist_hover_backgroundcolor:#555555,bdp_addtocart_textcolor:#ffffff,bdp_addtocart_backgroundcolor:#DF8D27,bdp_addtocart_text_hover_color:#ffffff,bdp_addtocart_hover_backgroundcolor:#333333',
													'display_value' => '#DF8D27,#E5A452,#555555,#333333',
												),
					...
					<div class="inside">
						<ul class="bdp-settings">
							<div class="bdp_grid_col_3">
								...
								<li class="bdp-active-product-li">
									<div class="bdp-left">
										<span class="bdp-key-title">
								...
								<li class="bdp-products-effect-li">
									<div class="bdp-left">
										<span class="bdp-key-title">
								...
								<li>
									<div class="bdp-left">
										<span class="bdp-key-title">
											<?php esc_html_e( 'Item Height ', 'blog-designer-pro' ); ?>
											<span class="bdp-px-prefix"><?php esc_html_e( '(px)', 'blog-designer-pro' ); ?></span>
										</span>
									</div>
									<div class="bdp-right">
								...
								<li>
									<div class="bdp-left">
										<span class="bdp-key-title">
											<?php esc_html_e( 'Margin between Blog Product ', 'blog-designer-pro' ); ?>
											<span class="bdp-px-prefix"><?php esc_html_e( '(px)', 'blog-designer-pro' ); ?></span>
										</span>
									</div>
									<div class="bdp-right">
										...
										<input type="number" name="template_post_margin" id="template_post_margin" value="<?php echo esc_attr( $template_post_margin ); ?>" />
									</div>
								</li>
								<li>
									<div class="bdp-left">
				...
				<div id="bdpstandard" class="postbox postbox-with-fw-options" style=<?php echo esc_attr( $bdpstandard_class_show ); ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							<li class="bdp-main-container-class-name-li">
								<div class="bdp-left">
									<span class="bdp-key-title">
							...
							<div class="bdp_grid_col_2">
								...
								<li class="ticker-label-text">
									...
									<div class="bdp-right">
										<?php $ticker_label_text = ( isset( $bdp_settings['ticker_label_text'] ) && '' != $bdp_settings['ticker_label_text'] ) ? $bdp_settings['main_container_class'] : ''; ?>
							...
							<div class="bdp_grid_col_3">
								...
								<li class="icon_font_size_setting">
									...
									<div class="bdp-right">
										...
										?>
											<input type="number" name="icon_fontsize" id="icon_fontsize" value="<?php echo esc_attr( $icon_fontsize ); ?>" onkeypress="return isNumberKey(event)" />
									</div>
								</li>
							</div>
						...
						<ul class="bdp-settings bdp-lineheight">
							<div class="bdp_grid_col_2">
								...
								<li class="post_length_setting">
									<div class="bdp-left">
										<span class="bdp-key-title">
											<?php esc_html_e( 'Product Tile Maximum Line', 'blog-designer' ); ?>
										</span>
									</div>
									<div class="bdp-right">
										<fieldset class="buttonset">
								...
								<li class="post_length_line">
									...
									<div class="bdp-right  input_number_of_line">
										...
										<input type="number" id="total_noofline" name="total_noofline" step="1" min="0" value="<?php echo isset( $bdp_settings['total_noofline'] ) ? esc_attr( $bdp_settings['total_noofline'] ) : '2'; ?>" placeholder="<?php esc_attr_e( 'Enter total number of Line', 'blog-designer' ); ?>" onkeypress="return isNumberKey(event)">
									</div>
								</li>
								<li class="post_content_wrap">
									<div class="bdp-left">
										<span class="bdp-key-title">
											<?php esc_html_e( 'Product Title Break Words', 'blog-designer' ); ?>
										</span>
									</div>
									<div class="bdp-right">
										<?php
							...
							<li class="bdp-typography-label-li">
				...
				<div id="bdpcontent" class="postbox postbox-with-fw-options bdp-content-setting1" style=<?php echo esc_attr( $bdpcontent_class_show ); ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							...
							<li class="bdp-product-typography-label-li">
								<div class="bdp-typography-wrapper bdp-typography-wrapper1 bdp_grid_col_4">
									<div class="bdp-typography-cover">
										<div class="bdp-typography-label">
											<span class="bdp-key-title">
								...
								<div class="bdp-typography-wrapper bdp-typography-wrapper1 bdp_grid_col_2">
									...
									<div class="bdp-typography-cover product-archive-readmore-hover">
										...
										<div class="bdp-typography-sub-cover full-width read_more_button_border_setting">
											<div class="bdp-typography-label">
												<span class="bdp-key-title">
													<?php esc_html_e( 'Read More Hover Button Border', 'blog-designer-pro' ); ?>
												</span>
											</div>
											<div class="bdp-typography-content">
												<div class="bdp-border-wrap">
								...
								<div class="bdp-typography-wrapper bdp-typography-wrapper1 bdp_grid_col_4">
									...
									<div class="bdp-typography-cover">
										...
										<?php $readmore_fontsize = isset( $bdp_settings['readmore_fontsize'] ) ? $bdp_settings['readmore_fontsize'] : '14'; ?>
											<input type="number" name="readmore_fontsize" id="readmore_fontsize" value="<?php echo esc_attr( $readmore_fontsize ); ?>" onkeypress="return isNumberKey(event)" />
										</div>
									</div>
							...
							<div class="bdp_grid_col_3">
								...
								<li class="gridcol_space_tr">
									...
									<div class="bdp-right">
										...
										<input type="number" name="grid_col_space" id="grid_col_spaceOutputId" value="<?php echo esc_attr( $grid_col_space ); ?>" />
									</div>
								</li>
								...
								<li class="bdp_media_custom_size_tr display_image_tr">
									...
									<div class="bdp-right">
										<div class="bdp_media_custom_size_tbl">
											<p> <span class="bdp_custom_media_size_title"><?php esc_html_e( 'Width ', 'blog-designer-pro' ); ?> <span class="bdp-px-prefix"><?php esc_html_e( '(px)', 'blog-designer-pro' ); ?></span></span> <input type="number" min="1" name="media_custom_width" class="media_custom_width" id="media_custom_width" value="<?php echo ( isset( $bdp_settings['media_custom_width'] ) && '' != $bdp_settings['media_custom_width'] ) ? esc_attr( $bdp_settings['media_custom_width'] ) : ''; ?>" /> </p>
											<p> <span class="bdp_custom_media_size_title"><?php esc_html_e( 'Height ', 'blog-designer-pro' ); ?> <span class="bdp-px-prefix"><?php esc_html_e( '(px)', 'blog-designer-pro' ); ?></span></span> <input type="number" min="1" name="media_custom_height" class="media_custom_height" id="media_custom_height" value="<?php echo ( isset( $bdp_settings['media_custom_height'] ) && '' != $bdp_settings['media_custom_height'] ) ? esc_attr( $bdp_settings['media_custom_height'] ) : ''; ?>"/> </p>
										</div>
									</div>
								</li>
							</div>
				...
				<div id="bdpproductarchivesetting" class="postbox postbox-with-fw-options" style=<?php echo esc_attr( $bdpproductsetting_class_show ); ?>>
					<div class="inside">
						<ul class="bdp-settings bdp-lineheight">
							<li class="bdp-display-sale-tag-li">
								<div class="bdp-left">
									<span class="bdp-key-title">
							...
							<li class="bdp-display-product-rating-li">
								<div class="bdp-left">
									<span class="bdp-key-title">
							...
							<li class="bdp_star_rating_setting">
								<ul>
									<div class="bdp_grid_col_3">
										...
										<li class="bdp_star_rating_tr bdp_star_rating_alignment_tr">
											<div class="bdp-left">
												<span class="bdp-key-title">
													<?php esc_html_e( 'Alignment', 'blog-designer-pro' ); ?>
												</span>
									...
									<li class="bdp_star_rating_tr bdp_price_padding_tr">
										<div class="bdp-boxshadow-wrapper bdp-boxshadow-wrapper1">
											<div class="bdp-boxshadow-cover">
												<div class="bdp-boxshadow-label">
													<span class="bdp-key-title">
									...
									<li class="bdp_star_rating_tr bdp_price_margin_tr">
										<div class="bdp-boxshadow-wrapper bdp-boxshadow-wrapper1">
											<div class="bdp-boxshadow-cover">
												<div class="bdp-boxshadow-label">
													<span class="bdp-key-title">
																...
																<div class="bdp-rmb-inner">
																	...
																	<div class="bdp-border-cover">
																		<div class="bdp-border-content">
																			...
																			<input type="number" id="bdp_addtocartbutton_borderbuttom" name="bdp_addtocartbutton_borderbuttom" step="1" min="0" value="<?php echo esc_attr( $bdp_addtocartbutton_borderbottom ); ?>" onkeypress="return isNumberKey(event)">
																		</div>
																	</div>
																</div>
																<div class="bdp-rmb-inner">
