 ...
 * This template can be overridden by copying it to yourtheme/bdp_templates/archive/neaty_block.php.
 *
...
add_action( 'bd_archive_design_format_function', 'bdp_archive_neaty_block_template', 10, 1 );

if ( ! function_exists( 'bdp_archive_neaty_block_template' ) ) {
	/**
	 ...
	 * @return void
	 */
	function bdp_archive_neaty_block_template( $bdp_settings ) {
		...
		?>
		<div class="bdp_blog_template blog_template neaty_block_blog">
		<?php
		...
		if ( 1 == $display_author || 1 == $display_comment_count || 1 == $display_postlike ) {
			if ( 1 == $display_author ) {
