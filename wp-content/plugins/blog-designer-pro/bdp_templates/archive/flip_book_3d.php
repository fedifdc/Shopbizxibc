 ...
 * This template can be overridden by copying it to yourtheme/bdp_templates/archive/flip_book_3d.php.
 *
...
add_action( 'bd_archive_design_format_function', 'bdp_archive_flip_book_3d_template', 10, 2 );

if ( ! function_exists( 'bdp_archive_flip_book_3d_template' ) ) {

	/**
	 * Add html for flip_book_3d template
	 *
	 ...
	 * @return void
	 */
	function bdp_archive_flip_book_3d_template( $bdp_settings, $alterclass ) {
		...
		$class_name           = 'blog_template bdp_blog_template flip_book_3d bb-item';
