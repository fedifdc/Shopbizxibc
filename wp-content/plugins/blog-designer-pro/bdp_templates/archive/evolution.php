...
if ( ! function_exists( 'bdp_archive_evolution_template' ) ) {
	...
	function bdp_archive_evolution_template( $bdp_settings, $alterclass ) {
		...
		<div class="<?php echo esc_attr( $class_name ); ?>">
			...
			<?php
			if ( 0 == $bdp_settings['rss_use_excerpt'] ) {
							...
							<div class="post-category custom-post-category <?php echo ( ! $taxonomy_link ) ? 'bdp_no_links' : ''; ?>">
								...
								if ( isset( $taxonomy ) && ! in_array( $taxonomy, $bdp_exclude_taxonomy ) ) {
									if ( isset( $term_list ) && ! empty( $term_list ) ) {
										?>
										<span class="taxonomies <?php echo esc_html( $taxonomy ); ?>">
											<span class="link-lable">
											<?php
											if ( ! in_array( $taxonomy, $bdp_exclude_label_taxonomy ) ) {
												echo '<i class="fas fa-folder-open"></i>&nbsp;' . esc_html( $taxonomy_single->label ) . '&nbsp;:&nbsp;';
											} elseif ( in_array( $taxonomy, $bdp_exclude_label_taxonomy ) ) {
