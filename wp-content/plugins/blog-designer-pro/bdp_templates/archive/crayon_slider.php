						...
						<div class="metadatabox">
							...
							if ( 1 == $bdp_settings['display_author'] || 1 == $bdp_settings['display_date'] ) {
								if ( 1 == $bdp_settings['display_author'] ) {
									...
									$author_class = ( Bdp_Utility::get_first_embed_media( $post->ID, $bdp_settings ) && 1 == $bdp_settings['rss_use_excerpt'] && get_post_format( $post->ID ) != 'gallery' ) ? 'class="post-video-format"' : '';
									?>
									<div class="mauthor">
