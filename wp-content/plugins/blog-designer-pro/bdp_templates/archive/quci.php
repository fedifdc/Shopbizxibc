 ...
 * This template can be overridden by copying it to yourtheme/bdp_templates/archive/quci.php.
 *
...
add_action( 'bd_archive_design_format_function', 'bdp_archive_quci_template', 10, 2 );

if ( ! function_exists( 'bdp_archive_quci_template' ) ) {
	 ...
	 * @return void
	 */
	function bdp_archive_quci_template( $bdp_settings, $alterclass ) {
		if ( ! defined( 'ABSPATH' ) ) {
			exit;
		}
				...
				if ( 1 == $display_author || 1 == $display_date || 1 == $comment_cnt || 1 == $bdp_settings['display_postlike'] ) {
					...
					<div class="posted_by">
						...
						if ( isset( $bdp_settings['display_postlike'] ) && 1 == $bdp_settings['display_postlike'] ) {
							echo ( ( 1 == $display_author && 1 == $display_date || 1 == $comment_cnt ) ) ? ' | ' : '';
			...
			<div class="post_content">
					<div class="post_content-inner">
						<?php if ( 0 == $bdp_settings['rss_use_excerpt'] ) : ?>
							...
							if ( '' != $bdp_excerpt_data ) {
								?>
								<p><?php echo esc_attr( $bdp_excerpt_data ); ?>
								<?php
					...
					<?php if ( 0 != $bdp_settings['rss_use_excerpt'] && 2 == $read_more_on ) { ?>
