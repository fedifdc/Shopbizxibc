...
if ( ! function_exists( 'bdp_archive_lightbreeze_template' ) ) {
	...
	function bdp_archive_lightbreeze_template( $bdp_settings, $alterclass ) {
		...
		if ( 'product' !== $post_type && isset( $bdp_settings['display_category'] ) && 0 == $bdp_settings['display_category'] ) {
		...
		">
			...
			">
				...
				<?php
				if ( 1 == $bdp_settings['display_date'] || 1 == $bdp_settings['display_postlike'] || 1 == $bdp_settings['display_tag'] || 1 == $bdp_settings['display_author'] || 1 == $bdp_settings['display_category'] || 1 == $bdp_settings['display_comment_count'] ) {
					?>
					...
					if ( isset( $bdp_settings[ 'display_taxonomy_' . $taxonomy ] ) && 1 == $bdp_settings[ 'display_taxonomy_' . $taxonomy ] ) {
						...
						if ( isset( $taxonomy ) && ! in_array( $taxonomy, $bdp_exclude_taxonomy ) ) {
							if ( isset( $term_list ) && ! empty( $term_list ) ) {
								$sep = 1;
								?>
								<div class="tags taxonomies <?php echo esc_attr( $taxonomy ); ?> <?php echo ( $taxonomy_link ) ? 'bdp_has_links' : 'bdp_no_links'; ?>">
