 ...
 * This template can be overridden by copying it to yourtheme/bdp_templates/archive/colorful_sliding.php.
 *
...
add_action( 'bd_archive_design_format_function', 'bdp_archive_colorful_sliding_template', 10, 2 );

if ( ! function_exists( 'bdp_archive_colorful_sliding_template' ) ) {
	 ...
	 * @return void
	 */
	function bdp_archive_colorful_sliding_template( $bdp_settings, $alterclass ) {
