 ...
 * This template can be overridden by copying it to yourtheme/bdp_templates/archive/banner.php.
 *
...
add_action( 'bd_archive_design_format_function', 'bdp_archive_banner_template', 10, 1 );

if ( ! function_exists( 'bdp_archive_banner_template' ) ) {
	/**
	 * Add html for banner template
	 *
	 * @param array $bdp_settings settings.
	 * @global object $post
	 * @return void
	 */
	function bdp_archive_banner_template( $bdp_settings ) {
		...
		$has_thumbnail = false;
		?>
		<div class="bdp_blog_template banner-post post-body-div col-lg-3 col-sm-6">
			<?php
