 ...
 * This template can be overridden by copying it to yourtheme/bdp_templates/archive/wise_block.php.
 *
...
add_action( 'bd_archive_design_format_function', 'bdp_archive_wise_block_template', 10, 2 );
if ( ! function_exists( 'bdp_archive_wise_block_template' ) ) {
	 ...
	 * @return void
	 */
	function bdp_archive_wise_block_template( $bdp_settings, $alterclass ) {
		...
		?>
		<div class="<?php echo esc_attr( $class_name ); ?> bdp_blog_single_post_wrapp">
			...
			<div class="bdp_blog_wraper ">
				...
				if ( in_array( $post_type, $bdp_all_post_type ) ) {
					...
					if ( isset( $bdp_settings['display_category'] ) && 1 == $bdp_settings['display_category'] ) {
						...
						?>
						<span class="post-category bdp-mb-15 <?php echo ( $categories_link ) ? 'bdp-no-linka' : 'bdp-has-links'; ?>">
							<?php
							if ( $categories_link ) {
				...
				?>
				<div class="post_content bdp-md-15">
						<?php
					...
					if ( 1 == $display_comment_count ) {
						...
						<li class="metacomments <?php echo esc_attr( $comment_class ); ?>">
							...
							if ( isset( $bdp_settings['disable_link_comment'] ) && 1 == $bdp_settings['disable_link_comment'] ) {
								comments_number( __( 'Leave a Comment', 'blog-designer-pro' ), 1, '%' );
							} else {
