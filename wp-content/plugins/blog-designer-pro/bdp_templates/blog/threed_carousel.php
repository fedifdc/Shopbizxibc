 ...
 * This template can be overridden by copying it to yourtheme/bdp_templates/blog/threed_carousel.php.
 *
...
<li class="<?php echo esc_attr( $class_name ) . ' columns_' . esc_attr( $slider_column ); ?>" style="display: inline-block; height: auto;">
