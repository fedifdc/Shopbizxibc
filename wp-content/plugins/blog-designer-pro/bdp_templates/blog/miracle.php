...
?>
<div class="bdp_blog_template blog_template miracle_blog bdp_blog_single_post_wrapp <?php echo esc_attr( $category ); ?>">
	<?php do_action( 'bdp_before_post_content' ); ?>
	<span class="bdp-post-format"><i class="<?php echo esc_attr( $post_format ); ?>"></i></span>
	<?php
	...
	if ( Bdp_Utility::get_first_embed_media( $post->ID, $bdp_settings ) && 1 == $bdp_settings['rss_use_excerpt'] ) {
		...
		if ( 1 == $display_author || ! empty( $thumbnail ) ) {
			?>
