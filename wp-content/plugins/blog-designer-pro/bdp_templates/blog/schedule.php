	...
	<div class="schedule-wrap">
		<div class="bdp-post-meta">
			...
			if ( 'post' === $bdp_settings['custom_post_type'] ) {
				...
				if ( isset( $bdp_settings[ 'display_taxonomy_' . $bdp_tax_tag ] ) && 1 == $bdp_settings[ 'display_taxonomy_' . $bdp_tax_tag ] ) {
								...
								if ( isset( $taxonomy ) && ! in_array( $taxonomy, $bdp_exclude_taxonomy ) ) {
									if ( isset( $term_list ) && ! empty( $term_list ) ) {
										...
										<span class="post-category taxonomies<?php echo ( $taxonomy_link ) ? ' bdp_no_links' : ' bdp_has_link'; ?>">
											...
											<?php
											if ( isset( $bdp_include_taxonomy ) && ! in_array( $taxonomy, $bdp_include_taxonomy ) ) {
