...
if ( 1 == $blog_unique_design ) {
	if ( 'first_post' === $unique_design_option && 0 == $prev_year && 1 == $paged ) {
		...
		$class_name = 'bdp_blog_template blog_template navia';
	}if ( 'featured_posts' === $unique_design_option && 0 == $prev_year && 1 == $paged ) {
		$class_name = 'bdp_blog_template blog_template navia first_post';
	...
	<div class="navia-wrap">
		...
		">
			...
			if ( Bdp_Utility::get_first_embed_media( $post->ID, $bdp_settings ) && 1 == $bdp_settings['rss_use_excerpt'] ) {
				...
				if ( isset( $bdp_settings['pinterest_image_share'] ) && 1 == $bdp_settings['pinterest_image_share'] && ( has_post_thumbnail() || ( isset( $bdp_settings['bdp_default_image_id'] ) && '' != $bdp_settings['bdp_default_image_id'] ) ) ) {
