...
<div class="<?php echo esc_attr( $class_name ); ?> bdp_blog_single_post_wrapp <?php echo esc_attr( $category ); ?>">
	...
	<div class="blog_header">
		...
		if ( 1 == $display_date && ( isset( $bdp_settings['display_tag'] ) && 1 == $bdp_settings['display_tag'] && has_tag() ) ) {
			echo '<span>-</span>';
		}
		...
		?>
			...
			if ( 1 == $bdp_settings['display_comment_count'] || ( isset( $bdp_settings['display_postlike'] ) && 1 == $bdp_settings['display_postlike'] ) ) {
				?>
	...
	<div class="post_content_wrap">
		...
		<p><?php echo wp_kses( Bdp_Posts::get_content( $post->ID, $bdp_settings, $bdp_settings['rss_use_excerpt'], $bdp_settings['txtExcerptlength'] ), Bdp_Admin_Functions::args_kses() ); ?>
			<?php
			...
			<?php
			if ( 1 == $read_more_link && 0 != $bdp_settings['rss_use_excerpt'] && 2 == $read_more_on ) {
