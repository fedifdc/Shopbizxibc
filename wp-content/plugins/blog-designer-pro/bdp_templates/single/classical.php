		...
		<div class="blog_template bdp_blog_template classical">
			...
			<div class="entry-container">
				...
				<div class="bdp-content-wrraper">
					...
					if ( $social_share ) {
						if ( ( isset( $bdp_settings['facebook_link'] ) && 1 == $bdp_settings['facebook_link'] ) || ( isset( $bdp_settings['twitter_link'] ) && 1 == $bdp_settings['twitter_link'] ) || ( isset( $bdp_settings['linkedin_link'] ) && 1 == $bdp_settings['linkedin_link'] ) || ( isset( $bdp_settings['email_link'] ) && 1 == $bdp_settings['email_link'] ) ||
						( isset( $bdp_settings['pinterest_link'] ) && 1 == $bdp_settings['pinterest_link'] ) || ( isset( $bdp_settings['telegram_link'] ) && 1 == $bdp_settings['telegram_link'] ) || ( isset( $bdp_settings['pocket_link'] ) && 1 == $bdp_settings['pocket_link'] ) ||
						( isset( $bdp_settings['skype_link'] ) && 1 == $bdp_settings['skype_link'] ) || ( isset( $bdp_settings['telegram_link'] ) && 1 == $bdp_settings['telegram_link'] ) || ( isset( $bdp_settings['reddit_link'] ) && 1 == $bdp_settings['reddit_link'] ) || ( isset( $bdp_settings['digg_link'] ) && 1 == $bdp_settings['digg_link'] ) || ( isset( $bdp_settings['tumblr_link'] ) && 1 == $bdp_settings['tumblr_link'] ) || ( isset( $bdp_settings['wordpress_link'] ) && 1 == $bdp_settings['wordpress_link'] ) || ( isset( $bdp_settings['whatsapp_link'] ) && 1 == $bdp_settings['whatsapp_link'] )
						) {
							?>
