...
if ( ! function_exists( 'bdp_single_clicky_template' ) ) {
	...
	function bdp_single_clicky_template( $bdp_settings ) {
		...
		<div class="blog_template bdp_blog_template clicky">
			...
			if ( 1 == $display_date || 1 == $display_comment || 1 == $display_postlike || 0 != $display_post_views ) {
				?>
				<div class="post-meta">
					<?php
					if ( 1 == $display_date ) {
					...
					if ( 1 == $display_postlike ) {
						if ( 1 == $display_date || 1 == $display_comment ) {
							echo wp_kses( $separator, Bdp_Admin_Functions::args_kses() );
						}
					...
					if ( 0 != $display_post_views ) {
						if ( 1 == $display_date || 1 == $display_comment || 1 == $display_postlike ) {
							echo wp_kses( $separator, Bdp_Admin_Functions::args_kses() );
						}
