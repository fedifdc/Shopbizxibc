 ...
 * This template can be overridden by copying it to yourtheme/bdp_templates/single/soft_block.php.
 *
...
add_action( 'bd_single_design_format_function', 'bdp_single_soft_block_template', 10, 1 );

if ( ! function_exists( 'bdp_single_soft_block_template' ) ) {
	 ...
	 * @return void
	 */
	function bdp_single_soft_block_template( $bdp_settings ) {
		...
		?>
		<div class="blog_template bdp_blog_template soft_block_template">
			<div class="single-wrapper">
				<?php do_action( 'bdp_after_single_post_content' ); ?>
				<div class="bdp-post-date">
					<?php $ar_day = ( isset( $bdp_settings['dsiplay_date_from'] ) && 'modify' === $bdp_settings['dsiplay_date_from'] ) ? get_the_modified_time( 'd' ) : get_the_time( 'd' ); ?>
					<span class="mdate"><a href="#"><?php echo esc_html( $ar_day ); ?></a></span>
				</div>
				<?php if ( isset( $bdp_settings['display_thumbnail'] ) && 1 == $bdp_settings['display_thumbnail'] ) { ?>
