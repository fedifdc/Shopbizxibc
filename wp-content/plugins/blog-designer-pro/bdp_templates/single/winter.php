...
if ( ! function_exists( 'bdp_single_winter_template' ) ) {
	...
	function bdp_single_winter_template( $bdp_settings ) {
		...
		$no_image_class    = '';
		if ( ! has_post_thumbnail() || ( isset( $bdp_settings['display_thumbnail'] ) && 0 == $bdp_settings['display_thumbnail'] ) ) {
		...
		<div class="blog_template bdp_blog_template winter <?php echo esc_attr( $no_image_class ); ?>">
			...
			<div class="post_content_wrap">
				...
				if ( ! has_post_thumbnail() && isset( $bdp_settings['display_thumbnail'] ) && 1 == $bdp_settings['display_thumbnail'] ) {
					$class = 'no_img';
				} elseif ( ! has_post_thumbnail() && isset( $bdp_settings['display_thumbnail'] ) && 0 == $bdp_settings['display_thumbnail'] ) {
					$class = 'no_img';
				} elseif ( has_post_thumbnail() && isset( $bdp_settings['display_thumbnail'] ) && 0 == $bdp_settings['display_thumbnail'] ) {
					$class = 'no_img';
				} else {
