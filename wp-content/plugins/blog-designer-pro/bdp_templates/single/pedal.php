...
if ( ! function_exists( 'bdp_single_pedal_template' ) ) {
	...
	function bdp_single_pedal_template( $bdp_settings ) {
		...
		<div class="blog_wrap blog_template bdp_blog_template pedal">
			...
			<?php
			$class = '';
			if ( ( isset( $bdp_settings['display_date'] ) && 1 == $bdp_settings['display_date'] ) || ( isset( $bdp_settings['display_author'] ) && 1 == $bdp_settings['display_author'] ) ) {
				?>
				<div class="left_div">
				<?php
			...
			<div class="full_content_wrap <?php echo esc_attr( $class ); ?>">
				...
				<div class="post_summary_outer">
					...
					if ( ( isset( $bdp_settings['display_comment'] ) && 1 == $bdp_settings['display_comment'] ) || ( isset( $bdp_settings['display_postlike'] ) && 1 == $bdp_settings['display_postlike'] ) || ( isset( $bdp_settings['display_author'] ) && 1 == $bdp_settings['display_author'] ) ) {
