					...
					<div class="metadatabox">
						...
						if ( isset( $bdp_settings['display_date'] ) && 1 == $bdp_settings['display_date'] ) {
							...
							<div class="mdate">
								...
								<span class="mdate-month"> <?php echo esc_html( isset( $bdp_settings['dsiplay_date_from'] ) && 'modify' === $bdp_settings['dsiplay_date_from'] ) ? esc_html( get_the_modified_time( 'M' ) ) : esc_html( get_the_time( 'M' ) ); ?> </span>
								<span class="mdate-day"> <?php echo esc_html( isset( $bdp_settings['dsiplay_date_from'] ) && 'modify' === $bdp_settings['dsiplay_date_from'] ) ? esc_html( get_the_modified_time( 'd' ) ) : esc_html( get_the_time( 'd' ) ); ?> </span>
						...
						if ( 1 == $display_title ) {
							?>
							<h1 class="post-title <?php echo esc_html( $class ); ?>">
								<?php
						...
						if ( $bdp_settings['display_author'] && 1 == $bdp_settings['display_author'] ) {
