...
<div class="container">
	<div class="row">		
		<div class="col-sm-8 col-xs-12 ">
			...
			if ( 'boxy-clean' === $bdp_theme || 'crayon_slider' === $bdp_theme || 'sunshiny_slider' === $bdp_theme || 'sallet_slider' === $bdp_theme || 'colorful_sliding' === $bdp_theme || 'colorful_sliding' === $bdp_theme || 'blog_carousel' === $bdp_theme || 'leest' === $bdp_theme ) {
				$unique_id = wp_rand();
			}
			...
			if ( 'timeline' === $bdp_theme ) {
				$_classes = 'bdp_archive_product_template bdp_wrapper';
			} else {
				$_classes = 'blog_template bdp_archive_product_template bdp_wrapper';
			}
			?>
			<!-- For Archive Product  -->
			<div class="<?php echo esc_attr( $_classes ); ?> <?php echo esc_attr( $bdp_theme ); ?>_cover bdp_archive <?php echo esc_attr( $bdp_theme ) . ' layout_id_' . esc_attr( $archive_id ); ?>">
				<?php
				...
				$display_tabbed_filter_by = 'product_cat';
