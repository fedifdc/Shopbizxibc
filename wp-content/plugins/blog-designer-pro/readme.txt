...
Plugin provides easy-to-use and user friendly admin interface.

= Multiple Browser Compatibility =
Plugin is compatible with multiple web browsers like Firefox, Chrome, Safari, Opera.

= 61 Different and Unique Blog Templates =
Plugin offers 61 different and unique blog template to make your blog page more attractive.

= 8 Awesome Timeline Templates =
Plugin included 8 different and unique timeline template to showcase your story or timeline page in more attractive way.

= Multilingual Translation Ready =
Blog Designer is ready to use with any language.

= Import & Export Layout =
User can easily import layout and export layout settings.

= Support of Single Post Design =
User can change single post design with 50 different and unique template.
...
= 3.4.8
Release Date: 08th August, 2024
* Updated: Make compatible with WordPress 6.6.1
* Updated: Make compatible with Woocommerce Version 9.1.x
* Updated: Make compatible with PHP Version 8.3
* Added: New Blog Template - "Leest" in Slider Blog Template Category
* Fixed: Security issues
* Fixed: minor bug fix
* Fixed: Design issues

= 3.4.7
Release Date: 05th February, 2024
* Added: New Admin UI
...
* Added: New Blog Template - "Colorful Sliding" in Full Width Blog Template Category
* Added: Isotope Filter with Pagination
* Updated: Coding Standards
* Fixed: Design issues

= 3.4.4
Release date: 24th August, 2022
* Added: Category, Tags & Date Filter with Pagination
* Added: 2 New Designs in Vertical Scrolling Widget
* Added: New Blog Template - "Banner" in Full Width Blog Template Category
* Added: Lazy Load Option for every layout
* Added: New Blog Template - "3D Carousel" in Slider Blog Template Category
* Added: New Blog Template - "3D Flip book" in Slider Blog Template Category
* Added: Print PDF For Post Blog page
* Added: Print PDF For Product page
* Added: Print PDF For Download page
* Added: Print PDF For Archive  page
* Added: Print PDF For Archive Product page
* Added: Print PDF For Archive Download page
* Updated: Make compatible with WordPress version 6.0.1
* Fixed: Archive Tabbed Template bug fix
...
= 3.4.2
Release date: 21tst February, 2022
...
* Added: Margin padding option in title and content
* Fixed: minor bug fix
...
* Added: New Blog Template - "Accordion" in Full Width Blog Template Category
...
* Fixed: Blog post Height in Wise block, Brit-co, Famous layout
...
* Fixed: WPBakery Page Builder Support Fix
