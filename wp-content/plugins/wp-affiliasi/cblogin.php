...
Silahkan login kembali';
	...
	<div class="formprofil">
		<div class="cbform-row">
			<div class="cbform-label">Username/Email</div>
			<div class="cbform-field"><input type="text" class="cbform-input" name="log" required/></div>
		</div>
		<div class="cbform-row">
			<div class="cbform-label">Password</div>
			<div class="cbform-field"><input type="password" class="cbform-input" name="pwd" required/></div>
		</div>
		<div class="cbform-row">
