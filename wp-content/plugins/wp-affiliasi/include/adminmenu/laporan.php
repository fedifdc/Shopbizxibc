...
foreach ($laporan as $laporan) {		
	if ($laporan->keterangan == 'cbaff') {
		if (substr($laporan->transaksi, 0,12) == 'Komisi Lvl 1') {		
			...
			$transaksi .= ' (<a href="admin.php?page=cbaf_memberlist&profil='.$laporan->id_user.'" target="_blank" title="Lihat Profil"><span class="dashicons dashicons-search"></span></a>)';
		} 
		...
		$transaksi = $laporan->transaksi. ' (<a href="admin.php?page=cbaf_memberlist&profil='.$laporan->id_sponsor.'" target="_blank" title="Lihat Profil"><span class="dashicons dashicons-search"></span></a>)';
	} else {
