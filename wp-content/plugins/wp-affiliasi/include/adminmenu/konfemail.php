...
<div class="wrap">
	...
	<a class="page-title-action" data-toggle="collapse" href="#advanced" role="button" aria-expanded="false">Bantuan ⮟</a>	
	...
	<p>Ganti tulisan <strong>FIELD</strong> dengan nama field WP Affiliasi. Daftar lengkap nama field dapat dilihat di file <a href="<?php echo site_url();?>/wp-content/plugins/wp-affiliasi/readme.txt">readme.txt</a></p>
...
<div id="accordion">
  <div style="border: solid 1px #cccccc; margin-bottom:5px">
  <h5 class="mb-0">
    <a class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
      <strong>DATA UMUM</strong>
    </a>
  </h5>
  <div id="collapseOne" class="collapse show m-2" aria-labelledby="headingOne" data-parent="#accordion">
		<div class="form-group row">
	 		<label class="col-sm-3 col-form-label">Nama Anda</label>
	 		<div class="col-sm-9"><input type="text" class="form-control" name="nama_email" value="<?php echo stripslashes($konfemail['nama_email']); ?>"></div>
	 	</div>
	 	<div class="form-group row">
	 		<label class="col-sm-3 col-form-label">Alamat Email Anda</label>
	 		<div class="col-sm-9"><input type="text" class="form-control" name="alamat_email" value="<?php echo stripslashes($konfemail['alamat_email']); ?>"></div>
	 	</div>
  </div>
	</div>
  <?php
  ...
  <div style="border: solid 1px #cccccc; margin-bottom:5px">
  <h5 class="mb-0">
    <a class="btn btn-link collapsed" data-toggle="collapse" data-target="#col'.$keyform.'" aria-expanded="false" aria-controls="col'.$keyform.'">
      <strong>'.$valform.'</strong>
    </a>
  </h5>
  <div id="col'.$keyform.'" class="collapse m-2" aria-labelledby="head'.$keyform.'" data-parent="#accordion">
 		<div class="col-sm-9">
 			<div class="row">
 				<div class="col-sm-12">
 					...
 					#<textarea class="form-control" rows="7" name="isi_'.$keyform.'">'.($konfemail['isi_'.$keyform] ??= '').'</textarea>
 					echo '
 				</div>
 			</div>
 		</div>
