...
Mengubah WordPress biasa menjadi sebuah web affiliasi dengan sistem multi level yang bekerja secara otomatis. Mampu bekerja bersama plugin Woocommerce sehingga anda bisa membangun sebuah toko online dengan system affiliasi.
...
- Menampilkan data pemilik web replika:	[sponsor data="FIELD"] atau [sponsor_FIELD]
- Menampilkan data member: [member data="FIELD"] atau [member_FIELD]
- Menampilkan data sponsor member yg sedang login: [mysponsor data="FIELD"]
	Daftar FIELD :
	- idwp
	- id_referral
	- id_tianshi
...
- Kode Khusus:
	...
	- Gunakan https://cafebisnis.com/fotomysponsor.jpg untuk menampilkan foto member
