	...
	<div id="produkblock">
		<div id="produkbox">
			...
			if ($produk->membership == 3) { 
				$showtxt .= '<br/><small>Harga: '.$options['matauang'].' '.number_format($produk->harga).'</small>'; 
		...
		<div id="produkactionbox">
			...
			if ($tombol == 'download') {
				$showtxt .= '<a href="'.plugins_url('wp-affiliasi/downloader.php?id=').$produk->id.'" id="produkorder">DOWNLOAD</a>';
			} else {
				$showtxt .= $tombol;
			}
		$showtxt .= '
