<?php
/**
 * Plugin Options : Vendor redeem funds options
 *
...
$settings           = array(
	'vendor-multi-tab-redeem-funds' => array(
		...
		'redeeming_description'             => $feature_available ? array() : array(
			'type'             => 'yith-field',
			'yith-type'        => 'html',
			'yith-display-row' => true,
			'html'             => sprintf( '<p class="info-box">%s</p>', __( 'These features are available only with YITH WooCommerce MultiVendor Premium 3.7.0 or greater', 'yith-woocommerce-account-funds' ) ),
		),
		...
		'redeeming_payment_type'            => array(
			...
			'class'     => 2 === count( $disabled_gateway ) ? 'yith-disabled' : '',
			'type'      => 'yith-field',
			'yith-type' => 'radio',
			'options'   => array(
