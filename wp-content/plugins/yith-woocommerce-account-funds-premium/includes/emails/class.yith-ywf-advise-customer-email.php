...
/**
 * Class that manage the email send to customer when the admin change the customer funds in backend
 *
...
if ( ! class_exists( 'YITH_YWF_Advise_Customer_Email' ) ) {
	/**
	 * Class YITH_YWF_Advise_Customer_Email
	 */
	class YITH_YWF_Advise_Customer_Email extends WC_Email {
		/**
		 * YITH_YWF_Advise_Customer_Email constructor.
		 */
