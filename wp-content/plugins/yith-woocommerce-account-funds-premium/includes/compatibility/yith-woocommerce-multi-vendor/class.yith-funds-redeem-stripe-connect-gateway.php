...
/**
 * Class that manage the compatibility with YITH Multi Vendor Plugin : Stripe Connect Gateway
 *
...
class YITH_Redeem_Funds_Stripe_Connect {
	 ...
	 *
	 * @var YITH_Redeem_Funds_Stripe_Connect
	 */
	 ...
	 *
	 * @return YITH_Redeem_Funds_Stripe_Connect
	 * @since 1.4.0
...
if ( ! function_exists( 'YITH_Redeem_Funds_with_Stripe_Connect' ) ) {
	 ...
	 * @return YITH_Redeem_Funds_Stripe_Connect
	 */
	function YITH_Redeem_Funds_with_Stripe_Connect() { // phpcs:ignore WordPress.NamingConventions.ValidFunctionName
