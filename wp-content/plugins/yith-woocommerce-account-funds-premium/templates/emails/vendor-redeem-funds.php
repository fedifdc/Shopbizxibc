...
do_action( 'woocommerce_email_header', $email_heading, $email ); ?>
	...
	<p><?php esc_html_e( 'The following vendors have redeem funds:', 'yith-woocommerce-account-funds' ); ?></p>
	<table class="td" cellpadding="6" cellspacing="0" border="1" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
		<thead>
		<tr>
