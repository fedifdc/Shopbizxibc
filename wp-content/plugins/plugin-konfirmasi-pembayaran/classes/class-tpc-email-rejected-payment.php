 ...
 */
class TPC_Email_Rejected_Payment extends WC_Email {

	/**
	 * Constructor, set default email setting
	 */
	public function __construct() {
		$this->id             = 'tpc_rejected_payment';
		$this->title          = __( 'Rejected payment', 'tpc' );
		$this->description    = __( 'Email sent to the customer when admin rejects the payment.', 'tpc' );
		$this->template_html  = 'emails/customer-rejected-payment.php';
		...
		add_action( 'tpc_rejected_payment_notification', array( $this, 'trigger' ), 10, 2 );
	...
	public function get_default_subject() {
		return __( 'Sorry, we did not receive your payment for order #{order_number} on {site_title}', 'tpc' );
	}
	...
	public function get_default_heading() {
		return __( 'We did not receive your payment', 'tpc' );
	}
	...
	public function get_default_additional_content() {
		return __( 'Please make sure you have completed the payment.', 'tpc' );
	}
...
return new TPC_Email_Rejected_Payment();