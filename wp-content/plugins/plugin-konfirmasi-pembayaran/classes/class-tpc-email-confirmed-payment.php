 ...
 */
class TPC_Email_Confirmed_Payment extends WC_Email {

	/**
	 * Constructor, set default email setting
	 */
	public function __construct() {
		$this->id             = 'tpc_confirmed_payment';
		$this->title          = __( 'Confirmed payment', 'tpc' );
		$this->description    = __( 'Email sent to the customer when admin confirms the payment.', 'tpc' );
		$this->template_html  = 'emails/customer-confirmed-payment.php';
		...
		add_action( 'tpc_confirmed_payment_notification', array( $this, 'trigger' ), 10, 2 );
	...
	public function get_default_subject() {
		return __( 'We received your payment for order #{order_number} on {site_title}', 'tpc' );
	}
	...
	public function get_default_heading() {
		return __( 'Thankyou for your payment', 'tpc' );
	}
	...
	public function get_default_additional_content() {
		return __( 'Thank you. Your order will be processed soon.', 'tpc' );
	}
...
return new TPC_Email_Confirmed_Payment();