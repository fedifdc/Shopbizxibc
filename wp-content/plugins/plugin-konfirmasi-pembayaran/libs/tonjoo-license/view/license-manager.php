		...
		<div class="license-wrapper">
			<div class="license-content">
										...
										<td class="field">
											<div class="license-field">
												...
												<div class="status <?php echo $is_active ? 'stat-success' : 'stat-error'; ?>">
													<?php
													if ( $is_active ) {
														printf( __( 'Valid until: %s', 'tpc' ), $this->get_local_time( $plugin['expiry'] ) );
														...
														printf( __( 'Expired at: %s', 'tpc' ), $this->get_local_time( $plugin['expiry'] ) );
													} else {
				...
				<div class="upsell-separator">
					<h3><?php esc_html_e( 'Have you tried our other cool stuffs?', 'tpc' ) ?></h3>
				</div>
				<?php
			...
			<div class="license-sidebar">
				<div class="meta-box">
					<div class="postbox">
						<h3 class="hndle"><span class="dashicons dashicons-sos"></span> <?php echo esc_html_e( 'Help Center', 'tpc' ); ?></h3>
						<div class="item">
							<p><?php esc_html_e( 'Where can I get my licenses?', 'tpc' ) ?></p>
							<a href="https://tonjoostudio.com/account/items/" class="button" target="_blank"><?php echo esc_html_e( 'My Licenses', 'tpc' ) ?></a>
						</div>
						<div class="item">
							<p><?php esc_html_e( 'I have a problem with my license', 'tpc' ) ?></p>
							<a href="https://forum.tonjoostudio.com/" class="button" target="_blank"><?php echo esc_html_e( 'Support Forum', 'tpc' ) ?></a>
						</div>
					</div>
				</div>
			</div>
