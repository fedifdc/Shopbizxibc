...
class Hooks {
    ...
    public function store_products_orderby() {
        ...
        $categories      = $store_user->get_store_categories();
        ?>
        <div class="dokan-store-products-filter-area dokan-clearfix">
            ...
            <select class="store-category-list mobile-only" onchange="location.href=this.value">
               <option value="">Pilih Kategori</option>
                <?php
                  foreach ( $categories as $category ) {
                    if ( isset( $category->term_id ) ) {
                        $store_url = dokan_get_store_url( $store_id );
                        $category_url = trailingslashit( $store_url ) . 'section/' . $category->term_id;
                        echo '<option value="' . esc_url( $category_url ) . '">' . esc_html( $category->name ) . '</option>';
                    }
                }
                ?>
            </select>
