                        ...
                        <div class="store-wrapper">
                            ...
                            <div class="store-footer">
                                ...
                                <a href="<?php echo esc_url( $store_url ); ?>" title="<?php esc_attr_e( 'Visit Store', 'dokan-lite' ); ?>">
                              	...
                              	<?php 
                                $sync_data_partner = get_user_meta( $seller->ID, 'sync_data_partner', true );
								...
								?>
                                    ...
                                    <a href="<?php echo esc_url( $sync_data_partner['website'] ); ?>" class="dokan-btn dokan-btn-theme dokan-btn-sm" target="_blank"><?php esc_html_e( 'Website', 'dokan-lite' ); ?></a>
                                	<?php if($is_sync_user) : ?>
										<a href="<?php echo esc_url( $sync_data_partner['website'] ); ?>" class="dokan-btn dokan-btn-theme dokan-btn-sm" target="_blank"><?php esc_html_e( 'Hubungkan Akun', 'dokan-lite' ); ?></a>
                              		<?php else : ?>
										<a href="<?php echo esc_url( $sync_data_partner['website'] ); ?>" class="dokan-btn dokan-btn-theme dokan-btn-sm" target="_blank"><?php esc_html_e( 'Akun Terhubung', 'dokan-lite' ); ?></a>
									<?php endif; ?>
                                <?php else : ?>
                                    <a href="#" class="dokan-btn dokan-btn-theme dokan-btn-sm"><?php esc_html_e( 'Tidak Terhubung', 'dokan-lite' ); ?></a>
                                <?php endif; ?>
