...
class POK_Hooks_Addresses {
	...
	public function update_order_meta( $order_id, $data ) {
		...
		// set data API.
		$order->update_meta_data( '_pok_data_api', $this->setting->get( 'base_api' ) );
	...
	public function show_additional_info_on_checkout() {
		if ( 'yes' === $this->setting->get( 'show_origin_on_checkout' ) && WC()->cart->needs_shipping() && ! $this->helper->is_multi_vendor_addon_active() ) {
