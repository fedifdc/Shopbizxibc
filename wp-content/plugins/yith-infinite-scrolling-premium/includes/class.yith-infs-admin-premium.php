			...
			if ( isset( $_GET['page'] ) && sanitize_text_field( wp_unslash( $_GET['page'] ) ) === $this->panel_page ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				...
				wp_localize_script(
					...
					array(
						...
						/**
						 * APPLY_FILTERS: yith_infs_block_loader_admin
						 *
						 * Filters the block loader to use in the backend.
						 *
						...
						/**
						 * APPLY_FILTERS: yith_infs_error_msg_admin
						 *
						 * Filters the error message shown when trying to create a section without entering a name.
						 *
						...
						/**
						 * APPLY_FILTERS: yith_infs_delete_msg_admin
						 *
						 * Filters the confirmation message shown when trying to delete a section.
						 *
						 * @param string $message Message.
						 *
						 * @return string
