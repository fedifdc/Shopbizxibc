(function ($, window, document) {
    ...
    $.yit_infinitescroll = function (options) {
        ...
        if( opts.eventType == 'scroll' ) {
            ...
            var date = new Date(),
                id   = 'yith-infs-button-' + date.getTime();

            button = '<div class="yith-infs-button-wrapper"><button id="' + id + '" class="' + opts.buttonClass + '">' + opts.buttonLabel + '</button></div>';
            ...
            $( '#' + id ).off('click').on( 'click', function() {
                ...
                $( document ).on( 'yith_infs_adding_elem', function( event, elem ){
                    ...
                    if( yith_infs_script.scroll_top_on_click_load_more ){
