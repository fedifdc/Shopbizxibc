				...
				<div class="section-body">
					<table>
						...
						foreach ( $fields as $field_key => $field_opts ) :
							...
							$type       = isset( $field_opts['type'] ) ? $field_opts['type'] : 'text'; // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
									...
									case 'loader':
										...
										<select name="<?php echo esc_attr( $field_name ); ?>" id="<?php echo esc_attr( $field_id ); ?>"
											...
											<?php foreach ( $field_opts['options'] as $preset => $url ) : ?>
												<option value="<?php echo esc_attr( $preset ); ?>" data-loader_url="<?php echo esc_url( $url ); ?>" <?php selected( $preset, $value ); ?>>
