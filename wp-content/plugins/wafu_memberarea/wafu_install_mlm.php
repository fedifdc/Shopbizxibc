...
if (!$wpdb->get_var("show tables like 'wafu_campaign_mlm'")) {
	$sql = "
	CREATE TABLE `wafu_campaign_mlm` (
		`camp_user_wp` bigint(20) NOT NULL,
	...
	$sql = "
	CREATE TABLE `wafu_gruptomember_mlm` (
		`camp_user_wp` bigint(20) NOT NULL,
