...
if ( ! class_exists( 'myCRED_Transfer_Module' ) ) :
	class myCRED_Transfer_Module extends myCRED_Module {
		...
		public function after_general_settings( $mycred = NULL ) {
			...
			// Autofill by
			$autofill = isset( $settings['autofill'] ) ? $settings['autofill'] : '';
				...
				// Loop though limits
						...
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<input type="text" name="<?php echo esc_attr( $this->field_name( array( 'limit' => 'amount' ) ) ); ?>" id="<?php echo esc_attr( $this->field_id( array( 'limit' => 'amount' ) ) ); ?>" class="form-control" value="<?php echo esc_attr( isset( $settings['limit']['amount'] ) ? $this->core->number( $settings['limit']['amount'] ) : '' ); ?>" />
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="form-group">
								<label for="<?php echo esc_attr( $this->field_id( array( 'errors' => 'low' ) ) ); ?>">
									<?php esc_html_e( 'Insufficient Funds Warning', 'mycred' ); ?>
								</label>
								<input type="text" 
								name="<?php echo esc_attr( $this->field_name( array( 'errors' => 'low' ) ) ); ?>" 
								id="<?php echo esc_attr( $this->field_id( array( 'errors' => 'low' ) ) ); ?>" 
								value="<?php echo esc_attr( isset( $settings['errors']['low'] ) ? $settings['errors']['low'] : '' ); ?>" 
								class="form-control" />
								<p>
									<span class="description">
										<?php esc_html_e( 'Message to show the user if they try to send more than they can afford.', 'mycred' ); ?>
									</span>
								</p>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<?php
							$login_template = isset( $settings['templates']['login'] ) ? $settings['templates']['login'] : '';
							wp_editor(  $login_template, $this->field_id( array( 'templates' => 'login' ) ), array(
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<?php
							$limit_template = isset( $settings['templates']['limit'] ) ? $settings['templates']['limit'] : '';
							wp_editor( $limit_template, $this->field_id( array( 'templates' => 'limit' ) ), array(
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<?php
							$balance_template = isset( $settings['templates']['balance'] ) ? $settings['templates']['balance'] : '';

							wp_editor( $balance_template, $this->field_id( array( 'templates' => 'balance' ) ), array(
