...
class CepatLakoo_Recent_Products_Widget_Elementor extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'CL - Recent Products', 'cepatlakoo' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'CL - Recent Products', 'cepatlakoo' ),
			]
		);
	...
	protected function render() {
		...
		echo do_shortcode( '[recent_products limit="'. $post_count .'"  columns="'. $post_column .'" orderby="'. $post_order_by .'" order="'. $post_order .'"]' );
...
Plugin::instance()->widgets_manager->register( new CepatLakoo_Recent_Products_Widget_Elementor() );
