...
/**
 * Mini-cart-popup
 * Extend for cepatlakoo cart popup
 *
	...
	<ul class="woocommerce-mini-cart cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?>">
		<?php
			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
				$sessions = (array)WC()->session->get( 'cl_cart_last_product' );
				$_product     = apply_filters( 'woocommerce_cart_item_product', $cart_item['data'], $cart_item, $cart_item_key );
				$product_id   = apply_filters( 'woocommerce_cart_item_product_id', $cart_item['product_id'], $cart_item, $cart_item_key );

				if( !empty( $sessions ) && ( ($sessions['product_id'] === 0 && $sessions['variation_id'] === $cart_item['variation_id']) || ($sessions['variation_id'] === 0 && $sessions['product_id'] == $product_id) ) ){
...
<?php do_action( 'woocommerce_after_mini_cart' ); WC()->session->__unset( 'cl_cart_last_product' ); ?>
